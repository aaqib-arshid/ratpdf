"""Wave 3 — Compress PDF + Compliance cluster expansions."""
...
COMPLIANCE_TOOLS = {
    "gst-invoice-format-india": ("/invoice/create", "Create GST invoice"),
    "e-invoicing-india-pdf": ("/invoice/bulk", "Bulk GST invoices"),
    "pdf-redaction-permanent": ("/pdf-redaction", "Redact PDF"),
    "wcag-22-pdf": ("/pdf/pdftotext", "PDF to Text"),
    "gdpr-pdf-redaction": ("/pdf-redaction", "Redact PDF"),
}
...
# Per-slug deep blocks (~500+ words each) to reach 1,500+ total per guide.
COMPRESS_SLUG_DEEP = {
    "compress-before-merge-pdf": """
