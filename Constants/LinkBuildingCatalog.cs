    ...
    public static class LinkBuildingCatalog
    {
        ...
        [
            ...
            new(
                ...
                true),
            new(
                "pdf-tool-buyer-guide",
                "How to Choose a PDF Tool (2026 Buyer Guide)",
                "Free limits, file caps, security checklist, and links to RatPDF vs iLovePDF, Smallpdf, Adobe, Soda PDF, and PDF Candy.",
                "/guides/choose-pdf-tool",
                LinkAssetType.ReferenceGuide,
                LinkAssetTier.P0,
                84,
                ["Buyer guide", "Comparison links", "Decision checklist"],
                true,
                "ethan-brooks"),
            new(
                "pdf-tool-market-comparison",
                "Online PDF Tool Market Comparison 2026",
                "Feature matrix: free tiers, upload limits, tool counts, and content depth across major PDF SaaS vendors.",
                "/research/pdf-tool-market-comparison",
                LinkAssetType.IndustryStudy,
                LinkAssetTier.P0,
                86,
                ["Original comparison table", "Citable research", "Links to /compare pages"],
                true,
                "ethan-brooks"),
            new(
                "secure-pdf-workflow-guide",
                "Secure PDF Workflow Hub",
                "Watermark, password, sign, unlock, and redaction guides in one editorial hub.",
                "/guides/secure-pdf-workflow",
                LinkAssetType.ReferenceGuide,
                LinkAssetTier.P1,
                79,
                ["Security workflow", "Multi-guide hub"],
                true),
            new(
                "vertical-lawyers",
                "PDF Tools for Lawyers",
                "Curated merge, redact, convert, and compress tools for legal document workflows.",
                "/pdf-tools-for-lawyers",
                LinkAssetType.ReferenceGuide,
                LinkAssetTier.P1,
                77,
                ["Vertical landing", "Legal workflow"],
                true),
            new(
                "vertical-accountants",
                "PDF Tools for Accountants",
                "Bank PDF to Excel, GST invoices, and board pack export for finance teams.",
                "/pdf-tools-for-accountants",
                LinkAssetType.ReferenceGuide,
                LinkAssetTier.P1,
                77,
                ["Vertical landing", "Finance workflow"],
                true),
            new(
                "vertical-students",
                "PDF Tools for Students",
                "Merge readings, OCR scans, and citation extraction for academic PDF workflows.",
                "/pdf-tools-for-students",
                LinkAssetType.ReferenceGuide,
                LinkAssetTier.P2,
                72,
                ["Vertical landing", "Education"],
                true),
            new(
                "ring-size-converter",
