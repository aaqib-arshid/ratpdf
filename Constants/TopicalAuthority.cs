...
namespace ratpdf.Constants
{
    ...
    public static class TopicalAuthority
    {
        ...
        [
            ...
            new("Combine & organize", "Merge, split, crop, reorder, rotate, and number pages.",
            [
                ("Merge PDF", "/pdf/merge", "Combine PDFs in custom order."),
                ("Organize PDF", "/pdf/organize", "Drag to reorder or delete pages."),
                ("Split PDF", "/pdf/split", "Extract page ranges or split by size."),
                ("Crop PDF", "/pdf/crop", "Trim scanner margins and white borders."),
            ...
            new("Edit & enrich", "OCR, summarize, compare, forms, metadata, and image extraction.",
            [
                ("Edit PDF", "/pdf/editpdf", "Quick browser edits."),
                ("AI PDF Summarizer", "/pdf/summarize", "Key points from long reports."),
                ("Compare PDFs", "/pdf/compare", "Text diff between two versions."),
                ("Fill PDF Form", "/pdf/fillform", "Complete AcroForm fields online."),
            ...
            new("Repair & archive", "Fix corrupt files and export archival PDF/A copies.",
            [
                ("Repair PDF", "/pdf/repair", "Rebuild damaged or unreadable PDFs."),
                ("PDF/A Converter", "/pdf/pdfa", "PDF/A-1b and PDF/A-2b archival export."),
            ]),
        ...
        private static readonly Dictionary<string, string[]> WorkflowByTool = new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["/pdf/crop"] = ["/pdf/organize", "/pdf/compress", "/pdf/merge"],
            ["/pdf/organize"] = ["/pdf/merge", "/pdf/split", "/pdf/compress"],
            ["/pdf/repair"] = ["/pdf/compress", "/pdf/unlockpdf", "/pdf/merge"],
            ["/pdf/summarize"] = ["/pdf/ocrpdf", "/pdf/pdftotext", "/pdf/compress"],
            ["/pdf/pdfa"] = ["/pdf/pdfmetadata", "/pdf/compress", "/pdf/repair"],
            ["/pdf/compare"] = ["/pdf/pdftotext", "/text-comparer", "/pdf/pdftodoc"],
            ["/pdf/fillform"] = ["/pdf/flattenpdf", "/pdf/password", "/pdf/compress"],
