namespace ratpdf.Constants
{
    ...
    public static class SiteToolNavigation
    {
        ...
        [
            ...
            new("Organize PDF", "/pdf/organize"),
            new("Crop PDF", "/pdf/crop"),
            new("Repair PDF", "/pdf/repair"),
            new("AI Summarizer", "/pdf/summarize"),
            new("PDF/A Converter", "/pdf/pdfa"),
            new("Compare PDFs", "/pdf/compare"),
            new("Fill PDF Form", "/pdf/fillform"),
