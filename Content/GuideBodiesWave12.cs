namespace ratpdf.Content
{
    ...
    internal static class GuideBodiesWave12
    {
        public static string? Get(string slug) => slug switch
        {
            ...
            "sox-pdf-retention" => SoxPdfRetention,
            "beginner-pdf-metadata-explained" => BeginnerPdfMetadataExplained,
            "pdf-a-archival" => PdfAArchival,
            "convert-to-pdf-a" => ConvertToPdfA,
            "pdf-a-conversion-online" => PdfAConversionOnline,
            "pdf-ua-accessibility" => PdfUaAccessibility,
            "pdf-x-print-standard" => PdfXPrintStandard,
            "pdf-standards-guide" => PdfStandardsGuide,
            "document-retention-pdf" => DocumentRetentionPdf,
            "pdf-archival-best-practices" => PdfArchivalBestPractices,
            "xmp-metadata-pdf" => XmpMetadataPdf,
            "pdf-version-compatibility" => PdfVersionCompatibility,
            "long-term-pdf-storage" => LongTermPdfStorage,
            "pdf-metadata-audit" => PdfMetadataAudit,
            "pdf-standards-archiving-hub" => PdfStandardsArchivingHub,
            _ => null
        };

        private const string PdfMetadata = """
            <h2>PDF Metadata Viewer — Document Properties &amp; Audit Export (2026)</h2>
            <p>RatPDF <a href="/pdf/pdfmetadata">PDF Metadata</a> — Records manager exports JSON properties before ECM migration.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF Metadata Viewer — Document Properties &amp; Audit Export (2026)</figcaption></figure>
            ...
            <h2>Workflow deep dive — PDF Metadata Viewer — Document Properties &amp; Audit Export (2026)</h2>
            ...
            <div class="rp-faq-cta alert alert-secondary my-4"><strong>Inspect</strong> <a href="/pdf/pdfmetadata" class="alert-link fw-semibold">Go →</a></div>
            
            <p>Hub: <a href="/guides/pdf-standards-archiving-hub">standards &amp; archiving hub</a> · <a href="/guides/pdf-standards-guide">standards matrix</a>.</p>
            ...
            <p class="mt-4"><a href="/pdf/pdfmetadata" class="btn btn-primary">PDF Metadata</a> · <a href="/guides/pdf-standards-archiving-hub">Standards hub</a></p>
            """;

        private const string AddPageNumbers = """
            <h2>Add Page Numbers to PDF — Footer Format &amp; Bates Prep (2026)</h2>
            <p>RatPDF <a href="/pdf/pagenumbers">Add Page Numbers</a> — Paralegal stamps Page 1 of 120 before court exhibit merge.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Add Page Numbers to PDF — Footer Format &amp; Bates Prep (2026)</figcaption></figure>
            ...
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Start workflow</strong> <a href="/pdf/pagenumbers" class="alert-link fw-semibold">Add Page Numbers →</a></div>
            ...
            <h2>Workflow deep dive — Add Page Numbers to PDF — Footer Format &amp; Bates Prep (2026)</h2>
            <p>Archival PDFs need policy before tools — standard selection beats retroactive conversion.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Add Page Numbers to PDF — Footer Format &amp; Bates Prep (2026)</figcaption></figure>
            <h2>Validation</h2>
            <p>Certified PDF/A/UA/X requires validator output in audit file — not assumption from export dialog.</p>
            <div class="rp-faq-cta alert alert-secondary my-4"><strong>Inspect</strong> <a href="/pdf/pagenumbers" class="alert-link fw-semibold">Go →</a></div>
            ...
            <p class="mt-4"><a href="/pdf/pagenumbers" class="btn btn-primary">Add Page Numbers</a> · <a href="/guides/pdf-standards-archiving-hub">Standards hub</a></p>
            """;

        private const string SoxPdfRetention = """
            <h2>SOX PDF Retention — Finance Records &amp; Immutable Archives (2026)</h2>
            <p>RatPDF <a href="/guides/pdf-tools">PDF tools hub</a> — Controller archives quarterly financial PDFs with retention calendar.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> SOX PDF Retention — Finance Records &amp; Immutable Archives (2026)</figcaption></figure>
            ...
            <h2>Workflow deep dive — SOX PDF Retention — Finance Records &amp; Immutable Archives (2026)</h2>
            <p>Archival PDFs need policy before tools — standard selection beats retroactive conversion.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> SOX PDF Retention — Finance Records &amp; Immutable Archives (2026)</figcaption></figure>
            <h2>Validation</h2>
            <p>Certified PDF/A/UA/X requires validator output in audit file — not assumption from export dialog.</p>
            <div class="rp-faq-cta alert alert-secondary my-4"><strong>Inspect</strong> <a href="/guides/pdf-tools" class="alert-link fw-semibold">Go →</a></div>
            ...
            <p class="mt-4"><a href="/guides/pdf-tools" class="btn btn-primary">PDF tools hub</a> · <a href="/guides/pdf-standards-archiving-hub">Standards hub</a></p>
            """;

        private const string BeginnerPdfMetadataExplained = """
            <h2>PDF Metadata Explained — Title, Author, XMP &amp; Hidden Fields (2026)</h2>
            <p>RatPDF <a href="/pdf/pdfmetadata">PDF Metadata</a> — New hire learns why author field leaks on external contract share.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF Metadata Explained — Title, Author, XMP &amp; Hidden Fields (2026)</figcaption></figure>
            ...
            <h2>Workflow deep dive — PDF Metadata Explained — Title, Author, XMP &amp; Hidden Fields (2026)</h2>
            <p>Archival PDFs need policy before tools — standard selection beats retroactive conversion.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF Metadata Explained — Title, Author, XMP &amp; Hidden Fields (2026)</figcaption></figure>
            <h2>Validation</h2>
            <p>Certified PDF/A/UA/X requires validator output in audit file — not assumption from export dialog.</p>
        ...
        private const string PdfAArchival = """
            <h2>PDF/A Archival — Long-Term Preservation Standard Explained (2026)</h2>
            <p>RatPDF <a href="/guides/pdf-tools">PDF tools hub</a> — County clerk plans deed PDF archive meeting PDF/A-1b requirements.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF/A Archival — Long-Term Preservation Standard Explained (2026)</figcaption></figure>
            ...
            <h2>Workflow deep dive — PDF/A Archival — Long-Term Preservation Standard Explained (2026)</h2>
            <p>Archival PDFs need policy before tools — standard selection beats retroactive conversion.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF/A Archival — Long-Term Preservation Standard Explained (2026)</figcaption></figure>
            <h2>Validation</h2>
            <p>Certified PDF/A/UA/X requires validator output in audit file — not assumption from export dialog.</p>
        ...
        private const string ConvertToPdfA = """
            <h2>Convert to PDF/A — Workflow &amp; Honest Tool Limits (2026)</h2>
            <p>RatPDF <a href="/pdf/compress">Compress PDF</a> — IT evaluates whether browser compress pass suffices before dedicated PDF/A server.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Convert to PDF/A — Workflow &amp; Honest Tool Limits (2026)</figcaption></figure>
            ...
            <h2>Workflow deep dive — Convert to PDF/A — Workflow &amp; Honest Tool Limits (2026)</h2>
            <p>Archival PDFs need policy before tools — standard selection beats retroactive conversion.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Convert to PDF/A — Workflow &amp; Honest Tool Limits (2026)</figcaption></figure>
            <h2>Validation</h2>
            <p>Certified PDF/A/UA/X requires validator output in audit file — not assumption from export dialog.</p>
            <div class="rp-faq-cta alert alert-secondary my-4"><strong>Inspect</strong> <a href="/pdf/compress" class="alert-link fw-semibold">Go →</a></div>
            ...
            <p class="mt-4"><a href="/pdf/compress" class="btn btn-primary">Compress PDF</a> · <a href="/guides/pdf-standards-archiving-hub">Standards hub</a></p>
            """;

        private const string PdfAConversionOnline = """
            <h2>PDF/A Conversion Online — When Browser Tools Help vs Specialist Apps (2026)</h2>
            <p>RatPDF <a href="/pdf/compress">Compress PDF</a> — Archivist searches online PDF/A after scan backlog from legacy TIFF.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF/A Conversion Online — When Browser Tools Help vs Specialist Apps (2026)</figcaption></figure>
            ...
            <h2>Workflow deep dive — PDF/A Conversion Online — When Browser Tools Help vs Specialist Apps (2026)</h2>
            <p>Archival PDFs need policy before tools — standard selection beats retroactive conversion.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF/A Conversion Online — When Browser Tools Help vs Specialist Apps (2026)</figcaption></figure>
            <h2>Validation</h2>
            <p>Certified PDF/A/UA/X requires validator output in audit file — not assumption from export dialog.</p>
        ...
        private const string PdfUaAccessibility = """
            <h2>PDF/UA Accessibility — Universal Access ISO Standard (2026)</h2>
            <p>RatPDF <a href="/pdf/ocrpdf">OCR PDF</a> — Publisher targets PDF/UA-1 for government RFP accessible deliverable.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF/UA Accessibility — Universal Access ISO Standard (2026)</figcaption></figure>
            ...
            <h2>Workflow deep dive — PDF/UA Accessibility — Universal Access ISO Standard (2026)</h2>
            <p>Archival PDFs need policy before tools — standard selection beats retroactive conversion.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF/UA Accessibility — Universal Access ISO Standard (2026)</figcaption></figure>
            <h2>Validation</h2>
            <p>Certified PDF/A/UA/X requires validator output in audit file — not assumption from export dialog.</p>
            <div class="rp-faq-cta alert alert-secondary my-4"><strong>Inspect</strong> <a href="/pdf/ocrpdf" class="alert-link fw-semibold">Go →</a></div>
            ...
            <p class="mt-4"><a href="/pdf/ocrpdf" class="btn btn-primary">OCR PDF</a> · <a href="/guides/pdf-standards-archiving-hub">Standards hub</a></p>
            """;

        private const string PdfXPrintStandard = """
            <h2>PDF/X Print Standard — Prepress &amp; Commercial Print Workflow (2026)</h2>
            <p>RatPDF <a href="/guides/pdf-tools">PDF tools hub</a> — Print shop rejects marketing PDF missing PDF/X-1a output intent.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF/X Print Standard — Prepress &amp; Commercial Print Workflow (2026)</figcaption></figure>
            ...
            <h2>Workflow deep dive — PDF/X Print Standard — Prepress &amp; Commercial Print Workflow (2026)</h2>
            <p>Archival PDFs need policy before tools — standard selection beats retroactive conversion.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF/X Print Standard — Prepress &amp; Commercial Print Workflow (2026)</figcaption></figure>
            <h2>Validation</h2>
            <p>Certified PDF/A/UA/X requires validator output in audit file — not assumption from export dialog.</p>
        ...
        private const string PdfStandardsGuide = """
            <h2>PDF Standards Guide — PDF/A, PDF/UA, PDF/X Decision Matrix (2026)</h2>
            <p>RatPDF <a href="/guides/pdf-tools">PDF tools hub</a> — Solution architect picks standard per deliverable type in enterprise wiki.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF Standards Guide — PDF/A, PDF/UA, PDF/X Decision Matrix (2026)</figcaption></figure>
            ...
            <h2>Workflow deep dive — PDF Standards Guide — PDF/A, PDF/UA, PDF/X Decision Matrix (2026)</h2>
            <p>Archival PDFs need policy before tools — standard selection beats retroactive conversion.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF Standards Guide — PDF/A, PDF/UA, PDF/X Decision Matrix (2026)</figcaption></figure>
            <h2>Validation</h2>
            <p>Certified PDF/A/UA/X requires validator output in audit file — not assumption from export dialog.</p>
        ...
        private const string DocumentRetentionPdf = """
            <h2>Document Retention for PDFs — Legal Holds &amp; Destruction Dates (2026)</h2>
            <p>RatPDF <a href="/guides/pdf-tools">PDF tools hub</a> — Legal ops maps invoice PDF 7-year retention vs marketing draft 2-year.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Document Retention for PDFs — Legal Holds &amp; Destruction Dates (2026)</figcaption></figure>
            ...
            <h2>Workflow deep dive — Document Retention for PDFs — Legal Holds &amp; Destruction Dates (2026)</h2>
            <p>Archival PDFs need policy before tools — standard selection beats retroactive conversion.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Document Retention for PDFs — Legal Holds &amp; Destruction Dates (2026)</figcaption></figure>
            <h2>Validation</h2>
            <p>Certified PDF/A/UA/X requires validator output in audit file — not assumption from export dialog.</p>
        ...
        private const string PdfArchivalBestPractices = """
            <h2>PDF Archival Best Practices — Masters, Derivatives &amp; Checksums (2026)</h2>
            <p>RatPDF <a href="/pdf/compress">Compress PDF</a> — Museum digitization project stores uncompressed master plus access copy.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF Archival Best Practices — Masters, Derivatives &amp; Checksums (2026)</figcaption></figure>
            ...
            <h2>Workflow deep dive — PDF Archival Best Practices — Masters, Derivatives &amp; Checksums (2026)</h2>
            <p>Archival PDFs need policy before tools — standard selection beats retroactive conversion.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF Archival Best Practices — Masters, Derivatives &amp; Checksums (2026)</figcaption></figure>
            <h2>Validation</h2>
            <p>Certified PDF/A/UA/X requires validator output in audit file — not assumption from export dialog.</p>
        ...
        private const string XmpMetadataPdf = """
            <h2>XMP Metadata in PDF — Dublin Core &amp; Custom Properties (2026)</h2>
            <p>RatPDF <a href="/pdf/pdfmetadata">PDF Metadata</a> — DAM team audits XMP rights field on licensed stock PDF insert.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> XMP Metadata in PDF — Dublin Core &amp; Custom Properties (2026)</figcaption></figure>
            ...
            <h2>Workflow deep dive — XMP Metadata in PDF — Dublin Core &amp; Custom Properties (2026)</h2>
            <p>Archival PDFs need policy before tools — standard selection beats retroactive conversion.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> XMP Metadata in PDF — Dublin Core &amp; Custom Properties (2026)</figcaption></figure>
            <h2>Validation</h2>
            <p>Certified PDF/A/UA/X requires validator output in audit file — not assumption from export dialog.</p>
        ...
        private const string PdfVersionCompatibility = """
            <h2>PDF Version Compatibility — 1.4 vs 1.7 vs 2.0 Viewer Issues (2026)</h2>
            <p>RatPDF <a href="/pdf/compress">Compress PDF</a> — Portal rejects PDF 2.0 — re-export as PDF 1.7 from source app.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF Version Compatibility — 1.4 vs 1.7 vs 2.0 Viewer Issues (2026)</figcaption></figure>
            ...
            <h2>Workflow deep dive — PDF Version Compatibility — 1.4 vs 1.7 vs 2.0 Viewer Issues (2026)</h2>
            <p>Archival PDFs need policy before tools — standard selection beats retroactive conversion.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF Version Compatibility — 1.4 vs 1.7 vs 2.0 Viewer Issues (2026)</figcaption></figure>
            <h2>Validation</h2>
            <p>Certified PDF/A/UA/X requires validator output in audit file — not assumption from export dialog.</p>
        ...
        private const string LongTermPdfStorage = """
            <h2>Long-Term PDF Storage — Cloud, Tape &amp; Format Migration (2026)</h2>
            <p>RatPDF <a href="/guides/pdf-tools">PDF tools hub</a> — Nonprofit plans 10-year grant PDF archive with format migration review.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Long-Term PDF Storage — Cloud, Tape &amp; Format Migration (2026)</figcaption></figure>
            ...
            <h2>Workflow deep dive — Long-Term PDF Storage — Cloud, Tape &amp; Format Migration (2026)</h2>
            <p>Archival PDFs need policy before tools — standard selection beats retroactive conversion.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Long-Term PDF Storage — Cloud, Tape &amp; Format Migration (2026)</figcaption></figure>
            <h2>Validation</h2>
            <p>Certified PDF/A/UA/X requires validator output in audit file — not assumption from export dialog.</p>
        ...
        private const string PdfMetadataAudit = """
            <h2>PDF Metadata Audit — Pre-Share &amp; Compliance Checklist (2026)</h2>
            <p>RatPDF <a href="/pdf/pdfmetadata">PDF Metadata</a> — Procurement scrubs creator path metadata before vendor RFP publish.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF Metadata Audit — Pre-Share &amp; Compliance Checklist (2026)</figcaption></figure>
            ...
            <h2>Workflow deep dive — PDF Metadata Audit — Pre-Share &amp; Compliance Checklist (2026)</h2>
            <p>Archival PDFs need policy before tools — standard selection beats retroactive conversion.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF Metadata Audit — Pre-Share &amp; Compliance Checklist (2026)</figcaption></figure>
            <h2>Validation</h2>
            <p>Certified PDF/A/UA/X requires validator output in audit file — not assumption from export dialog.</p>
        ...
        private const string PdfStandardsArchivingHub = """
            <h2>PDF Standards &amp; Archiving Hub — Retention, PDF/A &amp; Metadata (2026)</h2>
            <p>RatPDF <a href="/guides/pdf-tools">PDF tools hub</a> — Records management team landing page for RatPDF archival workflows.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF Standards &amp; Archiving Hub — Retention, PDF/A &amp; Metadata (2026)</figcaption></figure>
            ...
            <h2>Workflow deep dive — PDF Standards &amp; Archiving Hub — Retention, PDF/A &amp; Metadata (2026)</h2>
            <p>Archival PDFs need policy before tools — standard selection beats retroactive conversion.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF Standards &amp; Archiving Hub — Retention, PDF/A &amp; Metadata (2026)</figcaption></figure>
            <h2>Validation</h2>
            <p>Certified PDF/A/UA/X requires validator output in audit file — not assumption from export dialog.</p>
