namespace ratpdf.Content
{
    ...
    internal static class GuideBodiesWave40
    {
        public static string? Get(string slug) => slug switch
        {
            ...
            "real-estate-disclosure-pdf-merge" => RealEstateDisclosurePdfMerge,
            "student-combine-lecture-pdfs" => StudentCombineLecturePdfs,
            "pdf-vs-word-when-to-use" => PdfVsWordWhenToUse,
            "compress-pdf-mygov-australia" => CompressPdfMygovAustralia,
            "visa-application-pdf-workflow-argentina" => VisaApplicationPdfWorkflowArgentina,
            "visa-application-pdf-workflow-poland" => VisaApplicationPdfWorkflowPoland,
            "visa-application-pdf-workflow-sweden" => VisaApplicationPdfWorkflowSweden,
            "visa-application-pdf-workflow-norway" => VisaApplicationPdfWorkflowNorway,
            "visa-application-pdf-workflow-denmark" => VisaApplicationPdfWorkflowDenmark,
            "visa-application-pdf-workflow-finland" => VisaApplicationPdfWorkflowFinland,
            "visa-application-pdf-workflow-portugal" => VisaApplicationPdfWorkflowPortugal,
            "visa-application-pdf-workflow-greece" => VisaApplicationPdfWorkflowGreece,
            "visa-application-pdf-workflow-turkey" => VisaApplicationPdfWorkflowTurkey,
            "visa-application-pdf-workflow-egypt" => VisaApplicationPdfWorkflowEgypt,
            "visa-application-pdf-workflow-morocco" => VisaApplicationPdfWorkflowMorocco,
            "visa-application-pdf-workflow-nigeria" => VisaApplicationPdfWorkflowNigeria,
            _ => null
        };

        private const string BatesNumberingPdf = """
            <h2>Bates Numbering PDF — Litigation Production Stamp (2026)</h2>
            <p>Example: Paralegal stamps PROD000001–PROD012400 footer on discovery production before opposing counsel delivery.</p>
            <p class="lead">Pillar: <a href="/guides/add-page-numbers">add page numbers</a> · Related: <a href="/guides/redact-pdf-discovery">/guides/redact-pdf-discovery</a> · Tool page: <a href="/pdf/pagenumbers">/pdf/pagenumbers</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Bates Numbering PDF — Litigation Production Stamp (2026)</figcaption></figure>
            ...
            <p>Tool: <a href="/pdf/pagenumbers">/pdf/pagenumbers</a></p>
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Start workflow</strong> <a href="/pdf/pagenumbers" class="alert-link fw-semibold">Page Numbers →</a></div>
            ...
            <p class="mt-4"><a href="/pdf/pagenumbers" class="btn btn-primary">Page Numbers</a> · <a href="/guides/add-page-numbers">Full guide</a></p>
            """;

        private const string RealEstateDisclosurePdfMerge = """
            <h2>Real Estate Disclosure PDF Merge — State Order &amp; Closing Pack (2026)</h2>
            <p>Example: Agent merges lead paint, HOA, and seller disclosure PDFs in state-required order for buyer email.</p>
            <p class="lead">Pillar: <a href="/guides/compress-pdf-real-estate">compress PDF real estate</a> · Related: <a href="/guides/pdf-tools-real-estate">/guides/pdf-tools-real-estate</a> · Tool page: <a href="/pdf/merge">/pdf/merge</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Real Estate Disclosure PDF Merge — State Order &amp; Closing Pack (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/merge" class="btn btn-primary">Merge PDF</a> · <a href="/guides/compress-pdf-real-estate">Full guide</a></p>
            """;

        private const string StudentCombineLecturePdfs = """
            <h2>Student Combine Lecture PDFs — Weekly Reading Pack (2026)</h2>
            <p>Example: Undergrad merges Week 4 sociology readings — 14 files — one 22 MB PDF then compress for offline study.</p>
            <p class="lead">Pillar: <a href="/guides/merge-pdf-students">merge PDF for students</a> · Related: <a href="/guides/pdf-workflow-students">/guides/pdf-workflow-students</a> · Tool page: <a href="/pdf/merge">/pdf/merge</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Student Combine Lecture PDFs — Weekly Reading Pack (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/merge" class="btn btn-primary">Merge PDF</a> · <a href="/guides/merge-pdf-students">Full guide</a></p>
            """;

        private const string PdfVsWordWhenToUse = """
            <h2>PDF vs Word — When to Use Each Format (2026)</h2>
            <p>Example: Legal ops keeps signed contract as PDF for clients — uses Word only for internal redline draft.</p>
            <p class="lead">Pillar: <a href="/guides/pdf-to-word-vs-pdf-to-text">PDF to Word vs text</a> · Related: <a href="/guides/pdf-vs-word-when-to-convert">/guides/pdf-vs-word-when-to-convert</a> · Tool page: <a href="/pdf/pdftodoc">/pdf/pdftodoc</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF vs Word — When to Use Each Format (2026)</figcaption></figure>
        ...
        private const string CompressPdfMygovAustralia = """
            <h2>Compress PDF for myGov Australia — Tax &amp; Centrelink Upload (2026)</h2>
            <p>Example: Taxpayer compresses scanned deduction receipt PDF from 4 MB to 1.5 MB for myGov document upload.</p>
            <p class="lead">Pillar: <a href="/guides/compress-pdf-home-affairs-australia">compress Home Affairs Australia</a> · Related: <a href="/guides/government-portal-pdf-compress">/guides/government-portal-pdf-compress</a> · Tool page: <a href="/compress-pdf-for-government-forms">/compress-pdf-for-government-forms</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Compress PDF for myGov Australia — Tax &amp; Centrelink Upload (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/compress" class="btn btn-primary">Compress PDF</a> · <a href="/guides/compress-pdf-home-affairs-australia">Full guide</a></p>
            """;

        private const string VisaApplicationPdfWorkflowArgentina = """
            <h2>Visa Application PDF Workflow Argentina — Consulate &amp; VFS Pack (2026)</h2>
            <p>Example: Applicant compresses Banco Nación statement PDF for Argentina visa appointment.</p>
            <p class="lead">Pillar: <a href="/guides/merge-pdf-visa-application">merge PDF for visa</a> · Related: <a href="/guides/compress-pdf-for-visa-application">/guides/compress-pdf-for-visa-application</a> · Tool page: <a href="/compress-pdf-for-visa-application">/compress-pdf-for-visa-application</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Visa Application PDF Workflow Argentina — Consulate &amp; VFS Pack (2026)</figcaption></figure>
            
            <h2>Argentina visa PDF workflow</h2>
            <ol>
            ...
            <p>Read embassy FAQ for slot caps — official PDF exports — certified translation if required.</p>
        ...
        private const string VisaApplicationPdfWorkflowPoland = """
            <h2>Visa Application PDF Workflow Poland — Schengen &amp; National Visa (2026)</h2>
            <p>Example: Student merges Poland visa financials, insurance, and itinerary for VFS Warsaw.</p>
            <p class="lead">Pillar: <a href="/guides/merge-pdf-visa-application">merge PDF for visa</a> · Related: <a href="/guides/compress-pdf-schengen">/guides/compress-pdf-schengen</a> · Tool page: <a href="/compress-pdf-for-visa-application">/compress-pdf-for-visa-application</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Visa Application PDF Workflow Poland — Schengen &amp; National Visa (2026)</figcaption></figure>
            
            <h2>Poland visa PDF workflow</h2>
            <ol>
            <li>Download official bank and employment PDFs — not screenshots</li>
            <li><a href="/pdf/merge">Merge</a> in embassy/VFS order if one upload</li>
            <li><a href="/pdf/compress">Compress</a> once — Less on scans</li>
            ...
            <p>Schengen: merge cover sheet, itinerary, insurance, bank PDF — <a href="/guides/schengen-visa-pdf-merge-order">merge order guide</a> · <a href="/guides/compress-pdf-schengen">compress Schengen</a>.</p>
            <p>Hub: <a href="/guides/pdf-regional-workflows-hub">regional workflows</a> · financial: <a href="/guides/bank-statement-pdf-visa">bank statement visa</a>.</p>
            <p>Tool: <a href="/compress-pdf-for-visa-application">/compress-pdf-for-visa-application</a></p>
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Start workflow</strong> <a href="/pdf/merge" class="alert-link fw-semibold">Merge PDF →</a></div>
        ...
        private const string VisaApplicationPdfWorkflowSweden = """
            <h2>Visa Application PDF Workflow Sweden — Schengen &amp; Residence Permit (2026)</h2>
            <p>Example: Worker compresses employment contract and funds PDF for Sweden migration portal.</p>
            <p class="lead">Pillar: <a href="/guides/merge-pdf-visa-application">merge PDF for visa</a> · Related: <a href="/guides/compress-pdf-schengen">/guides/compress-pdf-schengen</a> · Tool page: <a href="/compress-pdf-for-visa-application">/compress-pdf-for-visa-application</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Visa Application PDF Workflow Sweden — Schengen &amp; Residence Permit (2026)</figcaption></figure>
            
            <h2>Sweden visa PDF workflow</h2>
            <ol>
            <li>Download official bank and employment PDFs — not screenshots</li>
            <li><a href="/pdf/merge">Merge</a> in embassy/VFS order if one upload</li>
            <li><a href="/pdf/compress">Compress</a> once — Less on scans</li>
        ...
        private const string VisaApplicationPdfWorkflowNorway = """
            <h2>Visa Application PDF Workflow Norway — Schengen &amp; UDI Upload (2026)</h2>
            <p>Example: Visitor merges invitation, insurance, and bank PDF for Norway UDI evidence.</p>
            <p class="lead">Pillar: <a href="/guides/merge-pdf-visa-application">merge PDF for visa</a> · Related: <a href="/guides/compress-pdf-schengen">/guides/compress-pdf-schengen</a> · Tool page: <a href="/compress-pdf-for-visa-application">/compress-pdf-for-visa-application</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Visa Application PDF Workflow Norway — Schengen &amp; UDI Upload (2026)</figcaption></figure>
            
            <h2>Norway visa PDF workflow</h2>
            <ol>
            <li>Download official bank and employment PDFs — not screenshots</li>
            <li><a href="/pdf/merge">Merge</a> in embassy/VFS order if one upload</li>
            <li><a href="/pdf/compress">Compress</a> once — Less on scans</li>
        ...
        private const string VisaApplicationPdfWorkflowDenmark = """
            <h2>Visa Application PDF Workflow Denmark — Schengen &amp; SIRI Pack (2026)</h2>
            <p>Example: Applicant compresses Danish bank export and admission letter for SIRI slot.</p>
            <p class="lead">Pillar: <a href="/guides/merge-pdf-visa-application">merge PDF for visa</a> · Related: <a href="/guides/compress-pdf-schengen">/guides/compress-pdf-schengen</a> · Tool page: <a href="/compress-pdf-for-visa-application">/compress-pdf-for-visa-application</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Visa Application PDF Workflow Denmark — Schengen &amp; SIRI Pack (2026)</figcaption></figure>
            
            <h2>Denmark visa PDF workflow</h2>
            <ol>
            <li>Download official bank and employment PDFs — not screenshots</li>
            <li><a href="/pdf/merge">Merge</a> in embassy/VFS order if one upload</li>
            <li><a href="/pdf/compress">Compress</a> once — Less on scans</li>
        ...
        private const string VisaApplicationPdfWorkflowFinland = """
            <h2>Visa Application PDF Workflow Finland — Schengen &amp; Migri (2026)</h2>
            <p>Example: Researcher merges Migri financial proof and passport bio PDF under cap.</p>
            <p class="lead">Pillar: <a href="/guides/merge-pdf-visa-application">merge PDF for visa</a> · Related: <a href="/guides/compress-pdf-schengen">/guides/compress-pdf-schengen</a> · Tool page: <a href="/compress-pdf-for-visa-application">/compress-pdf-for-visa-application</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Visa Application PDF Workflow Finland — Schengen &amp; Migri (2026)</figcaption></figure>
            
            <h2>Finland visa PDF workflow</h2>
            <ol>
            <li>Download official bank and employment PDFs — not screenshots</li>
            <li><a href="/pdf/merge">Merge</a> in embassy/VFS order if one upload</li>
            <li><a href="/pdf/compress">Compress</a> once — Less on scans</li>
        ...
        private const string VisaApplicationPdfWorkflowPortugal = """
            <h2>Visa Application PDF Workflow Portugal — Schengen &amp; VFS Lisbon (2026)</h2>
            <p>Example: Digital nomad compresses funds and lease PDF for Portugal visa upload.</p>
            <p class="lead">Pillar: <a href="/guides/merge-pdf-visa-application">merge PDF for visa</a> · Related: <a href="/guides/compress-pdf-schengen">/guides/compress-pdf-schengen</a> · Tool page: <a href="/compress-pdf-for-visa-application">/compress-pdf-for-visa-application</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Visa Application PDF Workflow Portugal — Schengen &amp; VFS Lisbon (2026)</figcaption></figure>
            
            <h2>Portugal visa PDF workflow</h2>
            <ol>
            <li>Download official bank and employment PDFs — not screenshots</li>
            <li><a href="/pdf/merge">Merge</a> in embassy/VFS order if one upload</li>
            <li><a href="/pdf/compress">Compress</a> once — Less on scans</li>
        ...
        private const string VisaApplicationPdfWorkflowGreece = """
            <h2>Visa Application PDF Workflow Greece — Schengen &amp; VFS Athens (2026)</h2>
            <p>Example: Tourist merges Greece visa insurance and itinerary — one compress pass.</p>
            <p class="lead">Pillar: <a href="/guides/merge-pdf-visa-application">merge PDF for visa</a> · Related: <a href="/guides/compress-pdf-schengen">/guides/compress-pdf-schengen</a> · Tool page: <a href="/compress-pdf-for-visa-application">/compress-pdf-for-visa-application</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Visa Application PDF Workflow Greece — Schengen &amp; VFS Athens (2026)</figcaption></figure>
            
            <h2>Greece visa PDF workflow</h2>
            <ol>
            <li>Download official bank and employment PDFs — not screenshots</li>
            <li><a href="/pdf/merge">Merge</a> in embassy/VFS order if one upload</li>
            <li><a href="/pdf/compress">Compress</a> once — Less on scans</li>
        ...
        private const string VisaApplicationPdfWorkflowTurkey = """
            <h2>Visa Application PDF Workflow Turkey — e-Visa &amp; Embassy Support (2026)</h2>
            <p>Example: Business visitor compresses invitation and company registration PDF for Turkey visa.</p>
            <p class="lead">Pillar: <a href="/guides/merge-pdf-visa-application">merge PDF for visa</a> · Related: <a href="/guides/compress-pdf-for-visa-application">/guides/compress-pdf-for-visa-application</a> · Tool page: <a href="/compress-pdf-for-visa-application">/compress-pdf-for-visa-application</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Visa Application PDF Workflow Turkey — e-Visa &amp; Embassy Support (2026)</figcaption></figure>
            
            <h2>Turkey visa PDF workflow</h2>
            <ol>
            <li>Download official bank and employment PDFs — not screenshots</li>
            <li><a href="/pdf/merge">Merge</a> in embassy/VFS order if one upload</li>
            <li><a href="/pdf/compress">Compress</a> once — Less on scans</li>
        ...
        private const string VisaApplicationPdfWorkflowEgypt = """
            <h2>Visa Application PDF Workflow Egypt — Embassy &amp; e-Visa Portal (2026)</h2>
            <p>Example: Tourist compresses hotel booking and funds PDF for Egypt visa portal.</p>
            <p class="lead">Pillar: <a href="/guides/merge-pdf-visa-application">merge PDF for visa</a> · Related: <a href="/guides/compress-pdf-for-visa-application">/guides/compress-pdf-for-visa-application</a> · Tool page: <a href="/compress-pdf-for-visa-application">/compress-pdf-for-visa-application</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Visa Application PDF Workflow Egypt — Embassy &amp; e-Visa Portal (2026)</figcaption></figure>
            
            <h2>Egypt visa PDF workflow</h2>
            <ol>
            <li>Download official bank and employment PDFs — not screenshots</li>
            <li><a href="/pdf/merge">Merge</a> in embassy/VFS order if one upload</li>
            <li><a href="/pdf/compress">Compress</a> once — Less on scans</li>
        ...
        private const string VisaApplicationPdfWorkflowMorocco = """
            <h2>Visa Application PDF Workflow Morocco — Consulate &amp; VFS (2026)</h2>
            <p>Example: Applicant merges Morocco visa financial evidence and travel insurance PDF.</p>
            <p class="lead">Pillar: <a href="/guides/merge-pdf-visa-application">merge PDF for visa</a> · Related: <a href="/guides/compress-pdf-for-visa-application">/guides/compress-pdf-for-visa-application</a> · Tool page: <a href="/compress-pdf-for-visa-application">/compress-pdf-for-visa-application</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Visa Application PDF Workflow Morocco — Consulate &amp; VFS (2026)</figcaption></figure>
            
            <h2>Morocco visa PDF workflow</h2>
            <ol>
            <li>Download official bank and employment PDFs — not screenshots</li>
            <li><a href="/pdf/merge">Merge</a> in embassy/VFS order if one upload</li>
            <li><a href="/pdf/compress">Compress</a> once — Less on scans</li>
        ...
        private const string VisaApplicationPdfWorkflowNigeria = """
            <h2>Visa Application PDF Workflow Nigeria — Embassy &amp; VFS Lagos (2026)</h2>
            <p>Example: Student compresses admission letter and sponsor bank PDF for Nigeria visa slot.</p>
            <p class="lead">Pillar: <a href="/guides/merge-pdf-visa-application">merge PDF for visa</a> · Related: <a href="/guides/compress-pdf-for-visa-application">/guides/compress-pdf-for-visa-application</a> · Tool page: <a href="/compress-pdf-for-visa-application">/compress-pdf-for-visa-application</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Visa Application PDF Workflow Nigeria — Embassy &amp; VFS Lagos (2026)</figcaption></figure>
            
            <h2>Nigeria visa PDF workflow</h2>
            <ol>
            <li>Download official bank and employment PDFs — not screenshots</li>
            <li><a href="/pdf/merge">Merge</a> in embassy/VFS order if one upload</li>
            <li><a href="/pdf/compress">Compress</a> once — Less on scans</li>
