...
{
    /// <summary>Wave 63 — CREATE batch 27 (final 2 editorial guides).</summary>
    internal static class GuideBodiesWave63
    {
        ...
        private const string PdfToAudio = """
            <h2>PDF to Audio — Read Documents Aloud (2026)</h2>
            <p>Example: Commuter extracts a PDF report to clean text, then feeds it to a text-to-speech app to listen on the drive.</p>
            <p class="lead">Pillar: <a href="/guides/pdf-to-text">PDF to text guide</a> · Related: <a href="/guides/pdf-to-kindle">/guides/pdf-to-kindle</a> · Tool page: <a href="/pdf/pdftotext">/pdf/pdftotext</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF to Audio — Read Documents Aloud (2026)</figcaption></figure>
            ...
            <p>Tool: <a href="/pdf/pdftotext">/pdf/pdftotext</a></p>
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Start workflow</strong> <a href="/pdf/pdftotext" class="alert-link fw-semibold">PDF to Text →</a></div>
        ...
        private const string PdfToHwp = """
            <h2>PDF to HWP — Convert for Hangul Word Processor (2026)</h2>
            <p>Example: Korean office worker converts a PDF to DOCX, then opens and saves it as HWP/HWPX in Hancom Office.</p>
            <p class="lead">Pillar: <a href="/guides/pdf-to-word">PDF to Word guide</a> · Related: <a href="/guides/pdf-to-odt">/guides/pdf-to-odt</a> · Tool page: <a href="/pdf/pdftodoc">/pdf/pdftodoc</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF to HWP — Convert for Hangul Word Processor (2026)</figcaption></figure>
