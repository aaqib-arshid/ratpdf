...
{
    /// <summary>Wave 48 — CREATE batch 12 (17 persona editorial guides).</summary>
    internal static class GuideBodiesWave48
    {
        public static string? Get(string slug) => slug switch
        {
            "best-browser-pdf-tools-for-developers" => BestBrowserPdfToolsForDevelopers,
            "best-browser-pdf-tools-for-ecommerce-sellers" => BestBrowserPdfToolsForEcommerceSellers,
            "best-browser-pdf-tools-for-event-planners" => BestBrowserPdfToolsForEventPlanners,
            "best-browser-pdf-tools-for-freelancers" => BestBrowserPdfToolsForFreelancers,
            "best-browser-pdf-tools-for-government-contractors" => BestBrowserPdfToolsForGovernmentContractors,
            "best-browser-pdf-tools-for-healthcare-administrators" => BestBrowserPdfToolsForHealthcareAdministrators,
            "best-browser-pdf-tools-for-hr-teams" => BestBrowserPdfToolsForHrTeams,
            "best-browser-pdf-tools-for-insurance-agents" => BestBrowserPdfToolsForInsuranceAgents,
            "best-browser-pdf-tools-for-journalists" => BestBrowserPdfToolsForJournalists,
            "best-browser-pdf-tools-for-lawyers" => BestBrowserPdfToolsForLawyers,
            "best-browser-pdf-tools-for-librarians" => BestBrowserPdfToolsForLibrarians,
            "best-browser-pdf-tools-for-marketers" => BestBrowserPdfToolsForMarketers,
            "best-browser-pdf-tools-for-nonprofits" => BestBrowserPdfToolsForNonprofits,
            "best-browser-pdf-tools-for-paralegals" => BestBrowserPdfToolsForParalegals,
            "best-browser-pdf-tools-for-photographers" => BestBrowserPdfToolsForPhotographers,
            "best-browser-pdf-tools-for-real-estate-agents" => BestBrowserPdfToolsForRealEstateAgents,
            "best-browser-pdf-tools-for-recruiters" => BestBrowserPdfToolsForRecruiters,
            _ => null
        };

        private const string BestBrowserPdfToolsForDevelopers = """
            <h2>Best Browser PDF Tools for Developers — Workflow Picks (2026)</h2>
            <p>Example: Merge API doc PDFs, compress release-note bundles, and split oversized log exports before ticket attach.</p>
            <p class="lead">Pillar: <a href="/guides/browser-vs-desktop-pdf-tools">browser vs desktop PDF tools</a> · Related: <a href="/guides/choose-pdf-tool">/guides/choose-pdf-tool</a> · Tool page: <a href="/pdf/merge">/pdf/merge</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Best Browser PDF Tools for Developers — Workflow Picks (2026)</figcaption></figure>
            
            <h2>Browser PDF toolkit for Developers</h2>
            <p>Typical tasks: Merge API doc PDFs, compress release-note bundles, and split oversized log exports before ticket attach.</p>
            <ul>
            ...
            <p class="mt-4"><a href="/pdf/merge" class="btn btn-primary">Merge PDF</a> · <a href="/guides/browser-vs-desktop-pdf-tools">Full guide</a></p>
            """;

        private const string BestBrowserPdfToolsForEcommerceSellers = """
            <h2>Best Browser PDF Tools for E-Commerce Sellers — Workflow Picks (2026)</h2>
            <p>Example: Compress product spec PDFs, merge supplier invoices, and watermark wholesale catalog drafts.</p>
            <p class="lead">Pillar: <a href="/guides/browser-vs-desktop-pdf-tools">browser vs desktop PDF tools</a> · Related: <a href="/guides/choose-pdf-tool">/guides/choose-pdf-tool</a> · Tool page: <a href="/pdf/compress">/pdf/compress</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Best Browser PDF Tools for E-Commerce Sellers — Workflow Picks (2026)</figcaption></figure>
            
            <h2>Browser PDF toolkit for E-Commerce Sellers</h2>
            <p>Typical tasks: Compress product spec PDFs, merge supplier invoices, and watermark wholesale catalog drafts.</p>
            <ul>
            <li><a href="/pdf/merge">Merge</a> — ordered multi-file packs</li>
            <li><a href="/pdf/compress">Compress</a> — email and portal size caps</li>
            <li><a href="/pdf/redaction">Redact</a> — permanent removal before external send</li>
            ...
            <p class="mt-4"><a href="/pdf/compress" class="btn btn-primary">Compress PDF</a> · <a href="/guides/browser-vs-desktop-pdf-tools">Full guide</a></p>
            """;

        private const string BestBrowserPdfToolsForEventPlanners = """
            <h2>Best Browser PDF Tools for Event Planners — Workflow Picks (2026)</h2>
            <p>Example: Merge vendor contract PDFs, compress floor-plan scans, and split day-of run sheets for crew email.</p>
            <p class="lead">Pillar: <a href="/guides/browser-vs-desktop-pdf-tools">browser vs desktop PDF tools</a> · Related: <a href="/guides/choose-pdf-tool">/guides/choose-pdf-tool</a> · Tool page: <a href="/pdf/merge">/pdf/merge</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Best Browser PDF Tools for Event Planners — Workflow Picks (2026)</figcaption></figure>
            
            <h2>Browser PDF toolkit for Event Planners</h2>
            <p>Typical tasks: Merge vendor contract PDFs, compress floor-plan scans, and split day-of run sheets for crew email.</p>
            <ul>
            <li><a href="/pdf/merge">Merge</a> — ordered multi-file packs</li>
            <li><a href="/pdf/compress">Compress</a> — email and portal size caps</li>
            <li><a href="/pdf/redaction">Redact</a> — permanent removal before external send</li>
        ...
        private const string BestBrowserPdfToolsForFreelancers = """
            <h2>Best Browser PDF Tools for Freelancers — Workflow Picks (2026)</h2>
            <p>Example: Watermark proposal PDFs, merge portfolio samples, and compress deliverables under client mailbox caps.</p>
            <p class="lead">Pillar: <a href="/guides/browser-vs-desktop-pdf-tools">browser vs desktop PDF tools</a> · Related: <a href="/guides/choose-pdf-tool">/guides/choose-pdf-tool</a> · Tool page: <a href="/pdf/watermark">/pdf/watermark</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Best Browser PDF Tools for Freelancers — Workflow Picks (2026)</figcaption></figure>
            
            <h2>Browser PDF toolkit for Freelancers</h2>
            <p>Typical tasks: Watermark proposal PDFs, merge portfolio samples, and compress deliverables under client mailbox caps.</p>
            <ul>
            <li><a href="/pdf/merge">Merge</a> — ordered multi-file packs</li>
            <li><a href="/pdf/compress">Compress</a> — email and portal size caps</li>
            <li><a href="/pdf/redaction">Redact</a> — permanent removal before external send</li>
            ...
            <p><a href="/guides/browser-vs-desktop-pdf-tools">Browser vs desktop</a> · <a href="/compare">Compare vendors</a> · <a href="/guides/pdf-tool-security-comparison">Security comparison</a>.</p>
            <p>Tool: <a href="/pdf/watermark">/pdf/watermark</a></p>
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Start workflow</strong> <a href="/pdf/watermark" class="alert-link fw-semibold">Watermark PDF →</a></div>
            ...
            <p class="mt-4"><a href="/pdf/watermark" class="btn btn-primary">Watermark PDF</a> · <a href="/guides/browser-vs-desktop-pdf-tools">Full guide</a></p>
            """;

        private const string BestBrowserPdfToolsForGovernmentContractors = """
            <h2>Best Browser PDF Tools for Government Contractors — Workflow Picks (2026)</h2>
            <p>Example: Redact CUI from draft PDFs, merge proposal volumes in order, and compress before SAM portal upload.</p>
            <p class="lead">Pillar: <a href="/guides/browser-vs-desktop-pdf-tools">browser vs desktop PDF tools</a> · Related: <a href="/guides/choose-pdf-tool">/guides/choose-pdf-tool</a> · Tool page: <a href="/pdf/redaction">/pdf/redaction</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Best Browser PDF Tools for Government Contractors — Workflow Picks (2026)</figcaption></figure>
            
            <h2>Browser PDF toolkit for Government Contractors</h2>
            <p>Typical tasks: Redact CUI from draft PDFs, merge proposal volumes in order, and compress before SAM portal upload.</p>
            <ul>
            <li><a href="/pdf/merge">Merge</a> — ordered multi-file packs</li>
            <li><a href="/pdf/compress">Compress</a> — email and portal size caps</li>
            <li><a href="/pdf/redaction">Redact</a> — permanent removal before external send</li>
            ...
            <p class="mt-4"><a href="/pdf/redaction" class="btn btn-primary">Redact PDF</a> · <a href="/guides/browser-vs-desktop-pdf-tools">Full guide</a></p>
            """;

        private const string BestBrowserPdfToolsForHealthcareAdministrators = """
            <h2>Best Browser PDF Tools for Healthcare Administrators — Workflow Picks (2026)</h2>
            <p>Example: Redact PHI from disclosure PDFs, merge policy packs, and compress portal uploads per BAA policy.</p>
            <p class="lead">Pillar: <a href="/guides/browser-vs-desktop-pdf-tools">browser vs desktop PDF tools</a> · Related: <a href="/guides/choose-pdf-tool">/guides/choose-pdf-tool</a> · Tool page: <a href="/pdf/redaction">/pdf/redaction</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Best Browser PDF Tools for Healthcare Administrators — Workflow Picks (2026)</figcaption></figure>
            
            <h2>Browser PDF toolkit for Healthcare Administrators</h2>
            <p>Typical tasks: Redact PHI from disclosure PDFs, merge policy packs, and compress portal uploads per BAA policy.</p>
            <ul>
            <li><a href="/pdf/merge">Merge</a> — ordered multi-file packs</li>
            <li><a href="/pdf/compress">Compress</a> — email and portal size caps</li>
            <li><a href="/pdf/redaction">Redact</a> — permanent removal before external send</li>
        ...
        private const string BestBrowserPdfToolsForHrTeams = """
            <h2>Best Browser PDF Tools for HR Teams — Workflow Picks (2026)</h2>
            <p>Example: Merge onboarding PDF packs, watermark offer letters DRAFT, and password-protect compensation attachments.</p>
            <p class="lead">Pillar: <a href="/guides/browser-vs-desktop-pdf-tools">browser vs desktop PDF tools</a> · Related: <a href="/guides/choose-pdf-tool">/guides/choose-pdf-tool</a> · Tool page: <a href="/pdf/merge">/pdf/merge</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Best Browser PDF Tools for HR Teams — Workflow Picks (2026)</figcaption></figure>
            
            <h2>Browser PDF toolkit for HR Teams</h2>
            <p>Typical tasks: Merge onboarding PDF packs, watermark offer letters DRAFT, and password-protect compensation attachments.</p>
            <ul>
            <li><a href="/pdf/merge">Merge</a> — ordered multi-file packs</li>
            <li><a href="/pdf/compress">Compress</a> — email and portal size caps</li>
            <li><a href="/pdf/redaction">Redact</a> — permanent removal before external send</li>
        ...
        private const string BestBrowserPdfToolsForInsuranceAgents = """
            <h2>Best Browser PDF Tools for Insurance Agents — Workflow Picks (2026)</h2>
            <p>Example: Merge policy declaration PDFs, compress claims photo scans, and flatten signed application forms.</p>
            <p class="lead">Pillar: <a href="/guides/browser-vs-desktop-pdf-tools">browser vs desktop PDF tools</a> · Related: <a href="/guides/choose-pdf-tool">/guides/choose-pdf-tool</a> · Tool page: <a href="/pdf/merge">/pdf/merge</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Best Browser PDF Tools for Insurance Agents — Workflow Picks (2026)</figcaption></figure>
            
            <h2>Browser PDF toolkit for Insurance Agents</h2>
            <p>Typical tasks: Merge policy declaration PDFs, compress claims photo scans, and flatten signed application forms.</p>
            <ul>
            <li><a href="/pdf/merge">Merge</a> — ordered multi-file packs</li>
            <li><a href="/pdf/compress">Compress</a> — email and portal size caps</li>
            <li><a href="/pdf/redaction">Redact</a> — permanent removal before external send</li>
        ...
        private const string BestBrowserPdfToolsForJournalists = """
            <h2>Best Browser PDF Tools for Journalists — Workflow Picks (2026)</h2>
            <p>Example: Redact confidential sources in FOI bundles, compress exhibit PDFs, and merge document dumps for review.</p>
            <p class="lead">Pillar: <a href="/guides/browser-vs-desktop-pdf-tools">browser vs desktop PDF tools</a> · Related: <a href="/guides/choose-pdf-tool">/guides/choose-pdf-tool</a> · Tool page: <a href="/pdf/redaction">/pdf/redaction</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Best Browser PDF Tools for Journalists — Workflow Picks (2026)</figcaption></figure>
            
            <h2>Browser PDF toolkit for Journalists</h2>
            <p>Typical tasks: Redact confidential sources in FOI bundles, compress exhibit PDFs, and merge document dumps for review.</p>
            <ul>
            <li><a href="/pdf/merge">Merge</a> — ordered multi-file packs</li>
            <li><a href="/pdf/compress">Compress</a> — email and portal size caps</li>
            <li><a href="/pdf/redaction">Redact</a> — permanent removal before external send</li>
        ...
        private const string BestBrowserPdfToolsForLawyers = """
            <h2>Best Browser PDF Tools for Lawyers — Workflow Picks (2026)</h2>
            <p>Example: Redact privileged passages, merge exhibit PDFs in filing order, and watermark negotiation drafts.</p>
            <p class="lead">Pillar: <a href="/guides/browser-vs-desktop-pdf-tools">browser vs desktop PDF tools</a> · Related: <a href="/guides/choose-pdf-tool">/guides/choose-pdf-tool</a> · Tool page: <a href="/pdf/redaction">/pdf/redaction</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Best Browser PDF Tools for Lawyers — Workflow Picks (2026)</figcaption></figure>
            
            <h2>Browser PDF toolkit for Lawyers</h2>
            <p>Typical tasks: Redact privileged passages, merge exhibit PDFs in filing order, and watermark negotiation drafts.</p>
            <ul>
            <li><a href="/pdf/merge">Merge</a> — ordered multi-file packs</li>
            <li><a href="/pdf/compress">Compress</a> — email and portal size caps</li>
            <li><a href="/pdf/redaction">Redact</a> — permanent removal before external send</li>
        ...
        private const string BestBrowserPdfToolsForLibrarians = """
            <h2>Best Browser PDF Tools for Librarians — Workflow Picks (2026)</h2>
            <p>Example: OCR donated scan PDFs, export PDF/A access copies, and compress reading-room handouts.</p>
            <p class="lead">Pillar: <a href="/guides/browser-vs-desktop-pdf-tools">browser vs desktop PDF tools</a> · Related: <a href="/guides/choose-pdf-tool">/guides/choose-pdf-tool</a> · Tool page: <a href="/pdf/ocrpdf">/pdf/ocrpdf</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Best Browser PDF Tools for Librarians — Workflow Picks (2026)</figcaption></figure>
            
            <h2>Browser PDF toolkit for Librarians</h2>
            <p>Typical tasks: OCR donated scan PDFs, export PDF/A access copies, and compress reading-room handouts.</p>
            <ul>
            <li><a href="/pdf/merge">Merge</a> — ordered multi-file packs</li>
            <li><a href="/pdf/compress">Compress</a> — email and portal size caps</li>
            <li><a href="/pdf/redaction">Redact</a> — permanent removal before external send</li>
            ...
            <p class="mt-4"><a href="/pdf/ocrpdf" class="btn btn-primary">OCR PDF</a> · <a href="/guides/browser-vs-desktop-pdf-tools">Full guide</a></p>
            """;

        private const string BestBrowserPdfToolsForMarketers = """
            <h2>Best Browser PDF Tools for Marketers — Workflow Picks (2026)</h2>
            <p>Example: Compress campaign PDF decks, flatten creative proofs, and merge brand guideline annexes.</p>
            <p class="lead">Pillar: <a href="/guides/browser-vs-desktop-pdf-tools">browser vs desktop PDF tools</a> · Related: <a href="/guides/choose-pdf-tool">/guides/choose-pdf-tool</a> · Tool page: <a href="/pdf/compress">/pdf/compress</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Best Browser PDF Tools for Marketers — Workflow Picks (2026)</figcaption></figure>
            
            <h2>Browser PDF toolkit for Marketers</h2>
            <p>Typical tasks: Compress campaign PDF decks, flatten creative proofs, and merge brand guideline annexes.</p>
            <ul>
            <li><a href="/pdf/merge">Merge</a> — ordered multi-file packs</li>
            <li><a href="/pdf/compress">Compress</a> — email and portal size caps</li>
            <li><a href="/pdf/redaction">Redact</a> — permanent removal before external send</li>
        ...
        private const string BestBrowserPdfToolsForNonprofits = """
            <h2>Best Browser PDF Tools for Nonprofits — Workflow Picks (2026)</h2>
            <p>Example: Merge grant application PDFs, compress annual report scans, and publish accessible donor PDFs.</p>
            <p class="lead">Pillar: <a href="/guides/browser-vs-desktop-pdf-tools">browser vs desktop PDF tools</a> · Related: <a href="/guides/choose-pdf-tool">/guides/choose-pdf-tool</a> · Tool page: <a href="/pdf/merge">/pdf/merge</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Best Browser PDF Tools for Nonprofits — Workflow Picks (2026)</figcaption></figure>
            
            <h2>Browser PDF toolkit for Nonprofits</h2>
            <p>Typical tasks: Merge grant application PDFs, compress annual report scans, and publish accessible donor PDFs.</p>
            <ul>
            <li><a href="/pdf/merge">Merge</a> — ordered multi-file packs</li>
            <li><a href="/pdf/compress">Compress</a> — email and portal size caps</li>
            <li><a href="/pdf/redaction">Redact</a> — permanent removal before external send</li>
        ...
        private const string BestBrowserPdfToolsForParalegals = """
            <h2>Best Browser PDF Tools for Paralegals — Workflow Picks (2026)</h2>
            <p>Example: Redact PII from discovery PDFs, merge Bates-numbered sets, and compress production volumes.</p>
            <p class="lead">Pillar: <a href="/guides/browser-vs-desktop-pdf-tools">browser vs desktop PDF tools</a> · Related: <a href="/guides/choose-pdf-tool">/guides/choose-pdf-tool</a> · Tool page: <a href="/pdf/redaction">/pdf/redaction</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Best Browser PDF Tools for Paralegals — Workflow Picks (2026)</figcaption></figure>
            
            <h2>Browser PDF toolkit for Paralegals</h2>
            <p>Typical tasks: Redact PII from discovery PDFs, merge Bates-numbered sets, and compress production volumes.</p>
            <ul>
            <li><a href="/pdf/merge">Merge</a> — ordered multi-file packs</li>
            <li><a href="/pdf/compress">Compress</a> — email and portal size caps</li>
            <li><a href="/pdf/redaction">Redact</a> — permanent removal before external send</li>
        ...
        private const string BestBrowserPdfToolsForPhotographers = """
            <h2>Best Browser PDF Tools for Photographers — Workflow Picks (2026)</h2>
            <p>Example: Compress portfolio PDF proofs, flatten layered lookbooks, and merge client delivery packages.</p>
            <p class="lead">Pillar: <a href="/guides/browser-vs-desktop-pdf-tools">browser vs desktop PDF tools</a> · Related: <a href="/guides/choose-pdf-tool">/guides/choose-pdf-tool</a> · Tool page: <a href="/pdf/compress">/pdf/compress</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Best Browser PDF Tools for Photographers — Workflow Picks (2026)</figcaption></figure>
            
            <h2>Browser PDF toolkit for Photographers</h2>
            <p>Typical tasks: Compress portfolio PDF proofs, flatten layered lookbooks, and merge client delivery packages.</p>
            <ul>
            <li><a href="/pdf/merge">Merge</a> — ordered multi-file packs</li>
            <li><a href="/pdf/compress">Compress</a> — email and portal size caps</li>
            <li><a href="/pdf/redaction">Redact</a> — permanent removal before external send</li>
        ...
        private const string BestBrowserPdfToolsForRealEstateAgents = """
            <h2>Best Browser PDF Tools for Real Estate Agents — Workflow Picks (2026)</h2>
            <p>Example: Merge disclosure PDF packs, compress MLS email attachments, and watermark listing drafts.</p>
            <p class="lead">Pillar: <a href="/guides/browser-vs-desktop-pdf-tools">browser vs desktop PDF tools</a> · Related: <a href="/guides/choose-pdf-tool">/guides/choose-pdf-tool</a> · Tool page: <a href="/pdf/merge">/pdf/merge</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Best Browser PDF Tools for Real Estate Agents — Workflow Picks (2026)</figcaption></figure>
            
            <h2>Browser PDF toolkit for Real Estate Agents</h2>
            <p>Typical tasks: Merge disclosure PDF packs, compress MLS email attachments, and watermark listing drafts.</p>
            <ul>
            <li><a href="/pdf/merge">Merge</a> — ordered multi-file packs</li>
            <li><a href="/pdf/compress">Compress</a> — email and portal size caps</li>
            <li><a href="/pdf/redaction">Redact</a> — permanent removal before external send</li>
        ...
        private const string BestBrowserPdfToolsForRecruiters = """
            <h2>Best Browser PDF Tools for Recruiters — Workflow Picks (2026)</h2>
            <p>Example: Compress candidate resume PDFs, merge interview packet annexes, and redact salary history before share.</p>
            <p class="lead">Pillar: <a href="/guides/browser-vs-desktop-pdf-tools">browser vs desktop PDF tools</a> · Related: <a href="/guides/choose-pdf-tool">/guides/choose-pdf-tool</a> · Tool page: <a href="/pdf/compress">/pdf/compress</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Best Browser PDF Tools for Recruiters — Workflow Picks (2026)</figcaption></figure>
            
            <h2>Browser PDF toolkit for Recruiters</h2>
            <p>Typical tasks: Compress candidate resume PDFs, merge interview packet annexes, and redact salary history before share.</p>
            <ul>
            <li><a href="/pdf/merge">Merge</a> — ordered multi-file packs</li>
            <li><a href="/pdf/compress">Compress</a> — email and portal size caps</li>
            <li><a href="/pdf/redaction">Redact</a> — permanent removal before external send</li>
