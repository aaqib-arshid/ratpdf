namespace ratpdf.Content
{
    ...
    internal static class GuideBodiesWave56
    {
        ...
        {
            "ocr-pdf-for-hr-teams" => OcrPdfForHrTeams,
            "ocr-pdf-for-sales-teams" => OcrPdfForSalesTeams,
            "ocr-pdf-for-marketing-teams" => OcrPdfForMarketingTeams,
            "pdf-error-linearization" => PdfErrorLinearization,
            "ocr-pdf-on-iphone" => OcrPdfOnIphone,
            "ocr-pdf-on-ipad" => OcrPdfOnIpad,
            "ocr-pdf-on-android" => OcrPdfOnAndroid,
            "ocr-pdf-on-chromebook" => OcrPdfOnChromebook,
            "ocr-pdf-on-linux" => OcrPdfOnLinux,
            "ocr-pdf-on-mac" => OcrPdfOnMac,
            "ocr-pdf-on-windows-11" => OcrPdfOnWindows11,
            "best-pdf-compressor-for-lawyers" => BestPdfCompressorForLawyers,
            "best-pdf-compressor-for-students" => BestPdfCompressorForStudents,
            "best-pdf-compressor-for-accountants" => BestPdfCompressorForAccountants,
            "best-pdf-compressor-for-teachers" => BestPdfCompressorForTeachers,
            "best-pdf-compressor-for-freelancers" => BestPdfCompressorForFreelancers,
            "best-pdf-compressor-for-small-business" => BestPdfCompressorForSmallBusiness,
            _ => null
        };

        private const string OcrPdfForHrTeams = """
            <h2>OCR PDF for HR Teams — Searchable Scans (2026)</h2>
            <p>Example: HR OCRs scanned I-9 PDF so compliance can search employee names without re-keying.</p>
            <p class="lead">Pillar: <a href="/guides/ocr-pdf">OCR PDF guide</a> · Related: <a href="/guides/compress-pdf-for-hr-teams">/guides/compress-pdf-for-hr-teams</a> · Tool page: <a href="/pdf/ocrpdf">/pdf/ocrpdf</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> OCR PDF for HR Teams — Searchable Scans (2026)</figcaption></figure>
            
            <h2>OCR PDF for HR Teams</h2>
            <p>Use case: Onboarding pack — HR OCRs scanned I-9 PDF so compliance can search employee names without re-keying.</p>
            <ol>
            ...
            <p>Pair with <a href="/guides/compress-pdf-for-hr-teams">compress workflow</a> · <a href="/guides/merge-pdf-for-hr-teams">merge workflow</a> — <strong>17/17 OCR-for complete</strong>.</p>
        ...
        private const string OcrPdfForSalesTeams = """
            <h2>OCR PDF for Sales Teams — Searchable Scans (2026)</h2>
            <p>Example: AE OCRs legacy proposal scan PDF so team can search pricing terms before renewal.</p>
            <p class="lead">Pillar: <a href="/guides/ocr-pdf">OCR PDF guide</a> · Related: <a href="/guides/compress-pdf-for-sales-teams">/guides/compress-pdf-for-sales-teams</a> · Tool page: <a href="/pdf/ocrpdf">/pdf/ocrpdf</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> OCR PDF for Sales Teams — Searchable Scans (2026)</figcaption></figure>
            
            <h2>OCR PDF for Sales Teams</h2>
            <p>Use case: Proposal archive — AE OCRs legacy proposal scan PDF so team can search pricing terms before renewal.</p>
            <ol>
            <li>Confirm scan is image-only — text does not select</li>
            <li><a href="/pdf/ocrpdf">OCR PDF</a> — match language to source</li>
            <li>Spot-check names and numbers on 3 pages</li>
            ...
            <p>Pair with <a href="/guides/compress-pdf-for-sales-teams">compress workflow</a> · <a href="/guides/merge-pdf-for-sales-teams">merge workflow</a> — <strong>17/17 OCR-for complete</strong>.</p>
            <p>Tool: <a href="/pdf/ocrpdf">/pdf/ocrpdf</a></p>
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Start workflow</strong> <a href="/pdf/ocrpdf" class="alert-link fw-semibold">OCR PDF →</a></div>
        ...
        private const string OcrPdfForMarketingTeams = """
            <h2>OCR PDF for Marketing Teams — Searchable Scans (2026)</h2>
            <p>Example: Marketer OCRs old brand guidelines scan PDF so team searches logo usage rules.</p>
            <p class="lead">Pillar: <a href="/guides/ocr-pdf">OCR PDF guide</a> · Related: <a href="/guides/compress-pdf-for-marketing-teams">/guides/compress-pdf-for-marketing-teams</a> · Tool page: <a href="/pdf/ocrpdf">/pdf/ocrpdf</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> OCR PDF for Marketing Teams — Searchable Scans (2026)</figcaption></figure>
            
            <h2>OCR PDF for Marketing Teams</h2>
            <p>Use case: Brand guidelines — Marketer OCRs old brand guidelines scan PDF so team searches logo usage rules.</p>
            <ol>
            <li>Confirm scan is image-only — text does not select</li>
            <li><a href="/pdf/ocrpdf">OCR PDF</a> — match language to source</li>
            <li>Spot-check names and numbers on 3 pages</li>
            ...
            <p>Pair with <a href="/guides/compress-pdf-for-marketing-teams">compress workflow</a> · <a href="/guides/merge-pdf-for-marketing-teams">merge workflow</a> — <strong>17/17 OCR-for complete</strong>.</p>
            <p>Tool: <a href="/pdf/ocrpdf">/pdf/ocrpdf</a></p>
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Start workflow</strong> <a href="/pdf/ocrpdf" class="alert-link fw-semibold">OCR PDF →</a></div>
        ...
        private const string PdfErrorLinearization = """
            <h2>PDF Linearization Failed — Fix Fast Web View (2026)</h2>
            <p>Example: DevOps sees linearization failed on 200 MB manual PDF on CDN — re-export with Fast Web View before re-upload.</p>
            <p class="lead">Pillar: <a href="/guides/glossary-linearization">linearization glossary</a> · Related: <a href="/guides/compress-pdf-guide">/guides/compress-pdf-guide</a> · Tool page: <a href="/pdf/compress">/pdf/compress</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF Linearization Failed — Fix Fast Web View (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/compress" class="btn btn-primary">Compress PDF</a> · <a href="/guides/glossary-linearization">Full guide</a></p>
            """;

        private const string OcrPdfOnIphone = """
            <h2>OCR PDF on iPhone — Safari Workflow (2026)</h2>
            <p>Example: Field rep OCRs receipt scan PDF on iPhone Safari before expense report.</p>
            <p class="lead">Pillar: <a href="/guides/ocr-pdf">OCR PDF guide</a> · Related: <a href="/guides/pdf-device-workflows-hub">/guides/pdf-device-workflows-hub</a> · Tool page: <a href="/pdf/ocrpdf">/pdf/ocrpdf</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> OCR PDF on iPhone — Safari Workflow (2026)</figcaption></figure>
            
            <h2>OCR PDF on iPhone</h2>
            <p>Browser: Safari — no app install required.</p>
            <ol>
            <li>Open Safari → <a href="/pdf/ocrpdf">OCR PDF</a></li>
        ...
        private const string OcrPdfOnIpad = """
            <h2>OCR PDF on iPad — Safari Workflow (2026)</h2>
            <p>Example: Teacher OCRs worksheet scan on iPad Safari for searchable classroom pack.</p>
            <p class="lead">Pillar: <a href="/guides/ocr-pdf">OCR PDF guide</a> · Related: <a href="/guides/pdf-device-workflows-hub">/guides/pdf-device-workflows-hub</a> · Tool page: <a href="/pdf/ocrpdf">/pdf/ocrpdf</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> OCR PDF on iPad — Safari Workflow (2026)</figcaption></figure>
            
            <h2>OCR PDF on iPad</h2>
            <p>Browser: Safari — no app install required.</p>
            <ol>
            <li>Open Safari → <a href="/pdf/ocrpdf">OCR PDF</a></li>
            <li>Upload scan from Files/Downloads</li>
        ...
        private const string OcrPdfOnAndroid = """
            <h2>OCR PDF on Android — Chrome Workflow (2026)</h2>
            <p>Example: Contractor OCRs site photo log scan on Android Chrome in field.</p>
            <p class="lead">Pillar: <a href="/guides/ocr-pdf">OCR PDF guide</a> · Related: <a href="/guides/pdf-device-workflows-hub">/guides/pdf-device-workflows-hub</a> · Tool page: <a href="/pdf/ocrpdf">/pdf/ocrpdf</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> OCR PDF on Android — Chrome Workflow (2026)</figcaption></figure>
            
            <h2>OCR PDF on Android</h2>
            <p>Browser: Chrome — no app install required.</p>
            <ol>
            <li>Open Chrome → <a href="/pdf/ocrpdf">OCR PDF</a></li>
            <li>Upload scan from Files/Downloads</li>
            <li>Choose OCR language — wait for text layer</li>
            <li>Download searchable PDF — delete from Downloads on shared devices</li>
            </ol>
        ...
        private const string OcrPdfOnChromebook = """
            <h2>OCR PDF on Chromebook — Chrome Workflow (2026)</h2>
            <p>Example: Student OCRs handout scan on school Chromebook before study.</p>
            <p class="lead">Pillar: <a href="/guides/ocr-pdf">OCR PDF guide</a> · Related: <a href="/guides/pdf-device-workflows-hub">/guides/pdf-device-workflows-hub</a> · Tool page: <a href="/pdf/ocrpdf">/pdf/ocrpdf</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> OCR PDF on Chromebook — Chrome Workflow (2026)</figcaption></figure>
            
            <h2>OCR PDF on Chromebook</h2>
            <p>Browser: Chrome — no app install required.</p>
            <ol>
            <li>Open Chrome → <a href="/pdf/ocrpdf">OCR PDF</a></li>
            <li>Upload scan from Files/Downloads</li>
        ...
        private const string OcrPdfOnLinux = """
            <h2>OCR PDF on Linux — Firefox Workflow (2026)</h2>
            <p>Example: Dev OCRs legacy API doc scan on Ubuntu Firefox for wiki search.</p>
            <p class="lead">Pillar: <a href="/guides/ocr-pdf">OCR PDF guide</a> · Related: <a href="/guides/pdf-device-workflows-hub">/guides/pdf-device-workflows-hub</a> · Tool page: <a href="/pdf/ocrpdf">/pdf/ocrpdf</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> OCR PDF on Linux — Firefox Workflow (2026)</figcaption></figure>
            
            <h2>OCR PDF on Linux</h2>
            <p>Browser: Firefox — no app install required.</p>
            <ol>
            <li>Open Firefox → <a href="/pdf/ocrpdf">OCR PDF</a></li>
            <li>Upload scan from Files/Downloads</li>
            <li>Choose OCR language — wait for text layer</li>
            <li>Download searchable PDF — delete from Downloads on shared devices</li>
            </ol>
        ...
        private const string OcrPdfOnMac = """
            <h2>OCR PDF on Mac — Safari Workflow (2026)</h2>
            <p>Example: Designer OCRs client proof scan in Safari without desktop OCR license.</p>
            <p class="lead">Pillar: <a href="/guides/ocr-pdf">OCR PDF guide</a> · Related: <a href="/guides/pdf-device-workflows-hub">/guides/pdf-device-workflows-hub</a> · Tool page: <a href="/pdf/ocrpdf">/pdf/ocrpdf</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> OCR PDF on Mac — Safari Workflow (2026)</figcaption></figure>
            
            <h2>OCR PDF on Mac</h2>
            <p>Browser: Safari — no app install required.</p>
            <ol>
            <li>Open Safari → <a href="/pdf/ocrpdf">OCR PDF</a></li>
            <li>Upload scan from Files/Downloads</li>
        ...
        private const string OcrPdfOnWindows11 = """
            <h2>OCR PDF on Windows 11 — Edge Workflow (2026)</h2>
            <p>Example: Analyst OCRs scanned quarterly report in Edge on corporate laptop.</p>
            <p class="lead">Pillar: <a href="/guides/ocr-pdf">OCR PDF guide</a> · Related: <a href="/guides/pdf-device-workflows-hub">/guides/pdf-device-workflows-hub</a> · Tool page: <a href="/pdf/ocrpdf">/pdf/ocrpdf</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> OCR PDF on Windows 11 — Edge Workflow (2026)</figcaption></figure>
            
            <h2>OCR PDF on Windows 11</h2>
            <p>Browser: Edge — no app install required.</p>
            <ol>
            <li>Open Edge → <a href="/pdf/ocrpdf">OCR PDF</a></li>
            <li>Upload scan from Files/Downloads</li>
            <li>Choose OCR language — wait for text layer</li>
            <li>Download searchable PDF — delete from Downloads on shared devices</li>
            </ol>
        ...
        private const string BestPdfCompressorForLawyers = """
            <h2>Best PDF Compressor for Lawyers — Browser vs Desktop (2026)</h2>
            <p>Example: Paralegal compresses 80 MB discovery PDF to 15 MB before secure file share to co-counsel.</p>
            <p class="lead">Pillar: <a href="/guides/compress-pdf-guide">compress PDF guide</a> · Related: <a href="/guides/best-browser-pdf-tools-for-lawyers">/guides/best-browser-pdf-tools-for-lawyers</a> · Tool page: <a href="/pdf/compress">/pdf/compress</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Best PDF Compressor for Lawyers — Browser vs Desktop (2026)</figcaption></figure>
            
            <h2>PDF compressor picks for Lawyers</h2>
            <p>Typical workflow: Paralegal compresses 80 MB discovery PDF to 15 MB before secure file share to co-counsel.</p>
            <ul>
            ...
            <p><a href="/guides/best-browser-pdf-tools-for-lawyers">Browser tools guide</a> · <a href="/guides/compress-pdf-for-lawyers">Vertical compress guide</a> · <a href="/compare">Compare vendors</a>.</p>
            <p>Tool: <a href="/pdf/compress">/pdf/compress</a></p>
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Start workflow</strong> <a href="/pdf/compress" class="alert-link fw-semibold">Compress PDF →</a></div>
        ...
        private const string BestPdfCompressorForStudents = """
            <h2>Best PDF Compressor for Students — Browser vs Desktop (2026)</h2>
            <p>Example: Student compresses 25 MB textbook scan PDF to 10 MB before LMS upload cap.</p>
            <p class="lead">Pillar: <a href="/guides/compress-pdf-guide">compress PDF guide</a> · Related: <a href="/guides/best-browser-pdf-tools-for-students">/guides/best-browser-pdf-tools-for-students</a> · Tool page: <a href="/pdf/compress">/pdf/compress</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Best PDF Compressor for Students — Browser vs Desktop (2026)</figcaption></figure>
            
            <h2>PDF compressor picks for Students</h2>
            <p>Typical workflow: Student compresses 25 MB textbook scan PDF to 10 MB before LMS upload cap.</p>
            <ul>
            <li><a href="/pdf/compress">Compress PDF</a> — Medium preset first</li>
            <li><a href="/pdf/merge">Merge</a> before compress when bundling scans</li>
            <li><a href="/pdf/ocrpdf">OCR</a> scanned docs before compress if search needed</li>
            ...
            <p><a href="/guides/best-browser-pdf-tools-for-students">Browser tools guide</a> · <a href="/guides/compress-pdf-for-students">Vertical compress guide</a> · <a href="/compare">Compare vendors</a>.</p>
            <p>Tool: <a href="/pdf/compress">/pdf/compress</a></p>
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Start workflow</strong> <a href="/pdf/compress" class="alert-link fw-semibold">Compress PDF →</a></div>
        ...
        private const string BestPdfCompressorForAccountants = """
            <h2>Best PDF Compressor for Accountants — Browser vs Desktop (2026)</h2>
            <p>Example: Staff compresses scanned receipt bundle from 12 MB to 4 MB before partner review email.</p>
            <p class="lead">Pillar: <a href="/guides/compress-pdf-guide">compress PDF guide</a> · Related: <a href="/guides/best-browser-pdf-tools-for-accountants">/guides/best-browser-pdf-tools-for-accountants</a> · Tool page: <a href="/pdf/compress">/pdf/compress</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Best PDF Compressor for Accountants — Browser vs Desktop (2026)</figcaption></figure>
            
            <h2>PDF compressor picks for Accountants</h2>
            <p>Typical workflow: Staff compresses scanned receipt bundle from 12 MB to 4 MB before partner review email.</p>
            <ul>
            <li><a href="/pdf/compress">Compress PDF</a> — Medium preset first</li>
            <li><a href="/pdf/merge">Merge</a> before compress when bundling scans</li>
            <li><a href="/pdf/ocrpdf">OCR</a> scanned docs before compress if search needed</li>
            ...
            <p><a href="/guides/best-browser-pdf-tools-for-accountants">Browser tools guide</a> · <a href="/guides/compress-pdf-for-accountants">Vertical compress guide</a> · <a href="/compare">Compare vendors</a>.</p>
            <p>Tool: <a href="/pdf/compress">/pdf/compress</a></p>
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Start workflow</strong> <a href="/pdf/compress" class="alert-link fw-semibold">Compress PDF →</a></div>
        ...
        private const string BestPdfCompressorForTeachers = """
            <h2>Best PDF Compressor for Teachers — Browser vs Desktop (2026)</h2>
            <p>Example: Instructor compresses reading PDF from 25 MB to 10 MB for Canvas course module.</p>
            <p class="lead">Pillar: <a href="/guides/compress-pdf-guide">compress PDF guide</a> · Related: <a href="/guides/best-browser-pdf-tools-for-teachers">/guides/best-browser-pdf-tools-for-teachers</a> · Tool page: <a href="/pdf/compress">/pdf/compress</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Best PDF Compressor for Teachers — Browser vs Desktop (2026)</figcaption></figure>
            
            <h2>PDF compressor picks for Teachers</h2>
            <p>Typical workflow: Instructor compresses reading PDF from 25 MB to 10 MB for Canvas course module.</p>
            <ul>
            <li><a href="/pdf/compress">Compress PDF</a> — Medium preset first</li>
            <li><a href="/pdf/merge">Merge</a> before compress when bundling scans</li>
            <li><a href="/pdf/ocrpdf">OCR</a> scanned docs before compress if search needed</li>
            ...
            <p><a href="/guides/best-browser-pdf-tools-for-teachers">Browser tools guide</a> · <a href="/guides/compress-pdf-for-education">Vertical compress guide</a> · <a href="/compare">Compare vendors</a>.</p>
            <p>Tool: <a href="/pdf/compress">/pdf/compress</a></p>
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Start workflow</strong> <a href="/pdf/compress" class="alert-link fw-semibold">Compress PDF →</a></div>
        ...
        private const string BestPdfCompressorForFreelancers = """
            <h2>Best PDF Compressor for Freelancers — Browser vs Desktop (2026)</h2>
            <p>Example: Designer compresses portfolio PDF from 22 MB to 9 MB before client Gmail attach.</p>
            <p class="lead">Pillar: <a href="/guides/compress-pdf-guide">compress PDF guide</a> · Related: <a href="/guides/best-browser-pdf-tools-for-freelancers">/guides/best-browser-pdf-tools-for-freelancers</a> · Tool page: <a href="/pdf/compress">/pdf/compress</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Best PDF Compressor for Freelancers — Browser vs Desktop (2026)</figcaption></figure>
            
            <h2>PDF compressor picks for Freelancers</h2>
            <p>Typical workflow: Designer compresses portfolio PDF from 22 MB to 9 MB before client Gmail attach.</p>
            <ul>
            <li><a href="/pdf/compress">Compress PDF</a> — Medium preset first</li>
            <li><a href="/pdf/merge">Merge</a> before compress when bundling scans</li>
            <li><a href="/pdf/ocrpdf">OCR</a> scanned docs before compress if search needed</li>
            ...
            <p><a href="/guides/best-browser-pdf-tools-for-freelancers">Browser tools guide</a> · <a href="/guides/compress-pdf-for-freelancers">Vertical compress guide</a> · <a href="/compare">Compare vendors</a>.</p>
            <p>Tool: <a href="/pdf/compress">/pdf/compress</a></p>
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Start workflow</strong> <a href="/pdf/compress" class="alert-link fw-semibold">Compress PDF →</a></div>
        ...
        private const string BestPdfCompressorForSmallBusiness = """
            <h2>Best PDF Compressor for Small Business — Browser vs Desktop (2026)</h2>
            <p>Example: Owner compresses invoice and contract pack from 18 MB to 8 MB before client portal upload.</p>
            <p class="lead">Pillar: <a href="/guides/compress-pdf-guide">compress PDF guide</a> · Related: <a href="/guides/best-browser-pdf-tools-for-small-business">/guides/best-browser-pdf-tools-for-small-business</a> · Tool page: <a href="/pdf/compress">/pdf/compress</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Best PDF Compressor for Small Business — Browser vs Desktop (2026)</figcaption></figure>
            
            <h2>PDF compressor picks for Small Business</h2>
            <p>Typical workflow: Owner compresses invoice and contract pack from 18 MB to 8 MB before client portal upload.</p>
            <ul>
            <li><a href="/pdf/compress">Compress PDF</a> — Medium preset first</li>
            <li><a href="/pdf/merge">Merge</a> before compress when bundling scans</li>
            <li><a href="/pdf/ocrpdf">OCR</a> scanned docs before compress if search needed</li>
            ...
            <p><a href="/guides/best-browser-pdf-tools-for-small-business">Browser tools guide</a> · <a href="/guides/compress-pdf-for-small-business">Vertical compress guide</a> · <a href="/compare">Compare vendors</a>.</p>
            <p>Tool: <a href="/pdf/compress">/pdf/compress</a></p>
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Start workflow</strong> <a href="/pdf/compress" class="alert-link fw-semibold">Compress PDF →</a></div>
