namespace ratpdf.Content
{
    ...
    internal static class GuideBodiesWave42
    {
        ...
        {
            "convert-to-pdf-a-online" => ConvertToPdfAOnline,
            "pdf-document-retention-periods" => PdfDocumentRetentionPeriods,
            "share-pdf-securely" => SharePdfSecurely,
            "firefox-print-to-pdf" => FirefoxPrintToPdf,
            "linkedin-save-profile-as-pdf" => LinkedinSaveProfileAsPdf,
            "accountant-client-pdf-portal" => AccountantClientPdfPortal,
            "compress-pdf-for-blackboard" => CompressPdfForBlackboard,
            "pdf-error-there-was-an-error-opening-this-document" => PdfErrorThereWasAnErrorOpeningThisDocument,
            "compress-pdf-ssa" => CompressPdfSsa,
            "bank-statement-pdf-workflow-argentina" => BankStatementPdfWorkflowArgentina,
            "bank-statement-pdf-workflow-poland" => BankStatementPdfWorkflowPoland,
            "bank-statement-pdf-workflow-sweden" => BankStatementPdfWorkflowSweden,
            "bank-statement-pdf-workflow-norway" => BankStatementPdfWorkflowNorway,
            "bank-statement-pdf-workflow-denmark" => BankStatementPdfWorkflowDenmark,
            "bank-statement-pdf-workflow-finland" => BankStatementPdfWorkflowFinland,
            "bank-statement-pdf-workflow-portugal" => BankStatementPdfWorkflowPortugal,
            "bank-statement-pdf-workflow-greece" => BankStatementPdfWorkflowGreece,
            _ => null
        };

        private const string ConvertToPdfAOnline = """
            <h2>Convert to PDF/A Online — Archival Workflow (2026)</h2>
            <p>Example: Records clerk validates PDF/A-1b export from Word before county archive ingest.</p>
            <p class="lead">Pillar: <a href="/guides/convert-to-pdf-a">convert to PDF/A</a> · Related: <a href="/guides/pdf-a-archival">/guides/pdf-a-archival</a> · Tool page: <a href="/pdf/compress">/pdf/compress</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Convert to PDF/A Online — Archival Workflow (2026)</figcaption></figure>
        ...
        private const string PdfDocumentRetentionPeriods = """
            <h2>PDF Document Retention Periods — Legal Holds &amp; Destruction (2026)</h2>
            <p>Example: Compliance maps invoice PDF 7-year retention vs contract 10-year — legal hold pauses purge job.</p>
            <p class="lead">Pillar: <a href="/guides/document-retention-pdf">document retention PDF</a> · Related: <a href="/guides/sox-pdf-retention">/guides/sox-pdf-retention</a> · Tool page: <a href="/pdf/pdfmetadata">/pdf/pdfmetadata</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF Document Retention Periods — Legal Holds &amp; Destruction (2026)</figcaption></figure>
        ...
        private const string SharePdfSecurely = """
            <h2>Share PDF Securely — Encrypt, Link &amp; Redact (2026)</h2>
            <p>Example: Consultant encrypts proposal PDF — password via SMS — watermark DRAFT on review copy.</p>
            <p class="lead">Pillar: <a href="/guides/secure-pdf-workflow">secure PDF workflow</a> · Related: <a href="/guides/secure-pdf-before-email">/guides/secure-pdf-before-email</a> · Tool page: <a href="/pdf/password">/pdf/password</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Share PDF Securely — Encrypt, Link &amp; Redact (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/password" class="btn btn-primary">Protect PDF</a> · <a href="/guides/secure-pdf-workflow">Full guide</a></p>
            """;

        private const string FirefoxPrintToPdf = """
            <h2>Firefox Print to PDF — Save Web Pages (2026)</h2>
            <p>Example: Researcher saves Firefox print-to-PDF of policy page — disables headers — archives with date.</p>
            <p class="lead">Pillar: <a href="/guides/edge-print-to-pdf">Edge print to PDF</a> · Related: <a href="/guides/webpage-to-pdf">/guides/webpage-to-pdf</a> · Tool page: <a href="/pdf/doctopdf">/pdf/doctopdf</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Firefox Print to PDF — Save Web Pages (2026)</figcaption></figure>
            ...
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Start workflow</strong> <a href="/pdf/doctopdf" class="alert-link fw-semibold">Save as PDF →</a></div>
            ...
            <p class="mt-4"><a href="/pdf/doctopdf" class="btn btn-primary">Save as PDF</a> · <a href="/guides/edge-print-to-pdf">Full guide</a></p>
            """;

        private const string LinkedinSaveProfileAsPdf = """
            <h2>LinkedIn Save Profile as PDF — Recruiter Export (2026)</h2>
            <p>Example: Recruiter saves candidate LinkedIn profile PDF — compress before ATS upload under 2 MB cap.</p>
            <p class="lead">Pillar: <a href="/guides/compress-pdf-for-linkedin">compress for LinkedIn</a> · Related: <a href="/guides/pdf-job-application-size-limit">/guides/pdf-job-application-size-limit</a> · Tool page: <a href="/compress-pdf-for-job-application">/compress-pdf-for-job-application</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> LinkedIn Save Profile as PDF — Recruiter Export (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/compress" class="btn btn-primary">Compress PDF</a> · <a href="/guides/compress-pdf-for-linkedin">Full guide</a></p>
            """;

        private const string AccountantClientPdfPortal = """
            <h2>Accountant Client PDF Portal — Secure Exchange (2026)</h2>
            <p>Example: CA firm encrypts Form 16 bundle PDF per client — separate portal password — audit log download.</p>
            <p class="lead">Pillar: <a href="/guides/pdf-tools-for-accountants">PDF tools for accountants</a> · Related: <a href="/guides/invoice-pdf-workflow-india">/guides/invoice-pdf-workflow-india</a> · Tool page: <a href="/pdf/password">/pdf/password</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Accountant Client PDF Portal — Secure Exchange (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/password" class="btn btn-primary">Protect PDF</a> · <a href="/guides/pdf-tools-for-accountants">Full guide</a></p>
            """;

        private const string CompressPdfForBlackboard = """
            <h2>Compress PDF for Blackboard — LMS Upload (2026)</h2>
            <p>Example: Professor uploads 15 MB syllabus scan — compress to 6 MB before Blackboard course shell.</p>
            <p class="lead">Pillar: <a href="/guides/compress-pdf-for-lms">compress for LMS</a> · Related: <a href="/guides/submit-homework-pdf-canvas">/guides/submit-homework-pdf-canvas</a> · Tool page: <a href="/compress-pdf">/compress-pdf</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Compress PDF for Blackboard — LMS Upload (2026)</figcaption></figure>
        ...
        private const string PdfErrorThereWasAnErrorOpeningThisDocument = """
            <h2>PDF Error Opening Document — Fix Corrupt &amp; Unsupported Files (2026)</h2>
            <p>Example: User re-downloads bank PDF — still fails — repair tool recovers xref table — opens in Acrobat.</p>
            ...
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF Error Opening Document — Fix Corrupt &amp; Unsupported Files (2026)</figcaption></figure>
        ...
        private const string CompressPdfSsa = """
            <h2>Compress PDF for SSA — Social Security Upload (2026)</h2>
            <p>Example: Claimant compresses medical records PDF support doc for SSA online disability upload.</p>
            <p class="lead">Pillar: <a href="/guides/government-portal-pdf-compress">government portal compress</a> · Related: <a href="/guides/compress-pdf-irs">/guides/compress-pdf-irs</a> · Tool page: <a href="/compress-pdf-for-government-forms">/compress-pdf-for-government-forms</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Compress PDF for SSA — Social Security Upload (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/compress" class="btn btn-primary">Compress PDF</a> · <a href="/guides/government-portal-pdf-compress">Full guide</a></p>
            """;

        private const string BankStatementPdfWorkflowArgentina = """
            <h2>Bank Statement PDF Workflow Argentina — Visa Evidence (2026)</h2>
            <p>Example: Applicant compresses Banco Galicia six-month PDF for Argentina visa financial slot.</p>
            <p class="lead">Pillar: <a href="/guides/visa-application-pdf-workflow-argentina">Argentina visa workflow</a> · Related: <a href="/guides/bank-statement-pdf-visa">/guides/bank-statement-pdf-visa</a> · Tool page: <a href="/compress-pdf-for-visa-application">/compress-pdf-for-visa-application</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Bank Statement PDF Workflow Argentina — Visa Evidence (2026)</figcaption></figure>
            
            <h2>Argentina bank PDF workflow</h2>
            <p>Official export: Banco Nación / Galicia netbank — not mobile screenshot — all pages — account holder visible.</p>
            <ol>
            ...
            <p>Pillar: <a href="/guides/visa-application-pdf-workflow-argentina">Argentina visa workflow</a> · <a href="/guides/bank-statement-pdf-visa">bank statement visa</a>.</p>
            ...
            <p class="mt-4"><a href="/pdf/compress" class="btn btn-primary">Compress PDF</a> · <a href="/guides/visa-application-pdf-workflow-argentina">Full guide</a></p>
            """;

        private const string BankStatementPdfWorkflowPoland = """
            <h2>Bank Statement PDF Workflow Poland — Visa Evidence (2026)</h2>
            <p>Example: Student compresses mBank statement PDF for Poland Schengen visa evidence.</p>
            <p class="lead">Pillar: <a href="/guides/visa-application-pdf-workflow-poland">Poland visa workflow</a> · Related: <a href="/guides/bank-statement-pdf-visa">/guides/bank-statement-pdf-visa</a> · Tool page: <a href="/compress-pdf-for-visa-application">/compress-pdf-for-visa-application</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Bank Statement PDF Workflow Poland — Visa Evidence (2026)</figcaption></figure>
            
            <h2>Poland bank PDF workflow</h2>
            <p>Official export: PKO BP / mBank export — not mobile screenshot — all pages — account holder visible.</p>
            <ol>
            <li>Download netbank PDF — last 3–6 months per visa rules</li>
            <li><a href="/pdf/compress">Compress</a> — Less on scans</li>
            <li>Verify balances and salary credits at 100% zoom</li>
            </ol>
            <p>Pillar: <a href="/guides/visa-application-pdf-workflow-poland">Poland visa workflow</a> · <a href="/guides/bank-statement-pdf-visa">bank statement visa</a>.</p>
            <p>Tool: <a href="/compress-pdf-for-visa-application">/compress-pdf-for-visa-application</a></p>
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Start workflow</strong> <a href="/pdf/compress" class="alert-link fw-semibold">Compress PDF →</a></div>
            ...
            <p class="mt-4"><a href="/pdf/compress" class="btn btn-primary">Compress PDF</a> · <a href="/guides/visa-application-pdf-workflow-poland">Full guide</a></p>
            """;

        private const string BankStatementPdfWorkflowSweden = """
            <h2>Bank Statement PDF Workflow Sweden — Visa Evidence (2026)</h2>
            <p>Example: Worker compresses Swedbank export for Sweden migration funds proof.</p>
            <p class="lead">Pillar: <a href="/guides/visa-application-pdf-workflow-sweden">Sweden visa workflow</a> · Related: <a href="/guides/bank-statement-pdf-visa">/guides/bank-statement-pdf-visa</a> · Tool page: <a href="/compress-pdf-for-visa-application">/compress-pdf-for-visa-application</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Bank Statement PDF Workflow Sweden — Visa Evidence (2026)</figcaption></figure>
            
            <h2>Sweden bank PDF workflow</h2>
            <p>Official export: Swedbank / Nordea PDF — not mobile screenshot — all pages — account holder visible.</p>
            <ol>
            <li>Download netbank PDF — last 3–6 months per visa rules</li>
            <li><a href="/pdf/compress">Compress</a> — Less on scans</li>
            <li>Verify balances and salary credits at 100% zoom</li>
            </ol>
            <p>Pillar: <a href="/guides/visa-application-pdf-workflow-sweden">Sweden visa workflow</a> · <a href="/guides/bank-statement-pdf-visa">bank statement visa</a>.</p>
            <p>Tool: <a href="/compress-pdf-for-visa-application">/compress-pdf-for-visa-application</a></p>
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Start workflow</strong> <a href="/pdf/compress" class="alert-link fw-semibold">Compress PDF →</a></div>
            ...
            <p class="mt-4"><a href="/pdf/compress" class="btn btn-primary">Compress PDF</a> · <a href="/guides/visa-application-pdf-workflow-sweden">Full guide</a></p>
            """;

        private const string BankStatementPdfWorkflowNorway = """
            <h2>Bank Statement PDF Workflow Norway — Visa Evidence (2026)</h2>
            <p>Example: Visitor compresses DNB statement PDF for Norway UDI upload.</p>
            <p class="lead">Pillar: <a href="/guides/visa-application-pdf-workflow-norway">Norway visa workflow</a> · Related: <a href="/guides/bank-statement-pdf-visa">/guides/bank-statement-pdf-visa</a> · Tool page: <a href="/compress-pdf-for-visa-application">/compress-pdf-for-visa-application</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Bank Statement PDF Workflow Norway — Visa Evidence (2026)</figcaption></figure>
            
            <h2>Norway bank PDF workflow</h2>
            <p>Official export: DNB / SpareBank PDF — not mobile screenshot — all pages — account holder visible.</p>
            <ol>
            <li>Download netbank PDF — last 3–6 months per visa rules</li>
            <li><a href="/pdf/compress">Compress</a> — Less on scans</li>
            <li>Verify balances and salary credits at 100% zoom</li>
            </ol>
            <p>Pillar: <a href="/guides/visa-application-pdf-workflow-norway">Norway visa workflow</a> · <a href="/guides/bank-statement-pdf-visa">bank statement visa</a>.</p>
            <p>Tool: <a href="/compress-pdf-for-visa-application">/compress-pdf-for-visa-application</a></p>
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Start workflow</strong> <a href="/pdf/compress" class="alert-link fw-semibold">Compress PDF →</a></div>
            ...
            <p class="mt-4"><a href="/pdf/compress" class="btn btn-primary">Compress PDF</a> · <a href="/guides/visa-application-pdf-workflow-norway">Full guide</a></p>
            """;

        private const string BankStatementPdfWorkflowDenmark = """
            <h2>Bank Statement PDF Workflow Denmark — Visa Evidence (2026)</h2>
            <p>Example: Applicant compresses Danske Bank PDF for SIRI financial evidence.</p>
            <p class="lead">Pillar: <a href="/guides/visa-application-pdf-workflow-denmark">Denmark visa workflow</a> · Related: <a href="/guides/bank-statement-pdf-visa">/guides/bank-statement-pdf-visa</a> · Tool page: <a href="/compress-pdf-for-visa-application">/compress-pdf-for-visa-application</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Bank Statement PDF Workflow Denmark — Visa Evidence (2026)</figcaption></figure>
            
            <h2>Denmark bank PDF workflow</h2>
            <p>Official export: Danske Bank / Nordea — not mobile screenshot — all pages — account holder visible.</p>
            <ol>
            <li>Download netbank PDF — last 3–6 months per visa rules</li>
            <li><a href="/pdf/compress">Compress</a> — Less on scans</li>
            <li>Verify balances and salary credits at 100% zoom</li>
            </ol>
            <p>Pillar: <a href="/guides/visa-application-pdf-workflow-denmark">Denmark visa workflow</a> · <a href="/guides/bank-statement-pdf-visa">bank statement visa</a>.</p>
            <p>Tool: <a href="/compress-pdf-for-visa-application">/compress-pdf-for-visa-application</a></p>
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Start workflow</strong> <a href="/pdf/compress" class="alert-link fw-semibold">Compress PDF →</a></div>
            ...
            <p class="mt-4"><a href="/pdf/compress" class="btn btn-primary">Compress PDF</a> · <a href="/guides/visa-application-pdf-workflow-denmark">Full guide</a></p>
            """;

        private const string BankStatementPdfWorkflowFinland = """
            <h2>Bank Statement PDF Workflow Finland — Visa Evidence (2026)</h2>
            <p>Example: Researcher compresses OP Financial Group statement for Migri slot.</p>
            <p class="lead">Pillar: <a href="/guides/visa-application-pdf-workflow-finland">Finland visa workflow</a> · Related: <a href="/guides/bank-statement-pdf-visa">/guides/bank-statement-pdf-visa</a> · Tool page: <a href="/compress-pdf-for-visa-application">/compress-pdf-for-visa-application</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Bank Statement PDF Workflow Finland — Visa Evidence (2026)</figcaption></figure>
            
            <h2>Finland bank PDF workflow</h2>
            <p>Official export: OP / Nordea Finland — not mobile screenshot — all pages — account holder visible.</p>
            <ol>
            <li>Download netbank PDF — last 3–6 months per visa rules</li>
            <li><a href="/pdf/compress">Compress</a> — Less on scans</li>
            <li>Verify balances and salary credits at 100% zoom</li>
            </ol>
            <p>Pillar: <a href="/guides/visa-application-pdf-workflow-finland">Finland visa workflow</a> · <a href="/guides/bank-statement-pdf-visa">bank statement visa</a>.</p>
            <p>Tool: <a href="/compress-pdf-for-visa-application">/compress-pdf-for-visa-application</a></p>
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Start workflow</strong> <a href="/pdf/compress" class="alert-link fw-semibold">Compress PDF →</a></div>
            ...
            <p class="mt-4"><a href="/pdf/compress" class="btn btn-primary">Compress PDF</a> · <a href="/guides/visa-application-pdf-workflow-finland">Full guide</a></p>
            """;

        private const string BankStatementPdfWorkflowPortugal = """
            <h2>Bank Statement PDF Workflow Portugal — Visa Evidence (2026)</h2>
            <p>Example: Digital nomad compresses Millennium BCP PDF for Portugal visa.</p>
            <p class="lead">Pillar: <a href="/guides/visa-application-pdf-workflow-portugal">Portugal visa workflow</a> · Related: <a href="/guides/bank-statement-pdf-visa">/guides/bank-statement-pdf-visa</a> · Tool page: <a href="/compress-pdf-for-visa-application">/compress-pdf-for-visa-application</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Bank Statement PDF Workflow Portugal — Visa Evidence (2026)</figcaption></figure>
            
            <h2>Portugal bank PDF workflow</h2>
            <p>Official export: Millennium BCP / Caixa — not mobile screenshot — all pages — account holder visible.</p>
            <ol>
            <li>Download netbank PDF — last 3–6 months per visa rules</li>
            <li><a href="/pdf/compress">Compress</a> — Less on scans</li>
            <li>Verify balances and salary credits at 100% zoom</li>
            </ol>
            <p>Pillar: <a href="/guides/visa-application-pdf-workflow-portugal">Portugal visa workflow</a> · <a href="/guides/bank-statement-pdf-visa">bank statement visa</a>.</p>
            <p>Tool: <a href="/compress-pdf-for-visa-application">/compress-pdf-for-visa-application</a></p>
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Start workflow</strong> <a href="/pdf/compress" class="alert-link fw-semibold">Compress PDF →</a></div>
            ...
            <p class="mt-4"><a href="/pdf/compress" class="btn btn-primary">Compress PDF</a> · <a href="/guides/visa-application-pdf-workflow-portugal">Full guide</a></p>
            """;

        private const string BankStatementPdfWorkflowGreece = """
            <h2>Bank Statement PDF Workflow Greece — Visa Evidence (2026)</h2>
            <p>Example: Tourist compresses NBG netbank PDF for Greece Schengen financial proof.</p>
            <p class="lead">Pillar: <a href="/guides/visa-application-pdf-workflow-greece">Greece visa workflow</a> · Related: <a href="/guides/bank-statement-pdf-visa">/guides/bank-statement-pdf-visa</a> · Tool page: <a href="/compress-pdf-for-visa-application">/compress-pdf-for-visa-application</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Bank Statement PDF Workflow Greece — Visa Evidence (2026)</figcaption></figure>
            
            <h2>Greece bank PDF workflow</h2>
            <p>Official export: National Bank of Greece — not mobile screenshot — all pages — account holder visible.</p>
            <ol>
            <li>Download netbank PDF — last 3–6 months per visa rules</li>
            <li><a href="/pdf/compress">Compress</a> — Less on scans</li>
            <li>Verify balances and salary credits at 100% zoom</li>
            </ol>
            <p>Pillar: <a href="/guides/visa-application-pdf-workflow-greece">Greece visa workflow</a> · <a href="/guides/bank-statement-pdf-visa">bank statement visa</a>.</p>
            <p>Tool: <a href="/compress-pdf-for-visa-application">/compress-pdf-for-visa-application</a></p>
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Start workflow</strong> <a href="/pdf/compress" class="alert-link fw-semibold">Compress PDF →</a></div>
            ...
            <p class="mt-4"><a href="/pdf/compress" class="btn btn-primary">Compress PDF</a> · <a href="/guides/visa-application-pdf-workflow-greece">Full guide</a></p>
            """;
