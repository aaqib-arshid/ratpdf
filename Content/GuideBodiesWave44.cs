...
{
    /// <summary>Wave 44 — CREATE batch 8 (17 new editorial guides).</summary>
    internal static class GuideBodiesWave44
    {
        public static string? Get(string slug) => slug switch
        {
            "compress-pdf-ird-nz" => CompressPdfIrdNz,
            "pdf-a-1b-compliance-checklist" => PdfA1BComplianceChecklist,
            "ghostscript-compress-pdf-settings" => GhostscriptCompressPdfSettings,
            "encrypt-pdf-aes-256" => EncryptPdfAes256,
            "screen-reader-pdf" => ScreenReaderPdf,
            "commercial-print-pdf-handoff" => CommercialPrintPdfHandoff,
            "archive-pdf-long-term-storage" => ArchivePdfLongTermStorage,
            "pdf24-vs-ilovepdf" => Pdf24VsIlovepdf,
            "how-pdf-compression-works" => HowPdfCompressionWorks,
            "pdf-error-0x80070057" => PdfError0X80070057,
            "contract-pdf-workflow-argentina" => ContractPdfWorkflowArgentina,
            "contract-pdf-workflow-poland" => ContractPdfWorkflowPoland,
            "contract-pdf-workflow-sweden" => ContractPdfWorkflowSweden,
            "contract-pdf-workflow-norway" => ContractPdfWorkflowNorway,
            "contract-pdf-workflow-denmark" => ContractPdfWorkflowDenmark,
            "contract-pdf-workflow-finland" => ContractPdfWorkflowFinland,
            "contract-pdf-workflow-portugal" => ContractPdfWorkflowPortugal,
            _ => null
        };

        private const string CompressPdfIrdNz = """
            <h2>Compress PDF for IRD NZ — myIR Upload Size (2026)</h2>
            <p>Example: NZ taxpayer compresses deduction receipt scan from 5 MB to 2 MB for myIR document upload.</p>
            <p class="lead">Pillar: <a href="/guides/invoice-generator-new-zealand">invoice generator New Zealand</a> · Related: <a href="/guides/government-portal-pdf-compress">/guides/government-portal-pdf-compress</a> · Tool page: <a href="/compress-pdf-for-government-forms">/compress-pdf-for-government-forms</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Compress PDF for IRD NZ — myIR Upload Size (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/compress" class="btn btn-primary">Compress PDF</a> · <a href="/guides/invoice-generator-new-zealand">Full guide</a></p>
            """;

        private const string PdfA1BComplianceChecklist = """
            <h2>PDF/A-1b Compliance Checklist — Archive Validation (2026)</h2>
            <p>Example: Records manager runs PDF/A-1b checklist before county clerk ingests scanned deed PDF.</p>
            <p class="lead">Pillar: <a href="/guides/convert-to-pdf-a">convert to PDF/A</a> · Related: <a href="/guides/glossary-pdf-a">/guides/glossary-pdf-a</a> · Tool page: <a href="/pdf/compress">/pdf/compress</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF/A-1b Compliance Checklist — Archive Validation (2026)</figcaption></figure>
        ...
        private const string GhostscriptCompressPdfSettings = """
            <h2>Ghostscript Compress PDF Settings — Profiles Explained (2026)</h2>
            <p>Example: IT admin maps RatPDF Less preset to Ghostscript /ebook vs /printer profile expectations.</p>
            <p class="lead">Pillar: <a href="/guides/ghostscript-pdf-compression">Ghostscript compression</a> · Related: <a href="/guides/glossary-ghostscript">/guides/glossary-ghostscript</a> · Tool page: <a href="/compress-pdf">/compress-pdf</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Ghostscript Compress PDF Settings — Profiles Explained (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/compress" class="btn btn-primary">Compress PDF</a> · <a href="/guides/ghostscript-pdf-compression">Full guide</a></p>
            """;

        private const string EncryptPdfAes256 = """
            <h2>Encrypt PDF AES-256 — Password Protection (2026)</h2>
            <p>Example: Legal encrypts M&A diligence PDF AES-256 — owner password for firm — user password for buyer.</p>
            ...
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Encrypt PDF AES-256 — Password Protection (2026)</figcaption></figure>
        ...
        private const string ScreenReaderPdf = """
            <h2>Screen Reader PDF — Tagged Structure &amp; QA (2026)</h2>
            <p>Example: Accessibility tester verifies H1–H3 tags and table headers with NVDA on policy PDF.</p>
            ...
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Screen Reader PDF — Tagged Structure &amp; QA (2026)</figcaption></figure>
        ...
        private const string CommercialPrintPdfHandoff = """
            <h2>Commercial Print PDF Handoff — Prepress Pack (2026)</h2>
            <p>Example: Designer exports PDF/X-1a brochure — flatten fonts — 3 mm bleed — sends to commercial printer.</p>
            <p class="lead">Pillar: <a href="/guides/commercial-print-pdf-checklist">commercial print checklist</a> · Related: <a href="/guides/pdf-x-print-standard">/guides/pdf-x-print-standard</a> · Tool page: <a href="/pdf/flattenpdf">/pdf/flattenpdf</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Commercial Print PDF Handoff — Prepress Pack (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/flattenpdf" class="btn btn-primary">Flatten PDF</a> · <a href="/guides/commercial-print-pdf-checklist">Full guide</a></p>
            """;

        private const string ArchivePdfLongTermStorage = """
            <h2>Archive PDF Long-Term Storage — Tiers &amp; Migration (2026)</h2>
            <p>Example: Archivist stores PDF/A access copy in warm tier — keeps master in records system — migration plan 2030.</p>
            <p class="lead">Pillar: <a href="/guides/long-term-pdf-storage">long-term PDF storage</a> · Related: <a href="/guides/pdf-a-archival">/guides/pdf-a-archival</a> · Tool page: <a href="/pdf/compress">/pdf/compress</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Archive PDF Long-Term Storage — Tiers &amp; Migration (2026)</figcaption></figure>
        ...
        private const string Pdf24VsIlovepdf = """
            <h2>PDF24 vs iLovePDF — Online Tools Compared (2026)</h2>
            <p>Example: SMB compares PDF24 Creator desktop vs iLovePDF browser for weekly merge/compress volume.</p>
            <p class="lead">Pillar: <a href="/compare/ilovepdf-alternative">iLovePDF alternative</a> · Related: <a href="/compare/pdf24-alternative">/compare/pdf24-alternative</a> · Tool page: <a href="/compare">/compare</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF24 vs iLovePDF — Online Tools Compared (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/compare" class="btn btn-primary">compare hub</a> · <a href="/compare/ilovepdf-alternative">Full guide</a></p>
            """;

        private const string HowPdfCompressionWorks = """
            <h2>How PDF Compression Works — Images, Fonts &amp; Linearization (2026)</h2>
            <p>Example: User learns JPEG re-encode shrinks scan 40% while digital Word export shrinks 15% only.</p>
            <p class="lead">Pillar: <a href="/guides/why-is-pdf-file-so-large">why PDF is large</a> · Related: <a href="/guides/ghostscript-pdf-compression">/guides/ghostscript-pdf-compression</a> · Tool page: <a href="/compress-pdf">/compress-pdf</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> How PDF Compression Works — Images, Fonts &amp; Linearization (2026)</figcaption></figure>
        ...
        private const string PdfError0X80070057 = """
            <h2>PDF Error 0x80070057 — Windows Parameter Fix (2026)</h2>
            <p>Example: Windows Print to PDF fails 0x80070057 — invalid page size — reset to A4 — retry export.</p>
            <p class="lead">Pillar: <a href="/guides/pdf-troubleshooting">PDF troubleshooting</a> · Related: <a href="/guides/pdf-won-t-open">/guides/pdf-won-t-open</a> · Tool page: <a href="/pdf/compress">/pdf/compress</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF Error 0x80070057 — Windows Parameter Fix (2026)</figcaption></figure>
        ...
        private const string ContractPdfWorkflowArgentina = """
            <h2>Contract PDF Workflow Argentina — B2B Pack (2026)</h2>
            <p>Example: Agency merges MSA and anexo PDFs before Argentina client signature.</p>
            <p class="lead">Pillar: <a href="/guides/contract-pdf-workflow-germany">contract workflow Germany (reference)</a> · Related: <a href="/guides/contract-pdf-redline-workflow">/guides/contract-pdf-redline-workflow</a> · Tool page: <a href="/pdf/merge">/pdf/merge</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Contract PDF Workflow Argentina — B2B Pack (2026)</figcaption></figure>
            
            <h2>Argentina contract PDF workflow</h2>
            <p>Typical pack: Contrato de prestación de servicios — merge master then numbered exhibits.</p>
            <ol>
            ...
            <p class="mt-4"><a href="/pdf/merge" class="btn btn-primary">Merge PDF</a> · <a href="/guides/contract-pdf-workflow-germany">Full guide</a></p>
            """;

        private const string ContractPdfWorkflowPoland = """
            <h2>Contract PDF Workflow Poland — B2B Pack (2026)</h2>
            <p>Example: SaaS vendor merges umowa ramowa and GDPR DPA exhibit for Poland enterprise deal.</p>
            <p class="lead">Pillar: <a href="/guides/contract-pdf-workflow-germany">contract workflow Germany (reference)</a> · Related: <a href="/guides/contract-pdf-redline-workflow">/guides/contract-pdf-redline-workflow</a> · Tool page: <a href="/pdf/merge">/pdf/merge</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Contract PDF Workflow Poland — B2B Pack (2026)</figcaption></figure>
            
            <h2>Poland contract PDF workflow</h2>
            <p>Typical pack: Umowa B2B — merge master then numbered exhibits.</p>
            <ol>
            <li><a href="/pdf/merge">Merge</a> in signature order — master first</li>
            <li><a href="/pdf/watermark">Watermark</a> DRAFT on negotiation copies</li>
            <li>Flatten after sign — <a href="/pdf/flattenpdf">Flatten PDF</a></li>
        ...
        private const string ContractPdfWorkflowSweden = """
            <h2>Contract PDF Workflow Sweden — B2B Pack (2026)</h2>
            <p>Example: Consultant merges huvudavtal and bilaga PDFs — watermark DRAFT until sign.</p>
            <p class="lead">Pillar: <a href="/guides/contract-pdf-workflow-germany">contract workflow Germany (reference)</a> · Related: <a href="/guides/contract-pdf-redline-workflow">/guides/contract-pdf-redline-workflow</a> · Tool page: <a href="/pdf/merge">/pdf/merge</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Contract PDF Workflow Sweden — B2B Pack (2026)</figcaption></figure>
            
            <h2>Sweden contract PDF workflow</h2>
            <p>Typical pack: Avtal B2B — merge master then numbered exhibits.</p>
            <ol>
            <li><a href="/pdf/merge">Merge</a> in signature order — master first</li>
            <li><a href="/pdf/watermark">Watermark</a> DRAFT on negotiation copies</li>
            <li>Flatten after sign — <a href="/pdf/flattenpdf">Flatten PDF</a></li>
        ...
        private const string ContractPdfWorkflowNorway = """
            <h2>Contract PDF Workflow Norway — B2B Pack (2026)</h2>
            <p>Example: Supplier merges framework agreement and SLA PDF for Norway public sector tender.</p>
            <p class="lead">Pillar: <a href="/guides/contract-pdf-workflow-germany">contract workflow Germany (reference)</a> · Related: <a href="/guides/contract-pdf-redline-workflow">/guides/contract-pdf-redline-workflow</a> · Tool page: <a href="/pdf/merge">/pdf/merge</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Contract PDF Workflow Norway — B2B Pack (2026)</figcaption></figure>
            
            <h2>Norway contract PDF workflow</h2>
            <p>Typical pack: Kontrakt B2B — merge master then numbered exhibits.</p>
            <ol>
            <li><a href="/pdf/merge">Merge</a> in signature order — master first</li>
            <li><a href="/pdf/watermark">Watermark</a> DRAFT on negotiation copies</li>
            <li>Flatten after sign — <a href="/pdf/flattenpdf">Flatten PDF</a></li>
        ...
        private const string ContractPdfWorkflowDenmark = """
            <h2>Contract PDF Workflow Denmark — B2B Pack (2026)</h2>
            <p>Example: Startup merges hovedkontrakt and databehandleraftale before Danish client review.</p>
            <p class="lead">Pillar: <a href="/guides/contract-pdf-workflow-germany">contract workflow Germany (reference)</a> · Related: <a href="/guides/contract-pdf-redline-workflow">/guides/contract-pdf-redline-workflow</a> · Tool page: <a href="/pdf/merge">/pdf/merge</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Contract PDF Workflow Denmark — B2B Pack (2026)</figcaption></figure>
            
            <h2>Denmark contract PDF workflow</h2>
            <p>Typical pack: Kontrakt &amp; bilag — merge master then numbered exhibits.</p>
            <ol>
            <li><a href="/pdf/merge">Merge</a> in signature order — master first</li>
            <li><a href="/pdf/watermark">Watermark</a> DRAFT on negotiation copies</li>
            <li>Flatten after sign — <a href="/pdf/flattenpdf">Flatten PDF</a></li>
        ...
        private const string ContractPdfWorkflowFinland = """
            <h2>Contract PDF Workflow Finland — B2B Pack (2026)</h2>
            <p>Example: Exporter merges master sopimus and English translation PDF for Finland distributor.</p>
            <p class="lead">Pillar: <a href="/guides/contract-pdf-workflow-germany">contract workflow Germany (reference)</a> · Related: <a href="/guides/contract-pdf-redline-workflow">/guides/contract-pdf-redline-workflow</a> · Tool page: <a href="/pdf/merge">/pdf/merge</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Contract PDF Workflow Finland — B2B Pack (2026)</figcaption></figure>
            
            <h2>Finland contract PDF workflow</h2>
            <p>Typical pack: Sopimus B2B — merge master then numbered exhibits.</p>
            <ol>
            <li><a href="/pdf/merge">Merge</a> in signature order — master first</li>
            <li><a href="/pdf/watermark">Watermark</a> DRAFT on negotiation copies</li>
            <li>Flatten after sign — <a href="/pdf/flattenpdf">Flatten PDF</a></li>
        ...
        private const string ContractPdfWorkflowPortugal = """
            <h2>Contract PDF Workflow Portugal — B2B Pack (2026)</h2>
            <p>Example: MSME merges contrato-quadro and anexos PDF for Portugal services agreement.</p>
            <p class="lead">Pillar: <a href="/guides/contract-pdf-workflow-germany">contract workflow Germany (reference)</a> · Related: <a href="/guides/contract-pdf-redline-workflow">/guides/contract-pdf-redline-workflow</a> · Tool page: <a href="/pdf/merge">/pdf/merge</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Contract PDF Workflow Portugal — B2B Pack (2026)</figcaption></figure>
            
            <h2>Portugal contract PDF workflow</h2>
            <p>Typical pack: Contrato B2B — merge master then numbered exhibits.</p>
            <ol>
            <li><a href="/pdf/merge">Merge</a> in signature order — master first</li>
            <li><a href="/pdf/watermark">Watermark</a> DRAFT on negotiation copies</li>
            <li>Flatten after sign — <a href="/pdf/flattenpdf">Flatten PDF</a></li>
