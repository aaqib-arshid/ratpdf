namespace ratpdf.Content
{
    ...
    internal static class GuideBodiesWave18
    {
        ...
        {
            "ocr-pdf-to-text" => OcrPdfToText,
            "pdf-to-text-online" => PdfToTextOnline,
            "how-to-convert-pdf-to-word" => HowToConvertPdfToWord,
            "pdf-to-word-converter" => PdfToWordConverter,
            "how-to-convert-pdf-to-text" => HowToConvertPdfToText,
            "scanned-pdf-to-text" => ScannedPdfToText,
            "pdf-to-text-on-android" => PdfToTextOnAndroid,
            "pdf-to-text-on-iphone" => PdfToTextOnIphone,
            "pdf-to-text-accessibility" => PdfToTextAccessibility,
            "compress-pdf-ucas" => CompressPdfUcas,
            "compress-pdf-uidai" => CompressPdfUidai,
            "compress-pdf-ukvi" => CompressPdfUkvi,
            "compress-pdf-usajobs" => CompressPdfUsajobs,
            "compress-pdf-for-passport-application" => CompressPdfForPassportApplication,
            "compress-pdf-for-university-application" => CompressPdfForUniversityApplication,
            "pdf-to-text-python-workflow" => PdfToTextPythonWorkflow,
            "pdf-to-text-multilingual" => PdfToTextMultilingual,
            _ => null
        };

        private const string OcrPdfToText = """
            <h2>OCR PDF to Text — Full Workflow for Scanned Documents (2026)</h2>
            <p>Example: Paralegal OCRs 200-page scanned deposition, then exports UTF-8 text for keyword review.</p>
            <p class="lead">Pillar: <a href="/guides/pdf-txt-guide">PDF to Text guide</a> · Tool page: <a href="/pdf-to-txt/ocr-pdf-to-text">/pdf-to-txt/ocr-pdf-to-text</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> OCR PDF to Text — Full Workflow for Scanned Documents (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/ocrpdf" class="btn btn-primary">OCR PDF</a> · <a href="/guides/pdf-txt-guide">Pillar guide</a> · <a href="/pdf-to-txt/ocr-pdf-to-text">Related tool page</a></p>
            """;

        private const string PdfToTextOnline = """
            <h2>PDF to Text Online — Extract Plain Text in Your Browser (2026)</h2>
            <p>Example: Researcher pulls quotes from digital journal PDF into Obsidian without retyping.</p>
            <p class="lead">Pillar: <a href="/guides/pdf-txt-guide">PDF to Text guide</a> · Tool page: <a href="/pdf-to-txt/pdf-to-text-online">/pdf-to-txt/pdf-to-text-online</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF to Text Online — Extract Plain Text in Your Browser (2026)</figcaption></figure>
            ...
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Open the primary tool</strong> <a href="/pdf/pdftotext" class="alert-link fw-semibold">PDF to Text →</a></div>
            ...
            <p class="mt-4"><a href="/pdf/pdftotext" class="btn btn-primary">PDF to Text</a> · <a href="/guides/pdf-txt-guide">Pillar guide</a> · <a href="/pdf-to-txt/pdf-to-text-online">Related tool page</a></p>
            """;

        private const string HowToConvertPdfToWord = """
            <h2>How to Convert PDF to Word — Step-by-Step Tutorial (2026)</h2>
            <p>Example: HR edits offer letter PDF exported from legacy system — Word redlines before countersign.</p>
            <p class="lead">Pillar: <a href="/guides/pdf-to-word">PDF to Word guide</a> · Tool page: <a href="/pdf-to-word/how-to-convert-pdf-to-word">/pdf-to-word/how-to-convert-pdf-to-word</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> How to Convert PDF to Word — Step-by-Step Tutorial (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/pdftodoc" class="btn btn-primary">PDF to Word</a> · <a href="/guides/pdf-to-word">Pillar guide</a> · <a href="/pdf-to-word/how-to-convert-pdf-to-word">Related tool page</a></p>
            """;

        private const string PdfToWordConverter = """
            <h2>PDF to Word Converter — Digital vs Scanned, Limits &amp; Best Tools (2026)</h2>
            <p>Example: Freelancer converts client SOW PDF to DOCX for milestone table edits.</p>
            <p class="lead">Pillar: <a href="/guides/pdf-to-word">PDF to Word guide</a> · Tool page: <a href="/pdf-to-word/convert-pdf-to-word">/pdf-to-word/convert-pdf-to-word</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF to Word Converter — Digital vs Scanned, Limits &amp; Best Tools (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/pdftodoc" class="btn btn-primary">PDF to Word</a> · <a href="/guides/pdf-to-word">Pillar guide</a> · <a href="/pdf-to-word/convert-pdf-to-word">Related tool page</a></p>
            """;

        private const string HowToConvertPdfToText = """
            <h2>How to Convert PDF to Text — Digital &amp; Scanned Workflows (2026)</h2>
            <p>Example: Developer exports API spec PDF to .txt for grep and CI documentation search.</p>
            <p class="lead">Pillar: <a href="/guides/pdf-txt-guide">PDF to Text guide</a> · Tool page: <a href="/pdf-to-txt/how-do-i-convert-pdf-to-text">/pdf-to-txt/how-do-i-convert-pdf-to-text</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> How to Convert PDF to Text — Digital &amp; Scanned Workflows (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/pdftotext" class="btn btn-primary">PDF to Text</a> · <a href="/guides/pdf-txt-guide">Pillar guide</a> · <a href="/pdf-to-txt/how-do-i-convert-pdf-to-text">Related tool page</a></p>
            """;

        private const string ScannedPdfToText = """
            <h2>Scanned PDF to Text — OCR Pipeline &amp; Quality Checks (2026)</h2>
            <p>Example: Clinic digitizes paper intake forms — OCR then text export for EHR indexing.</p>
            <p class="lead">Pillar: <a href="/guides/ocr-pdf">OCR PDF guide</a> · Tool page: <a href="/pdf-to-txt/how-scanned-pdf-to-text">/pdf-to-txt/how-scanned-pdf-to-text</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Scanned PDF to Text — OCR Pipeline &amp; Quality Checks (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/ocrpdf" class="btn btn-primary">OCR PDF</a> · <a href="/guides/ocr-pdf">Pillar guide</a> · <a href="/pdf-to-txt/how-scanned-pdf-to-text">Related tool page</a></p>
            """;

        private const string PdfToTextOnAndroid = """
            <h2>PDF to Text on Android — Chrome, Drive &amp; Mobile Workflow (2026)</h2>
            <p>Example: Field auditor extracts clause text from vendor PDF on phone before site visit.</p>
            <p class="lead">Pillar: <a href="/guides/pdf-txt-guide">PDF to Text guide</a> · Tool page: <a href="/pdf-to-txt/pdf-to-text-android">/pdf-to-txt/pdf-to-text-android</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF to Text on Android — Chrome, Drive &amp; Mobile Workflow (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/pdftotext" class="btn btn-primary">PDF to Text</a> · <a href="/guides/pdf-txt-guide">Pillar guide</a> · <a href="/pdf-to-txt/pdf-to-text-android">Related tool page</a></p>
            """;

        private const string PdfToTextOnIphone = """
            <h2>PDF to Text on iPhone — Safari, Files &amp; iOS Workflow (2026)</h2>
            <p>Example: Consultant copies meeting notes from client PDF on iPad during flight.</p>
            <p class="lead">Pillar: <a href="/guides/pdf-txt-guide">PDF to Text guide</a> · Tool page: <a href="/pdf-to-txt/pdf-to-text-iphone">/pdf-to-txt/pdf-to-text-iphone</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF to Text on iPhone — Safari, Files &amp; iOS Workflow (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/pdftotext" class="btn btn-primary">PDF to Text</a> · <a href="/guides/pdf-txt-guide">Pillar guide</a> · <a href="/pdf-to-txt/pdf-to-text-iphone">Related tool page</a></p>
            """;

        private const string PdfToTextAccessibility = """
            <h2>PDF to Text for Accessibility — Screen Readers &amp; Searchable OCR (2026)</h2>
            <p>Example: University disability office OCRs scanned course packs so VoiceOver can read content.</p>
            <p class="lead">Pillar: <a href="/guides/pdf-ua-accessibility">PDF/UA accessibility guide</a> · Tool page: <a href="/pdf-to-txt/pdf-to-text-online">/pdf-to-txt/pdf-to-text-online</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF to Text for Accessibility — Screen Readers &amp; Searchable OCR (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/ocrpdf" class="btn btn-primary">OCR PDF</a> · <a href="/guides/pdf-ua-accessibility">Pillar guide</a> · <a href="/pdf-to-txt/pdf-to-text-online">Related tool page</a></p>
            """;

        private const string CompressPdfUcas = """
            <h2>Compress PDF for UCAS — UK University Application Upload Fix (2026)</h2>
            <p>Example: A-level student shrinks reference letter PDF from 8 MB to 1.2 MB for UCAS reference upload.</p>
            <p class="lead">Pillar: <a href="/guides/compress-pdf-guide">compress PDF guide</a> · Tool page: <a href="/guides/compress-pdf-ucas">/guides/compress-pdf-ucas</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Compress PDF for UCAS — UK University Application Upload Fix (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/compress" class="btn btn-primary">Compress PDF</a> · <a href="/guides/compress-pdf-guide">Pillar guide</a> · <a href="/guides/compress-pdf-ucas">Related tool page</a></p>
            """;

        private const string CompressPdfUidai = """
            <h2>Compress PDF for UIDAI — Aadhaar Update &amp; Enrolment Upload Fix (2026)</h2>
            <p>Example: Resident compresses address proof scan from 4 MB phone photo to 900 KB for uidai.gov.in.</p>
            <p class="lead">Pillar: <a href="/guides/compress-pdf-guide">compress PDF guide</a> · Tool page: <a href="/compress-aadhar-pdf">/compress-aadhar-pdf</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Compress PDF for UIDAI — Aadhaar Update &amp; Enrolment Upload Fix (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/compress" class="btn btn-primary">Compress PDF</a> · <a href="/guides/compress-pdf-guide">Pillar guide</a> · <a href="/compress-aadhar-pdf">Related tool page</a></p>
            """;

        private const string CompressPdfUkvi = """
            <h2>Compress PDF for UKVI — UK Visa Document Upload Fix (2026)</h2>
            <p>Example: Skilled worker applicant fits bank statement PDF under 6 MB UKVI slot.</p>
            <p class="lead">Pillar: <a href="/guides/compress-pdf-for-visa-application">visa application compress guide</a> · Tool page: <a href="/guides/compress-pdf-ukvi">/guides/compress-pdf-ukvi</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Compress PDF for UKVI — UK Visa Document Upload Fix (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/compress" class="btn btn-primary">Compress PDF</a> · <a href="/guides/compress-pdf-for-visa-application">Pillar guide</a> · <a href="/guides/compress-pdf-ukvi">Related tool page</a></p>
            """;

        private const string CompressPdfUsajobs = """
            <h2>Compress PDF for USAJOBS — Federal Resume Upload Fix (2026)</h2>
            <p>Example: Federal applicant compresses 5 MB resume PDF to 2 MB for USAJOBS attachment field.</p>
            <p class="lead">Pillar: <a href="/guides/compress-pdf-for-job-application">job application compress guide</a> · Tool page: <a href="/guides/compress-pdf-usajobs">/guides/compress-pdf-usajobs</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Compress PDF for USAJOBS — Federal Resume Upload Fix (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/compress" class="btn btn-primary">Compress PDF</a> · <a href="/guides/compress-pdf-for-job-application">Pillar guide</a> · <a href="/guides/compress-pdf-usajobs">Related tool page</a></p>
            """;

        private const string CompressPdfForPassportApplication = """
            <h2>Compress PDF for Passport Application — Global Portal Size Fix (2026)</h2>
            <p>Example: Applicant compresses affidavit scan for Passport Seva without blurring MRZ zone.</p>
            <p class="lead">Pillar: <a href="/guides/compress-pdf-guide">compress PDF guide</a> · Tool page: <a href="/guides/compress-pdf-passport-india">/guides/compress-pdf-passport-india</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Compress PDF for Passport Application — Global Portal Size Fix (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/compress" class="btn btn-primary">Compress PDF</a> · <a href="/guides/compress-pdf-guide">Pillar guide</a> · <a href="/guides/compress-pdf-passport-india">Related tool page</a></p>
            """;

        private const string CompressPdfForUniversityApplication = """
            <h2>Compress PDF for University Application — Portal Upload Guide (2026)</h2>
            <p>Example: International student compresses transcript PDF for 3 MB portal cap.</p>
            <p class="lead">Pillar: <a href="/guides/compress-pdf-common-app">Common App compress guide</a> · Tool page: <a href="/guides/compress-pdf-for-university-application">/guides/compress-pdf-for-university-application</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Compress PDF for University Application — Portal Upload Guide (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/compress" class="btn btn-primary">Compress PDF</a> · <a href="/guides/compress-pdf-common-app">Pillar guide</a> · <a href="/guides/compress-pdf-for-university-application">Related tool page</a></p>
            """;

        private const string PdfToTextPythonWorkflow = """
            <h2>PDF to Text Python Workflow — Export, Parse &amp; Automate (2026)</h2>
            <p>Example: Data team exports quarterly report PDFs to UTF-8 .txt then chunks for RAG pipeline.</p>
            <p class="lead">Pillar: <a href="/guides/pdf-txt-guide">PDF to Text guide</a> · Tool page: <a href="/pdf-to-txt/extract-text-from-pdf">/pdf-to-txt/extract-text-from-pdf</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF to Text Python Workflow — Export, Parse &amp; Automate (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/pdftotext" class="btn btn-primary">PDF to Text</a> · <a href="/guides/pdf-txt-guide">Pillar guide</a> · <a href="/pdf-to-txt/extract-text-from-pdf">Related tool page</a></p>
            """;

        private const string PdfToTextMultilingual = """
            <h2>PDF to Text Multilingual — Hindi, Arabic, UTF-8 &amp; OCR (2026)</h2>
            <p>Example: Compliance officer extracts Hindi GST notice text after OCR for translation review.</p>
            <p class="lead">Pillar: <a href="/guides/pdf-txt-guide">PDF to Text guide</a> · Tool page: <a href="/pdf-to-txt/pdf-to-text-online">/pdf-to-txt/pdf-to-text-online</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF to Text Multilingual — Hindi, Arabic, UTF-8 &amp; OCR (2026)</figcaption></figure>
