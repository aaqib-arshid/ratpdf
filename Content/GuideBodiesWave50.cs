namespace ratpdf.Content
{
    ...
    internal static class GuideBodiesWave50
    {
        ...
        {
            "pdf-retention-schedule-by-type" => PdfRetentionScheduleByType,
            "pdf-error-xfa-form" => PdfErrorXfaForm,
            "split-pdf-on-ipad" => SplitPdfOnIpad,
            "split-pdf-on-android" => SplitPdfOnAndroid,
            "split-pdf-on-chromebook" => SplitPdfOnChromebook,
            "split-pdf-on-linux" => SplitPdfOnLinux,
            "split-pdf-on-windows-11" => SplitPdfOnWindows11,
            "beginner-scanned-vs-digital-pdf" => BeginnerScannedVsDigitalPdf,
            "pdf-approval-workflow-no-adobe" => PdfApprovalWorkflowNoAdobe,
            "fix-pdf-low-contrast-text" => FixPdfLowContrastText,
            "pdf-prints-grayscale-only" => PdfPrintsGrayscaleOnly,
            "pdf-records-management-policy" => PdfRecordsManagementPolicy,
            "pdf-to-csv" => PdfToCsv,
            "merge-pdf-for-lawyers" => MergePdfForLawyers,
            "merge-pdf-for-accountants" => MergePdfForAccountants,
            "merge-pdf-for-healthcare" => MergePdfForHealthcare,
            "merge-pdf-for-real-estate" => MergePdfForRealEstate,
            _ => null
        };

        private const string PdfRetentionScheduleByType = """
            <h2>PDF Retention Schedule by Document Type — Matrix (2026)</h2>
            <p>Example: Compliance publishes matrix — tax invoice 7 years — contract 10 years — HR 5 years — legal hold overrides.</p>
            <p class="lead">Pillar: <a href="/guides/pdf-retention-policy">PDF retention policy</a> · Related: <a href="/guides/pdf-document-retention-periods">/guides/pdf-document-retention-periods</a> · Tool page: <a href="/pdf/pdfmetadata">/pdf/pdfmetadata</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF Retention Schedule by Document Type — Matrix (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/pdfmetadata" class="btn btn-primary">PDF Metadata</a> · <a href="/guides/pdf-retention-policy">Full guide</a></p>
            """;

        private const string PdfErrorXfaForm = """
            <h2>XFA PDF Form Not Supported — Fix &amp; Migrate (2026)</h2>
            <p>Example: Browser viewer shows XFA not supported — rebuild form as AcroForm — test in Reader before republish.</p>
            <p class="lead">Pillar: <a href="/guides/xfa-to-acroform-convert">XFA to AcroForm convert</a> · Related: <a href="/guides/glossary-xfa-forms">/guides/glossary-xfa-forms</a> · Tool page: <a href="/pdf/editpdf">/pdf/editpdf</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> XFA PDF Form Not Supported — Fix &amp; Migrate (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/editpdf" class="btn btn-primary">Edit PDF</a> · <a href="/guides/xfa-to-acroform-convert">Full guide</a></p>
            """;

        private const string SplitPdfOnIpad = """
            <h2>Split PDF on iPad — Safari Extract Workflow (2026)</h2>
            <p>Example: Attorney extracts one exhibit page from deposition PDF on iPad before client email.</p>
            <p class="lead">Pillar: <a href="/guides/split-pdf-on-mac">split PDF on Mac (reference)</a> · Related: <a href="/guides/pdf-device-workflows-hub">/guides/pdf-device-workflows-hub</a> · Tool page: <a href="/pdf/split">/pdf/split</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Split PDF on iPad — Safari Extract Workflow (2026)</figcaption></figure>
            
            <h2>Split PDF on iPad</h2>
            <p>Browser: Safari — extract page range without desktop install.</p>
            <ol>
            <li>Open Safari → <a href="/pdf/split">Split PDF</a></li>
            ...
            <p>Tool: <a href="/pdf/split">/pdf/split</a></p>
            ...
            <p class="mt-4"><a href="/pdf/split" class="btn btn-primary">Split PDF</a> · <a href="/guides/split-pdf-on-mac">Full guide</a></p>
            """;

        private const string SplitPdfOnAndroid = """
            <h2>Split PDF on Android — Chrome Extract Workflow (2026)</h2>
            <p>Example: Field tech splits warranty PDF page from manual on Android phone before WhatsApp send.</p>
            <p class="lead">Pillar: <a href="/guides/split-pdf-on-mac">split PDF on Mac (reference)</a> · Related: <a href="/guides/pdf-device-workflows-hub">/guides/pdf-device-workflows-hub</a> · Tool page: <a href="/pdf/split">/pdf/split</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Split PDF on Android — Chrome Extract Workflow (2026)</figcaption></figure>
            
            <h2>Split PDF on Android</h2>
            <p>Browser: Chrome — extract page range without desktop install.</p>
            <ol>
            <li>Open Chrome → <a href="/pdf/split">Split PDF</a></li>
            <li>Upload PDF from Files/Downloads</li>
            <li>Enter page range or extract single page</li>
            <li>Download split PDF — <a href="/pdf/compress">compress</a> if email cap</li>
            </ol>
        ...
        private const string SplitPdfOnChromebook = """
            <h2>Split PDF on Chromebook — Chrome Extract Workflow (2026)</h2>
            <p>Example: Student extracts one chapter PDF from textbook scan on school Chromebook.</p>
            <p class="lead">Pillar: <a href="/guides/split-pdf-on-mac">split PDF on Mac (reference)</a> · Related: <a href="/guides/pdf-device-workflows-hub">/guides/pdf-device-workflows-hub</a> · Tool page: <a href="/pdf/split">/pdf/split</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Split PDF on Chromebook — Chrome Extract Workflow (2026)</figcaption></figure>
            
            <h2>Split PDF on Chromebook</h2>
            <p>Browser: Chrome — extract page range without desktop install.</p>
            <ol>
            <li>Open Chrome → <a href="/pdf/split">Split PDF</a></li>
            <li>Upload PDF from Files/Downloads</li>
        ...
        private const string SplitPdfOnLinux = """
            <h2>Split PDF on Linux — Firefox Extract Workflow (2026)</h2>
            <p>Example: Engineer splits drawing sheet from 200-page spec PDF on Ubuntu browser.</p>
            <p class="lead">Pillar: <a href="/guides/split-pdf-on-mac">split PDF on Mac (reference)</a> · Related: <a href="/guides/pdf-device-workflows-hub">/guides/pdf-device-workflows-hub</a> · Tool page: <a href="/pdf/split">/pdf/split</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Split PDF on Linux — Firefox Extract Workflow (2026)</figcaption></figure>
            
            <h2>Split PDF on Linux</h2>
            <p>Browser: Firefox — extract page range without desktop install.</p>
            <ol>
            <li>Open Firefox → <a href="/pdf/split">Split PDF</a></li>
            <li>Upload PDF from Files/Downloads</li>
            <li>Enter page range or extract single page</li>
            <li>Download split PDF — <a href="/pdf/compress">compress</a> if email cap</li>
            </ol>
        ...
        private const string SplitPdfOnWindows11 = """
            <h2>Split PDF on Windows 11 — Edge Extract Workflow (2026)</h2>
            <p>Example: Paralegal extracts Bates range from production PDF in Edge without Acrobat.</p>
            <p class="lead">Pillar: <a href="/guides/split-pdf-on-mac">split PDF on Mac (reference)</a> · Related: <a href="/guides/pdf-device-workflows-hub">/guides/pdf-device-workflows-hub</a> · Tool page: <a href="/pdf/split">/pdf/split</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Split PDF on Windows 11 — Edge Extract Workflow (2026)</figcaption></figure>
            
            <h2>Split PDF on Windows 11</h2>
            <p>Browser: Edge — extract page range without desktop install.</p>
            <ol>
            <li>Open Edge → <a href="/pdf/split">Split PDF</a></li>
            <li>Upload PDF from Files/Downloads</li>
            <li>Enter page range or extract single page</li>
            <li>Download split PDF — <a href="/pdf/compress">compress</a> if email cap</li>
            </ol>
        ...
        private const string BeginnerScannedVsDigitalPdf = """
            <h2>Scanned vs Digital PDF — How to Tell &amp; What to Do (2026)</h2>
            <p>Example: User tries select-all on invoice PDF — no text — scan needs OCR before PDF to Word or search.</p>
            <p class="lead">Pillar: <a href="/guides/what-is-a-pdf-file">what is a PDF</a> · Related: <a href="/guides/scanned-pdf-to-word">/guides/scanned-pdf-to-word</a> · Tool page: <a href="/pdf/ocrpdf">/pdf/ocrpdf</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Scanned vs Digital PDF — How to Tell &amp; What to Do (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/ocrpdf" class="btn btn-primary">OCR PDF</a> · <a href="/guides/what-is-a-pdf-file">Full guide</a></p>
            """;

        private const string PdfApprovalWorkflowNoAdobe = """
            <h2>PDF Approval Workflow Without Adobe — Browser Sign-Off (2026)</h2>
            <p>Example: SMB approves vendor SOW — watermark DRAFT — merge exhibits — flatten — e-sign in DocuSign without Acrobat license.</p>
            <p class="lead">Pillar: <a href="/guides/pdf-review-workflow">PDF review workflow</a> · Related: <a href="/guides/browser-vs-desktop-pdf-tools">/guides/browser-vs-desktop-pdf-tools</a> · Tool page: <a href="/pdf/watermark">/pdf/watermark</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF Approval Workflow Without Adobe — Browser Sign-Off (2026)</figcaption></figure>
        ...
        private const string FixPdfLowContrastText = """
            <h2>Fix PDF Low Contrast Text — WCAG Color Fixes (2026)</h2>
            <p>Example: Public notice PDF fails WCAG — light gray body text on white — darken to 4.5:1 contrast — retag and republish.</p>
            <p class="lead">Pillar: <a href="/guides/pdf-ua-accessibility">PDF/UA accessibility</a> · Related: <a href="/guides/fix-pdf-untagged-content">/guides/fix-pdf-untagged-content</a> · Tool page: <a href="/pdf/ocrpdf">/pdf/ocrpdf</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Fix PDF Low Contrast Text — WCAG Color Fixes (2026)</figcaption></figure>
        ...
        private const string PdfPrintsGrayscaleOnly = """
            <h2>PDF Prints Grayscale Only — Color Driver Fixes (2026)</h2>
            <p>Example: Brochure PDF prints black and white on color MFP — disable grayscale in driver — check print in grayscale off.</p>
            <p class="lead">Pillar: <a href="/guides/pdf-printing-guide">PDF printing guide</a> · Related: <a href="/guides/print-pdf-black-and-white">/guides/print-pdf-black-and-white</a> · Tool page: <a href="/pdf/flattenpdf">/pdf/flattenpdf</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF Prints Grayscale Only — Color Driver Fixes (2026)</figcaption></figure>
        ...
        private const string PdfRecordsManagementPolicy = """
            <h2>PDF Records Management Policy — Template &amp; Controls (2026)</h2>
            <p>Example: Records officer drafts RM policy — classification schema — retention class in metadata — destruction approval workflow.</p>
            <p class="lead">Pillar: <a href="/guides/document-retention-pdf">document retention PDF</a> · Related: <a href="/guides/pdf-standards-archiving-hub">/guides/pdf-standards-archiving-hub</a> · Tool page: <a href="/pdf/pdfmetadata">/pdf/pdfmetadata</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF Records Management Policy — Template &amp; Controls (2026)</figcaption></figure>
        ...
        private const string PdfToCsv = """
            <h2>PDF to CSV — Extract Table Data Workflow (2026)</h2>
            <p>Example: Analyst exports invoice table PDF — text extract — paste to spreadsheet — or PDF to Excel for complex tables.</p>
            <p class="lead">Pillar: <a href="/guides/pdf-to-text-online">PDF to text online</a> · Related: <a href="/guides/pdf-to-word">/guides/pdf-to-word</a> · Tool page: <a href="/pdf/pdftotext">/pdf/pdftotext</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF to CSV — Extract Table Data Workflow (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/pdftotext" class="btn btn-primary">PDF to Text</a> · <a href="/guides/pdf-to-text-online">Full guide</a></p>
            """;

        private const string MergePdfForLawyers = """
            <h2>Merge PDF for Lawyers — Exhibits Workflow (2026)</h2>
            <p>Example: Litigation team merges exhibit PDFs in filing order — watermark DRAFT until court-ready export.</p>
            ...
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Merge PDF for Lawyers — Exhibits Workflow (2026)</figcaption></figure>
            
            <h2>Merge PDF for Lawyers</h2>
            <p>Typical pack: Exhibits — Litigation team merges exhibit PDFs in filing order — watermark DRAFT until court-ready export.</p>
            <ol>
        ...
        private const string MergePdfForAccountants = """
            <h2>Merge PDF for Accountants — Audit packs Workflow (2026)</h2>
            <p>Example: Audit team merges bank statement and support PDFs by account before partner review.</p>
            ...
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Merge PDF for Accountants — Audit packs Workflow (2026)</figcaption></figure>
            
            <h2>Merge PDF for Accountants</h2>
            <p>Typical pack: Audit packs — Audit team merges bank statement and support PDFs by account before partner review.</p>
            <ol>
            <li>Numeric filename prefixes before upload</li>
            <li><a href="/pdf/merge">Merge</a> in delivery order</li>
            <li><a href="/pdf/watermark">Watermark</a> DRAFT if pre-approval</li>
        ...
        private const string MergePdfForHealthcare = """
            <h2>Merge PDF for Healthcare — Clinical packs Workflow (2026)</h2>
            <p>Example: Admin merges policy and consent PDFs for committee packet — HIPAA upload policy check first.</p>
            ...
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Merge PDF for Healthcare — Clinical packs Workflow (2026)</figcaption></figure>
            
            <h2>Merge PDF for Healthcare</h2>
            <p>Typical pack: Clinical packs — Admin merges policy and consent PDFs for committee packet — HIPAA upload policy check first.</p>
            <ol>
            <li>Numeric filename prefixes before upload</li>
            <li><a href="/pdf/merge">Merge</a> in delivery order</li>
            <li><a href="/pdf/watermark">Watermark</a> DRAFT if pre-approval</li>
        ...
        private const string MergePdfForRealEstate = """
            <h2>Merge PDF for Real Estate — Disclosure packs Workflow (2026)</h2>
            <p>Example: Agent merges disclosure PDFs in MLS order before buyer signature packet.</p>
            ...
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Merge PDF for Real Estate — Disclosure packs Workflow (2026)</figcaption></figure>
            
            <h2>Merge PDF for Real Estate</h2>
            <p>Typical pack: Disclosure packs — Agent merges disclosure PDFs in MLS order before buyer signature packet.</p>
            <ol>
            <li>Numeric filename prefixes before upload</li>
            <li><a href="/pdf/merge">Merge</a> in delivery order</li>
            <li><a href="/pdf/watermark">Watermark</a> DRAFT if pre-approval</li>
