namespace ratpdf.Content
{
    ...
    internal static class GuideBodiesWave60
    {
        ...
        {
            "ocr-pdf-italian" => OcrPdfItalian,
            "ocr-pdf-dutch" => OcrPdfDutch,
            "ocr-pdf-turkish" => OcrPdfTurkish,
            "ocr-pdf-vietnamese" => OcrPdfVietnamese,
            "ocr-pdf-thai" => OcrPdfThai,
            "ocr-pdf-hebrew" => OcrPdfHebrew,
            "ocr-pdf-polish" => OcrPdfPolish,
            "pdf-to-odt" => PdfToOdt,
            "pdf-to-notion" => PdfToNotion,
            "pdf-to-kindle" => PdfToKindle,
            "pdf-to-xml" => PdfToXml,
            "beginner-pdf-color-spaces" => BeginnerPdfColorSpaces,
            "beginner-pdf-font-subsetting" => BeginnerPdfFontSubsetting,
            "beginner-pdf-linearization" => BeginnerPdfLinearization,
            "pdf-handoff-design-to-dev" => PdfHandoffDesignToDev,
            "pdf-archive-metadata-schema" => PdfArchiveMetadataSchema,
            "pdf-shared-drive-naming-convention" => PdfSharedDriveNamingConvention,
            _ => null
        };

        private const string OcrPdfItalian = """
            <h2>OCR PDF in Italian — Searchable Italian Scans (2026)</h2>
            <p>Example: Rome supplier invoice scan with à, è, é, ì, ò, ù amounts.</p>
            ...
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> OCR PDF in Italian — Searchable Italian Scans (2026)</figcaption></figure>
            
            <h2>OCR PDF in Italian</h2>
            <p>Script: Latin + accents. Example: Rome supplier invoice scan with à, è, é, ì, ò, ù amounts.</p>
            <ol>
            <li>Scan at 300 DPI grayscale — low DPI is the top cause of Italian OCR errors</li>
            <li><a href="/pdf/ocrpdf">OCR PDF</a> — select Italian as the recognition language</li>
            <li>Grave and acute accents matter on legal terms — proofread totals and partita IVA after OCR.</li>
        ...
        private const string OcrPdfDutch = """
            <h2>OCR PDF in Dutch — Searchable Dutch Scans (2026)</h2>
            <p>Example: Amsterdam vendor contract scan with ij and diaeresis (ë, ï).</p>
            <p class="lead">Pillar: <a href="/guides/ocr-pdf">OCR PDF guide</a> · Related: <a href="/guides/make-scanned-pdf-searchable">/guides/make-scanned-pdf-searchable</a> · Tool page: <a href="/pdf/ocrpdf">/pdf/ocrpdf</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> OCR PDF in Dutch — Searchable Dutch Scans (2026)</figcaption></figure>
            
            <h2>OCR PDF in Dutch</h2>
            <p>Script: Latin + ij digraph. Example: Amsterdam vendor contract scan with ij and diaeresis (ë, ï).</p>
            <ol>
            <li>Scan at 300 DPI grayscale — low DPI is the top cause of Dutch OCR errors</li>
            <li><a href="/pdf/ocrpdf">OCR PDF</a> — select Dutch as the recognition language</li>
            <li>The ij digraph and trema can mis-split — search the viewer for key nouns and verify BTW/IBAN fields.</li>
            <li>Need layout edits? <a href="/pdf/pdftodoc">PDF to Word</a> preserves structure better than plain text</li>
            </ol>
            <p>More languages: <a href="/guides/ocr-pdf-spanish">Spanish</a> · <a href="/guides/ocr-pdf-french">French</a> · <a href="/guides/ocr-pdf-arabic">Arabic</a> · <a href="/guides/ocr-pdf-poor-quality">Poor-quality scans</a>.</p>
            <p>Tool: <a href="/pdf/ocrpdf">/pdf/ocrpdf</a></p>
        ...
        private const string OcrPdfTurkish = """
            <h2>OCR PDF in Turkish — Searchable Turkish Scans (2026)</h2>
            <p>Example: Istanbul lease scan with ı, i, ş, ç, ğ, ö, ü.</p>
            <p class="lead">Pillar: <a href="/guides/ocr-pdf">OCR PDF guide</a> · Related: <a href="/guides/make-scanned-pdf-searchable">/guides/make-scanned-pdf-searchable</a> · Tool page: <a href="/pdf/ocrpdf">/pdf/ocrpdf</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> OCR PDF in Turkish — Searchable Turkish Scans (2026)</figcaption></figure>
            
            <h2>OCR PDF in Turkish</h2>
            <p>Script: Latin + dotted/dotless i. Example: Istanbul lease scan with ı, i, ş, ç, ğ, ö, ü.</p>
            <ol>
            <li>Scan at 300 DPI grayscale — low DPI is the top cause of Turkish OCR errors</li>
            <li><a href="/pdf/ocrpdf">OCR PDF</a> — select Turkish as the recognition language</li>
            <li>Dotted i (i) vs dotless i (ı) is a common OCR error — proofread names and the vergi numarası carefully.</li>
            <li>Need layout edits? <a href="/pdf/pdftodoc">PDF to Word</a> preserves structure better than plain text</li>
            </ol>
            <p>More languages: <a href="/guides/ocr-pdf-spanish">Spanish</a> · <a href="/guides/ocr-pdf-french">French</a> · <a href="/guides/ocr-pdf-arabic">Arabic</a> · <a href="/guides/ocr-pdf-poor-quality">Poor-quality scans</a>.</p>
            <p>Tool: <a href="/pdf/ocrpdf">/pdf/ocrpdf</a></p>
        ...
        private const string OcrPdfVietnamese = """
            <h2>OCR PDF in Vietnamese — Searchable Vietnamese Scans (2026)</h2>
            <p>Example: Hanoi business license scan with stacked diacritics and tone marks.</p>
            <p class="lead">Pillar: <a href="/guides/ocr-pdf">OCR PDF guide</a> · Related: <a href="/guides/make-scanned-pdf-searchable">/guides/make-scanned-pdf-searchable</a> · Tool page: <a href="/pdf/ocrpdf">/pdf/ocrpdf</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> OCR PDF in Vietnamese — Searchable Vietnamese Scans (2026)</figcaption></figure>
            
            <h2>OCR PDF in Vietnamese</h2>
            <p>Script: Latin + tone marks. Example: Hanoi business license scan with stacked diacritics and tone marks.</p>
            <ol>
            <li>Scan at 300 DPI grayscale — low DPI is the top cause of Vietnamese OCR errors</li>
            <li><a href="/pdf/ocrpdf">OCR PDF</a> — select Vietnamese as the recognition language</li>
            <li>Multiple diacritics per vowel raise error rates — verify names and figures at 300 DPI, proofread tone marks.</li>
            <li>Need layout edits? <a href="/pdf/pdftodoc">PDF to Word</a> preserves structure better than plain text</li>
            </ol>
            <p>More languages: <a href="/guides/ocr-pdf-spanish">Spanish</a> · <a href="/guides/ocr-pdf-french">French</a> · <a href="/guides/ocr-pdf-arabic">Arabic</a> · <a href="/guides/ocr-pdf-poor-quality">Poor-quality scans</a>.</p>
            <p>Tool: <a href="/pdf/ocrpdf">/pdf/ocrpdf</a></p>
        ...
        private const string OcrPdfThai = """
            <h2>OCR PDF in Thai — Searchable Thai Scans (2026)</h2>
            <p>Example: Bangkok rental agreement scan in continuous Thai script.</p>
            <p class="lead">Pillar: <a href="/guides/ocr-pdf">OCR PDF guide</a> · Related: <a href="/guides/make-scanned-pdf-searchable">/guides/make-scanned-pdf-searchable</a> · Tool page: <a href="/pdf/ocrpdf">/pdf/ocrpdf</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> OCR PDF in Thai — Searchable Thai Scans (2026)</figcaption></figure>
            
            <h2>OCR PDF in Thai</h2>
            <p>Script: Thai script (no word spaces). Example: Bangkok rental agreement scan in continuous Thai script.</p>
            <ol>
            <li>Scan at 300 DPI grayscale — low DPI is the top cause of Thai OCR errors</li>
            <li><a href="/pdf/ocrpdf">OCR PDF</a> — select Thai as the recognition language</li>
            <li>Thai has no spaces between words, so line breaks may shift — expect manual reflow; use PDF to Word for layout edits.</li>
            <li>Need layout edits? <a href="/pdf/pdftodoc">PDF to Word</a> preserves structure better than plain text</li>
            </ol>
            <p>More languages: <a href="/guides/ocr-pdf-spanish">Spanish</a> · <a href="/guides/ocr-pdf-french">French</a> · <a href="/guides/ocr-pdf-arabic">Arabic</a> · <a href="/guides/ocr-pdf-poor-quality">Poor-quality scans</a>.</p>
            <p>Tool: <a href="/pdf/ocrpdf">/pdf/ocrpdf</a></p>
        ...
        private const string OcrPdfHebrew = """
            <h2>OCR PDF in Hebrew — Searchable Hebrew Scans (2026)</h2>
            <p>Example: Tel Aviv employment contract scan with Hebrew and English clauses.</p>
            <p class="lead">Pillar: <a href="/guides/ocr-pdf">OCR PDF guide</a> · Related: <a href="/guides/make-scanned-pdf-searchable">/guides/make-scanned-pdf-searchable</a> · Tool page: <a href="/pdf/ocrpdf">/pdf/ocrpdf</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> OCR PDF in Hebrew — Searchable Hebrew Scans (2026)</figcaption></figure>
            
            <h2>OCR PDF in Hebrew</h2>
            <p>Script: Hebrew RTL. Example: Tel Aviv employment contract scan with Hebrew and English clauses.</p>
            <ol>
            <li>Scan at 300 DPI grayscale — low DPI is the top cause of Hebrew OCR errors</li>
            <li><a href="/pdf/ocrpdf">OCR PDF</a> — select Hebrew as the recognition language</li>
            <li>RTL reading order can shuffle in plain .txt export — keep PDF to Word output for mixed Hebrew/English layout.</li>
            <li>Need layout edits? <a href="/pdf/pdftodoc">PDF to Word</a> preserves structure better than plain text</li>
            </ol>
            <p>More languages: <a href="/guides/ocr-pdf-spanish">Spanish</a> · <a href="/guides/ocr-pdf-french">French</a> · <a href="/guides/ocr-pdf-arabic">Arabic</a> · <a href="/guides/ocr-pdf-poor-quality">Poor-quality scans</a>.</p>
            <p>Tool: <a href="/pdf/ocrpdf">/pdf/ocrpdf</a></p>
        ...
        private const string OcrPdfPolish = """
            <h2>OCR PDF in Polish — Searchable Polish Scans (2026)</h2>
            <p>Example: Warsaw invoice scan with ł, ą, ę, ż, ź, ć, ń, ś.</p>
            <p class="lead">Pillar: <a href="/guides/ocr-pdf">OCR PDF guide</a> · Related: <a href="/guides/make-scanned-pdf-searchable">/guides/make-scanned-pdf-searchable</a> · Tool page: <a href="/pdf/ocrpdf">/pdf/ocrpdf</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> OCR PDF in Polish — Searchable Polish Scans (2026)</figcaption></figure>
            
            <h2>OCR PDF in Polish</h2>
            <p>Script: Latin + ogonek/stroke. Example: Warsaw invoice scan with ł, ą, ę, ż, ź, ć, ń, ś.</p>
            <ol>
            <li>Scan at 300 DPI grayscale — low DPI is the top cause of Polish OCR errors</li>
            <li><a href="/pdf/ocrpdf">OCR PDF</a> — select Polish as the recognition language</li>
            <li>Diacritics like ł and ż are easily dropped — proofread the NIP number and beneficiary names after OCR.</li>
            <li>Need layout edits? <a href="/pdf/pdftodoc">PDF to Word</a> preserves structure better than plain text</li>
            </ol>
            <p>More languages: <a href="/guides/ocr-pdf-spanish">Spanish</a> · <a href="/guides/ocr-pdf-french">French</a> · <a href="/guides/ocr-pdf-arabic">Arabic</a> · <a href="/guides/ocr-pdf-poor-quality">Poor-quality scans</a>.</p>
            <p>Tool: <a href="/pdf/ocrpdf">/pdf/ocrpdf</a></p>
        ...
        private const string PdfToOdt = """
            <h2>PDF to ODT — Convert for LibreOffice &amp; OpenOffice (2026)</h2>
            <p>Example: Open-source team converts a PDF report to ODT so it opens cleanly in LibreOffice Writer without Microsoft Word.</p>
            <p class="lead">Pillar: <a href="/guides/pdf-to-word">PDF to Word guide</a> · Related: <a href="/guides/pdf-to-rtf">/guides/pdf-to-rtf</a> · Tool page: <a href="/pdf/pdftodoc">/pdf/pdftodoc</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF to ODT — Convert for LibreOffice &amp; OpenOffice (2026)</figcaption></figure>
        ...
        private const string PdfToNotion = """
            <h2>PDF to Notion — Import Docs into Your Workspace (2026)</h2>
            <p>Example: Product manager converts a PDF spec to Markdown, then pastes it into a Notion page so the team can edit inline.</p>
            <p class="lead">Pillar: <a href="/guides/pdf-to-text">PDF to text guide</a> · Related: <a href="/guides/pdf-to-word">/guides/pdf-to-word</a> · Tool page: <a href="/pdf/pdftomarkdown">/pdf/pdftomarkdown</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF to Notion — Import Docs into Your Workspace (2026)</figcaption></figure>
            ...
            <p>Tool: <a href="/pdf/pdftomarkdown">/pdf/pdftomarkdown</a></p>
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Start workflow</strong> <a href="/pdf/pdftomarkdown" class="alert-link fw-semibold">PDF to Markdown →</a></div>
            ...
            <p class="mt-4"><a href="/pdf/pdftomarkdown" class="btn btn-primary">PDF to Markdown</a> · <a href="/guides/pdf-to-text">Full guide</a></p>
            """;

        private const string PdfToKindle = """
            <h2>PDF to Kindle — Send Documents to Your E-Reader (2026)</h2>
            <p>Example: Reader reflows a fixed-layout PDF to EPUB/DOCX before Send-to-Kindle so text scales on a small e-ink screen.</p>
            <p class="lead">Pillar: <a href="/guides/pdf-to-text">PDF to text guide</a> · Related: <a href="/guides/pdf-to-epub">/guides/pdf-to-epub</a> · Tool page: <a href="/pdf/pdftodoc">/pdf/pdftodoc</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF to Kindle — Send Documents to Your E-Reader (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/pdftodoc" class="btn btn-primary">PDF to Word</a> · <a href="/guides/pdf-to-text">Full guide</a></p>
            """;

        private const string PdfToXml = """
            <h2>PDF to XML — Extract Structured Data (2026)</h2>
            <p>Example: Developer extracts invoice fields from PDFs into XML for an ERP import after a text-layer or OCR pass.</p>
            <p class="lead">Pillar: <a href="/guides/pdf-to-text">PDF to text guide</a> · Related: <a href="/guides/pdf-to-excel">/guides/pdf-to-excel</a> · Tool page: <a href="/pdf/pdftotext">/pdf/pdftotext</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF to XML — Extract Structured Data (2026)</figcaption></figure>
        ...
        private const string BeginnerPdfColorSpaces = """
            <h2>PDF Color Spaces Explained — CMYK vs RGB (2026)</h2>
            <p>Example: Designer learns why an RGB screen proof shifts color on a CMYK press and converts before print handoff.</p>
            <p class="lead">Pillar: <a href="/guides/pdf-tools">PDF tools hub</a> · Related: <a href="/guides/beginner-pdf-vs-png-for-documents">/guides/beginner-pdf-vs-png-for-documents</a> · Tool page: <a href="/pdf/compress">/pdf/compress</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF Color Spaces Explained — CMYK vs RGB (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/compress" class="btn btn-primary">Compress PDF</a> · <a href="/guides/pdf-tools">Full guide</a></p>
            """;

        private const string BeginnerPdfFontSubsetting = """
            <h2>PDF Font Subsetting Explained — Smaller, Portable Files (2026)</h2>
            <p>Example: Publisher subsets embedded fonts so a brochure PDF shrinks without breaking glyphs on other machines.</p>
            <p class="lead">Pillar: <a href="/guides/pdf-tools">PDF tools hub</a> · Related: <a href="/guides/pdf-error-font-embedding">/guides/pdf-error-font-embedding</a> · Tool page: <a href="/pdf/compress">/pdf/compress</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF Font Subsetting Explained — Smaller, Portable Files (2026)</figcaption></figure>
        ...
        private const string BeginnerPdfLinearization = """
            <h2>PDF Linearization Explained — Fast Web View (2026)</h2>
            <p>Example: Web team linearizes a large catalog PDF so the first page renders while the rest streams from the CDN.</p>
            <p class="lead">Pillar: <a href="/guides/glossary-linearization">linearization glossary</a> · Related: <a href="/guides/pdf-error-linearization">/guides/pdf-error-linearization</a> · Tool page: <a href="/pdf/compress">/pdf/compress</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF Linearization Explained — Fast Web View (2026)</figcaption></figure>
        ...
        private const string PdfHandoffDesignToDev = """
            <h2>PDF Handoff Design to Development — Specs &amp; Assets (2026)</h2>
            <p>Example: Designer flattens a spec PDF, embeds fonts, and annotates measurements before handing it to the dev team.</p>
            <p class="lead">Pillar: <a href="/guides/pdf-review-workflow">PDF review workflow</a> · Related: <a href="/guides/best-pdf-editor-for-designers">/guides/best-pdf-editor-for-designers</a> · Tool page: <a href="/pdf/flattenpdf">/pdf/flattenpdf</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF Handoff Design to Development — Specs &amp; Assets (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/flattenpdf" class="btn btn-primary">Flatten PDF</a> · <a href="/guides/pdf-review-workflow">Full guide</a></p>
            """;

        private const string PdfArchiveMetadataSchema = """
            <h2>PDF Archive Metadata Schema — Consistent Records (2026)</h2>
            <p>Example: Records team standardizes title, author, subject, and retention-class metadata fields across an archive.</p>
            <p class="lead">Pillar: <a href="/guides/pdf-records-management-policy">records management policy</a> · Related: <a href="/guides/pdf-archive-folder-structure">/guides/pdf-archive-folder-structure</a> · Tool page: <a href="/pdf/pdfmetadata">/pdf/pdfmetadata</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF Archive Metadata Schema — Consistent Records (2026)</figcaption></figure>
        ...
        private const string PdfSharedDriveNamingConvention = """
            <h2>PDF Shared Drive Naming Convention — Findable Files (2026)</h2>
            <p>Example: Ops lead rolls out a ClientName_DocType_YYYY-MM-DD_vN convention so shared-drive PDFs sort and search cleanly.</p>
            <p class="lead">Pillar: <a href="/guides/pdf-records-management-policy">records management policy</a> · Related: <a href="/guides/pdf-version-control-best-practices">/guides/pdf-version-control-best-practices</a> · Tool page: <a href="/pdf/merge">/pdf/merge</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF Shared Drive Naming Convention — Findable Files (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/merge" class="btn btn-primary">Merge PDF</a> · <a href="/guides/pdf-records-management-policy">Full guide</a></p>
            """;
