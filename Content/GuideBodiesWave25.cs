namespace ratpdf.Content
{
    ...
    internal static class GuideBodiesWave25
    {
        ...
        {
            "beginner-pdf-page-size-a4-letter" => BeginnerPdfPageSizeA4Letter,
            "beginner-pdf-tags-accessibility" => BeginnerPdfTagsAccessibility,
            "email-attachment-limits-2027" => EmailAttachmentLimits2027,
            "how-to-add-signature-pdf-free" => HowToAddSignaturePdfFree,
            "how-to-password-protect-a-pdf" => HowToPasswordProtectAPdf,
            "how-to-protect-pdf-before-sending" => HowToProtectPdfBeforeSending,
            "how-to-redact-sensitive-information-pdf" => HowToRedactSensitiveInformationPdf,
            "how-to-sign-a-pdf" => HowToSignAPdf,
            "how-to-unlock-a-pdf" => HowToUnlockAPdf,
            "how-to-watermark-a-pdf" => HowToWatermarkAPdf,
            "pdf-text-extraction-empty" => PdfTextExtractionEmpty,
            "ocr-accuracy-tips" => OcrAccuracyTips,
            "ocr-historical-documents" => OcrHistoricalDocuments,
            "ocr-lecture-notes-students" => OcrLectureNotesStudents,
            "glossary-cgst" => GlossaryCgst,
            "glossary-client-side-pdf" => GlossaryClientSidePdf,
            "glossary-cmap" => GlossaryCmap,
            _ => null
        };

        private const string BeginnerPdfPageSizeA4Letter = """
            <h2>PDF Page Size A4 vs Letter — US &amp; International Basics (2026)</h2>
            <p>Example: US consultant sends Letter PDF to EU client — printer crops footer on A4 default tray.</p>
            <p class="lead">Learn more: <a href="/guides/beginner-pdf-basics">PDF basics</a> · Related: <a href="/guides/beginner-pdf-file-structure">/guides/beginner-pdf-file-structure</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF Page Size A4 vs Letter — US &amp; International Basics (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/doctopdf" class="btn btn-primary">Word to PDF</a> · <a href="/guides/beginner-pdf-basics">Full guide</a></p>
            """;

        private const string BeginnerPdfTagsAccessibility = """
            <h2>PDF Tags &amp; Accessibility Basics — Screen Readers (2026)</h2>
            <p>Example: City council publishes benefits PDF — screen reader reads pages out of order without tags.</p>
            <p class="lead">Learn more: <a href="/guides/pdf-accessibility-wcag">PDF accessibility WCAG</a> · Related: <a href="/guides/tagged-pdf-checklist">/guides/tagged-pdf-checklist</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF Tags &amp; Accessibility Basics — Screen Readers (2026)</figcaption></figure>
        ...
        private const string EmailAttachmentLimits2027 = """
            <h2>Email Attachment Limits 2027 — PDF Size Quick Reference</h2>
            <p>Example: IT updates internal wiki with 2027 provider caps before Q1 vendor audit.</p>
            <p class="lead">Learn more: <a href="/guides/email-attachment-size-limits-2026">email attachment limits 2026 (current)</a> · Related: <a href="/guides/email-attachment-limits-2026">/guides/email-attachment-limits-2026</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Email Attachment Limits 2027 — PDF Size Quick Reference</figcaption></figure>
        ...
        private const string HowToAddSignaturePdfFree = """
            <h2>How Do I Add a Signature to PDF Free? — Typed &amp; Drawn (2026)</h2>
            <p>Example: Freelancer countersigns SOW PDF in browser before Monday kickoff — no Acrobat license.</p>
            <p class="lead">Learn more: <a href="/guides/sign-pdf">sign PDF guide</a> · Related: <a href="/guides/how-to-sign-a-pdf">/guides/how-to-sign-a-pdf</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> How Do I Add a Signature to PDF Free? — Typed &amp; Drawn (2026)</figcaption></figure>
        ...
        private const string HowToPasswordProtectAPdf = """
            <h2>How Do I Password Protect a PDF? — Encrypt Before Send (2026)</h2>
            <p>Example: HR encrypts draft policy PDF — shares passphrase via SMS not email thread.</p>
            <p class="lead">Learn more: <a href="/guides/password-protect-pdf">password protect PDF guide</a> · Related: <a href="/guides/how-to-protect-pdf-before-sending">/guides/how-to-protect-pdf-before-sending</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> How Do I Password Protect a PDF? — Encrypt Before Send (2026)</figcaption></figure>
        ...
        private const string HowToProtectPdfBeforeSending = """
            <h2>How Do I Protect PDF Before Sending? — Watermark, Password, Redact (2026)</h2>
            <p>Example: Sales marks proposal DRAFT watermark then password-protects before external pilot.</p>
            <p class="lead">Learn more: <a href="/guides/secure-pdf-workflow">secure PDF workflow hub</a> · Related: <a href="/guides/how-to-password-protect-a-pdf">/guides/how-to-password-protect-a-pdf</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> How Do I Protect PDF Before Sending? — Watermark, Password, Redact (2026)</figcaption></figure>
            ...
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Try the tool</strong> <a href="/guides/secure-pdf-workflow" class="alert-link fw-semibold">secure PDF workflow →</a></div>
            ...
            <p class="mt-4"><a href="/guides/secure-pdf-workflow" class="btn btn-primary">secure PDF workflow</a> · <a href="/guides/secure-pdf-workflow">Full guide</a></p>
            """;

        private const string HowToRedactSensitiveInformationPdf = """
            <h2>How Do I Redact Sensitive Information in PDF? — Permanent Removal (2026)</h2>
            <p>Example: Paralegal redacts account numbers from discovery PDF — black box overlay failed copy-paste test.</p>
            <p class="lead">Learn more: <a href="/guides/pdf-redaction">PDF redaction guide</a> · Related: <a href="/guides/pdf-redaction-permanent">/guides/pdf-redaction-permanent</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> How Do I Redact Sensitive Information in PDF? — Permanent Removal (2026)</figcaption></figure>
            ...
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Try the tool</strong> <a href="/pdf-redaction" class="alert-link fw-semibold">PDF Redaction →</a></div>
            ...
            <p class="mt-4"><a href="/pdf-redaction" class="btn btn-primary">PDF Redaction</a> · <a href="/guides/pdf-redaction">Full guide</a></p>
            """;

        private const string HowToSignAPdf = """
            <h2>How Do I Sign a PDF? — Free Online Workflow (2026)</h2>
            <p>Example: Operations lead signs vendor NDA PDF on phone before warehouse shipment release.</p>
            <p class="lead">Learn more: <a href="/guides/sign-pdf-legally">sign PDF legally</a> · Related: <a href="/guides/how-to-add-signature-pdf-free">/guides/how-to-add-signature-pdf-free</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> How Do I Sign a PDF? — Free Online Workflow (2026)</figcaption></figure>
        ...
        private const string HowToUnlockAPdf = """
            <h2>How Do I Unlock a PDF? — Remove Password When Authorized (2026)</h2>
            <p>Example: Admin unlocks archived board pack to merge with Q4 appendix before re-encrypting.</p>
            <p class="lead">Learn more: <a href="/guides/unlock-pdf">unlock PDF guide</a> · Related: <a href="/guides/remove-password-from-pdf">/guides/remove-password-from-pdf</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> How Do I Unlock a PDF? — Remove Password When Authorized (2026)</figcaption></figure>
            ...
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Try the tool</strong> <a href="/pdf/unlockpdf" class="alert-link fw-semibold">Unlock PDF →</a></div>
            ...
            <p class="mt-4"><a href="/pdf/unlockpdf" class="btn btn-primary">Unlock PDF</a> · <a href="/guides/unlock-pdf">Full guide</a></p>
            """;

        private const string HowToWatermarkAPdf = """
            <h2>How Do I Watermark a PDF? — DRAFT &amp; CONFIDENTIAL (2026)</h2>
            <p>Example: Product team stamps CONFIDENTIAL on roadmap PDF before investor preview.</p>
            <p class="lead">Learn more: <a href="/guides/watermark-pdf">watermark PDF guide</a> · Related: <a href="/guides/watermark-vs-password-pdf">/guides/watermark-vs-password-pdf</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> How Do I Watermark a PDF? — DRAFT &amp; CONFIDENTIAL (2026)</figcaption></figure>
            ...
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Try the tool</strong> <a href="/pdf/watermark" class="alert-link fw-semibold">Watermark PDF →</a></div>
            ...
            <p class="mt-4"><a href="/pdf/watermark" class="btn btn-primary">Watermark PDF</a> · <a href="/guides/watermark-pdf">Full guide</a></p>
            """;

        private const string PdfTextExtractionEmpty = """
            <h2>Empty Text Extraction from PDF — Why Copy Returns Nothing (2026)</h2>
            <p>Example: Analyst exports contract PDF to .txt — file is blank because source was scan without OCR.</p>
            <p class="lead">Learn more: <a href="/guides/how-to-extract-text-from-pdf">extract text from PDF</a> · Related: <a href="/guides/how-to-make-pdf-searchable">/guides/how-to-make-pdf-searchable</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Empty Text Extraction from PDF — Why Copy Returns Nothing (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/ocrpdf" class="btn btn-primary">OCR PDF</a> · <a href="/guides/how-to-extract-text-from-pdf">Full guide</a></p>
            """;

        private const string OcrAccuracyTips = """
            <h2>OCR Accuracy Tips — DPI, Deskew &amp; Language (2026)</h2>
            <p>Example: Records clerk rescans 200 DPI skewed deeds at 300 DPI — name hit rate jumps from 60% to 95%.</p>
            <p class="lead">Learn more: <a href="/guides/how-to-ocr-a-scanned-pdf">OCR a scanned PDF</a> · Related: <a href="/guides/tesseract-vs-online-ocr">/guides/tesseract-vs-online-ocr</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> OCR Accuracy Tips — DPI, Deskew &amp; Language (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/ocrpdf" class="btn btn-primary">OCR PDF</a> · <a href="/guides/how-to-ocr-a-scanned-pdf">Full guide</a></p>
            """;

        private const string OcrHistoricalDocuments = """
            <h2>OCR Historical Documents — Archives, Newspapers &amp; Old Fonts (2026)</h2>
            <p>Example: Genealogy volunteer OCRs 1920s newspaper clipping PDF — Gothic font needs manual spot-check.</p>
            <p class="lead">Learn more: <a href="/guides/ocr-accuracy-tips">OCR accuracy tips</a> · Related: <a href="/guides/ocr-pdf">/guides/ocr-pdf</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> OCR Historical Documents — Archives, Newspapers &amp; Old Fonts (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/ocrpdf" class="btn btn-primary">OCR PDF</a> · <a href="/guides/ocr-accuracy-tips">Full guide</a></p>
            """;

        private const string OcrLectureNotesStudents = """
            <h2>OCR Lecture Notes for Students — Handwriting &amp; Whiteboard PDFs (2026)</h2>
            <p>Example: Student OCRs phone photo of whiteboard notes before exam — searches Ctrl+F for formula.</p>
            <p class="lead">Learn more: <a href="/guides/beginner-ocr-basics">OCR basics</a> · Related: <a href="/guides/pdf-to-text-on-iphone">/guides/pdf-to-text-on-iphone</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> OCR Lecture Notes for Students — Handwriting &amp; Whiteboard PDFs (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/ocrpdf" class="btn btn-primary">OCR PDF</a> · <a href="/guides/beginner-ocr-basics">Full guide</a></p>
            """;

        private const string GlossaryCgst = """
            <h2>What Is CGST on an Invoice PDF? — India GST Context (2026)</h2>
            <p>Example: Accountant exports GST invoice from Tally to PDF — CGST line must match e-invoice schema.</p>
            <p class="lead">Learn more: <a href="/guides/excel-to-pdf">Excel to PDF guide</a> · Related: <a href="/guides/glossary-gst-invoice">/guides/glossary-gst-invoice</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> What Is CGST on an Invoice PDF? — India GST Context (2026)</figcaption></figure>
            ...
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Try the tool</strong> <a href="/pdf/exceltopdf" class="alert-link fw-semibold">Excel to PDF →</a></div>
            ...
            <p class="mt-4"><a href="/pdf/exceltopdf" class="btn btn-primary">Excel to PDF</a> · <a href="/guides/excel-to-pdf">Full guide</a></p>
            """;

        private const string GlossaryClientSidePdf = """
            <h2>What Is Client-Side PDF Processing? — Browser vs Server (2026)</h2>
            <p>Example: Legal reviews vendor — RatPDF processes in browser without permanent server storage of PHI.</p>
            <p class="lead">Learn more: <a href="/home/security">RatPDF security</a> · Related: <a href="/guides/pdf-tool-security-comparison">/guides/pdf-tool-security-comparison</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> What Is Client-Side PDF Processing? — Browser vs Server (2026)</figcaption></figure>
            ...
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Try the tool</strong> <a href="/guides/browser-vs-desktop-pdf-tools" class="alert-link fw-semibold">browser vs desktop PDF tools →</a></div>
            ...
            <p class="mt-4"><a href="/guides/browser-vs-desktop-pdf-tools" class="btn btn-primary">browser vs desktop PDF tools</a> · <a href="/home/security">Full guide</a></p>
            """;

        private const string GlossaryCmap = """
            <h2>What Is a CMap in PDF? — Character Mapping for CJK (2026)</h2>
            <p>Example: Japanese report PDF search fails — missing CMap means glyph IDs not mapped to Unicode.</p>
            <p class="lead">Learn more: <a href="/guides/glossary-cid-font">CID font glossary</a> · Related: <a href="/guides/glossary-composite-font">/guides/glossary-composite-font</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> What Is a CMap in PDF? — Character Mapping for CJK (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/ocrpdf" class="btn btn-primary">OCR PDF</a> · <a href="/guides/glossary-cid-font">Full guide</a></p>
            """;
