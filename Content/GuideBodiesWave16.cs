namespace ratpdf.Content
{
    ...
    internal static class GuideBodiesWave16
    {
        ...
        {
            "glossary-compress-pdf-online" => GlossaryCompressPdfOnline,
            "glossary-pdf-to-word-converter" => GlossaryPdfToWordConverter,
            "glossary-pdf-to-text-extractor" => GlossaryPdfToTextExtractor,
            "glossary-compression" => GlossaryCompression,
            "glossary-ocr" => GlossaryOcr,
            "glossary-pdf-a" => GlossaryPdfA,
            "glossary-pdf-ua" => GlossaryPdfUa,
            "glossary-pdf-x" => GlossaryPdfX,
            "glossary-digital-signature" => GlossaryDigitalSignature,
            "glossary-acroform" => GlossaryAcroform,
            "glossary-ghostscript" => GlossaryGhostscript,
            "glossary-tesseract" => GlossaryTesseract,
            "glossary-metadata" => GlossaryMetadata,
            "glossary-merge" => GlossaryMerge,
            "glossary-pdf" => GlossaryPdf,
            "glossary-font-embedding" => GlossaryFontEmbedding,
            "glossary-redaction" => GlossaryRedaction,
            _ => null
        };

        private const string GlossaryCompressPdfOnline = """
            <h2>What Is Compress PDF Online? — Definition &amp; When to Use a Browser Tool (2026)</h2>
            <p>Example: Recruiter shrinks a 12 MB portfolio PDF to under Gmail's 25 MB limit before sending.</p>
            <p class="lead">Main workflow guide: <a href="/guides/compress-pdf-guide">compress PDF guide</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> What Is Compress PDF Online? — Definition &amp; When to Use a Browser Tool (2026)</figcaption></figure>
        ...
        private const string GlossaryPdfToWordConverter = """
            <h2>What Is a PDF to Word Converter? — Definition, Limits &amp; Best Use Cases (2026)</h2>
            <p>Example: Paralegal converts a digital contract PDF to DOCX for clause redlines — not a scanned lease.</p>
            <p class="lead">Main workflow guide: <a href="/guides/pdf-to-word">PDF to Word guide</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> What Is a PDF to Word Converter? — Definition, Limits &amp; Best Use Cases (2026)</figcaption></figure>
        ...
        private const string GlossaryPdfToTextExtractor = """
            <h2>What Is a PDF to Text Extractor? — Plain Text vs OCR Explained (2026)</h2>
            <p>Example: Developer pulls API documentation text from a digital PDF into a CI search index.</p>
            <p class="lead">Main workflow guide: <a href="/guides/pdf-txt-guide">PDF to Text guide</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> What Is a PDF to Text Extractor? — Plain Text vs OCR Explained (2026)</figcaption></figure>
        ...
        private const string GlossaryCompression = """
            <h2>What Is PDF Compression? — Lossy vs Lossless Explained (2026)</h2>
            <p>Example: Finance team reduces quarterly report from 8 MB to 900 KB for board email.</p>
            <p class="lead">Main workflow guide: <a href="/guides/compress-pdf-guide">compress PDF guide</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> What Is PDF Compression? — Lossy vs Lossless Explained (2026)</figcaption></figure>
        ...
        private const string GlossaryOcr = """
            <h2>What Is OCR for PDF? — Searchable Scans &amp; Text Layers (2026)</h2>
            <p>Example: Clinic digitizes paper intake forms — OCR adds selectable text for EHR search.</p>
            <p class="lead">Main workflow guide: <a href="/guides/ocr-pdf">OCR PDF guide</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> What Is OCR for PDF? — Searchable Scans &amp; Text Layers (2026)</figcaption></figure>
        ...
        private const string GlossaryPdfA = """
            <h2>What Is PDF/A? — Archival PDF Standard Explained (2026)</h2>
            <p>Example: Records manager validates 7-year tax PDF bundle meets PDF/A-1b before glacier upload.</p>
            <p class="lead">Main workflow guide: <a href="/guides/pdf-a-archival">PDF/A archival guide</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> What Is PDF/A? — Archival PDF Standard Explained (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/pdfmetadata" class="btn btn-primary">PDF Metadata</a> · <a href="/guides/pdf-a-archival">Full guide</a></p>
            """;

        private const string GlossaryPdfUa = """
            <h2>What Is PDF/UA? — Universal Accessibility Standard for PDF (2026)</h2>
            <p>Example: University publishes course pack — PDF/UA required for screen reader students.</p>
            <p class="lead">Main workflow guide: <a href="/guides/pdf-ua-accessibility">PDF/UA accessibility guide</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> What Is PDF/UA? — Universal Accessibility Standard for PDF (2026)</figcaption></figure>
        ...
        private const string GlossaryPdfX = """
            <h2>What Is PDF/X? — Print-Ready PDF Standard Explained (2026)</h2>
            <p>Example: Agency exports brochure PDF/X-1a — printer rejects RGB-only file without output intent.</p>
            <p class="lead">Main workflow guide: <a href="/guides/pdf-x-print-standard">PDF/X print standard guide</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> What Is PDF/X? — Print-Ready PDF Standard Explained (2026)</figcaption></figure>
        ...
        private const string GlossaryDigitalSignature = """
            <h2>What Is a Digital PDF Signature? — Typed, Drawn &amp; Certificate Signatures (2026)</h2>
            <p>Example: Freelancer adds typed signature to SOW — client needs visible approval, not PKI certificate.</p>
            <p class="lead">Main workflow guide: <a href="/guides/sign-pdf">sign PDF guide</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> What Is a Digital PDF Signature? — Typed, Drawn &amp; Certificate Signatures (2026)</figcaption></figure>
        ...
        private const string GlossaryAcroform = """
            <h2>What Is AcroForm? — Interactive PDF Forms Explained (2026)</h2>
            <p>Example: HR sends fillable onboarding PDF — AcroForm fields must flatten before archive.</p>
            <p class="lead">Main workflow guide: <a href="/guides/flatten-pdf">flatten PDF guide</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> What Is AcroForm? — Interactive PDF Forms Explained (2026)</figcaption></figure>
        ...
        private const string GlossaryGhostscript = """
            <h2>What Is Ghostscript? — PDF Compression &amp; Conversion Engine (2026)</h2>
            <p>Example: IT admin compares Ghostscript /ebook vs /printer settings for invoice batch compression.</p>
            <p class="lead">Main workflow guide: <a href="/guides/compress-pdf-guide">compress PDF guide</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> What Is Ghostscript? — PDF Compression &amp; Conversion Engine (2026)</figcaption></figure>
        ...
        private const string GlossaryTesseract = """
            <h2>What Is Tesseract OCR? — Open-Source PDF Text Recognition (2026)</h2>
            <p>Example: Archivist OCRs 1990s scanned newsletters — Tesseract language pack set to English.</p>
            <p class="lead">Main workflow guide: <a href="/guides/ocr-pdf">OCR PDF guide</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> What Is Tesseract OCR? — Open-Source PDF Text Recognition (2026)</figcaption></figure>
        ...
        private const string GlossaryMetadata = """
            <h2>What Is PDF Metadata? — Title, Author, XMP &amp; Properties (2026)</h2>
            <p>Example: Procurement scrubs internal author name from RFP PDF before public portal upload.</p>
            <p class="lead">Main workflow guide: <a href="/guides/pdf-metadata">PDF metadata guide</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> What Is PDF Metadata? — Title, Author, XMP &amp; Properties (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/pdfmetadata" class="btn btn-primary">PDF Metadata</a> · <a href="/guides/pdf-metadata">Full guide</a></p>
            """;

        private const string GlossaryMerge = """
            <h2>What Does Merge PDF Mean? — Combine Files Without Reordering Mistakes (2026)</h2>
            <p>Example: Applicant merges passport, bank statement, and cover letter into one visa upload PDF.</p>
            <p class="lead">Main workflow guide: <a href="/guides/merge-pdf">merge PDF guide</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> What Does Merge PDF Mean? — Combine Files Without Reordering Mistakes (2026)</figcaption></figure>
        ...
        private const string GlossaryPdf = """
            <h2>What Is a PDF File? — Portable Document Format Basics (2026)</h2>
            <p>Example: New hire receives policy PDF — needs to know why it opens the same on Mac and Windows.</p>
            <p class="lead">Main workflow guide: <a href="/guides/beginner-what-is-a-pdf">what is a PDF beginner guide</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> What Is a PDF File? — Portable Document Format Basics (2026)</figcaption></figure>
        ...
        private const string GlossaryFontEmbedding = """
            <h2>What Is PDF Font Embedding? — Missing Font &amp; Print Fixes (2026)</h2>
            <p>Example: Proposal PDF prints with substituted font — re-export from Word with embed fonts enabled.</p>
            <p class="lead">Main workflow guide: <a href="/guides/embed-fonts-before-printing">embed fonts before printing guide</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> What Is PDF Font Embedding? — Missing Font &amp; Print Fixes (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/doctopdf" class="btn btn-primary">Word to PDF</a> · <a href="/guides/embed-fonts-before-printing">Full guide</a></p>
            """;

        private const string GlossaryRedaction = """
            <h2>What Is PDF Redaction? — Permanent Removal vs Black Boxes (2026)</h2>
            <p>Example: Legal team redacts SSNs from discovery PDF — black highlight alone leaves text under layer.</p>
            <p class="lead">Main workflow guide: <a href="/guides/pdf-redaction">PDF redaction guide</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> What Is PDF Redaction? — Permanent Removal vs Black Boxes (2026)</figcaption></figure>
            ...
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Try the related tool</strong> <a href="/pdf-redaction" class="alert-link fw-semibold">PDF Redaction →</a></div>
