namespace ratpdf.Content
{
    ...
    internal static class GuideBodiesWave11
    {
        public static string? Get(string slug) => slug switch
        {
            ...
            "hipaa-pdf-handling" => HipaaPdfHandling,
            "section-508-pdf" => Section508Pdf,
            "secure-pdf-workflow" => SecurePdfWorkflow,
            "blackout-text-in-pdf" => BlackoutTextInPdf,
            "remove-password-from-pdf" => RemovePasswordFromPdf,
            "pdf-accessibility-wcag" => PdfAccessibilityWcag,
            "gdpr-pdf-redaction-workflow" => GdprPdfRedactionWorkflow,
            "hipaa-compliant-pdf-email" => HipaaCompliantPdfEmail,
            "pdf-accessibility-checker" => PdfAccessibilityChecker,
            "tagged-pdf-checklist" => TaggedPdfChecklist,
            "redact-pdf-discovery" => RedactPdfDiscovery,
            "pdf-metadata-remove" => PdfMetadataRemove,
            "pdf-security-compliance-guide" => PdfSecurityComplianceGuide,
            _ => null
        };

        private const string PasswordProtectPdf = """
            <h2>Password Protect PDF — Encrypt Before Email &amp; Portal Upload (2026)</h2>
            <p>RatPDF <a href="/pdf/password">Protect PDF</a> — HR sends encrypted payslip PDF — password shared via separate SMS.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Password Protect PDF — Encrypt Before Email &amp; Portal Upload (2026)</figcaption></figure>
            ...
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Apply control</strong> <a href="/pdf/password" class="alert-link fw-semibold">Protect PDF →</a></div>
            ...
            <h2>Workflow deep dive — Password Protect PDF — Encrypt Before Email &amp; Portal Upload (2026)</h2>
            ...
            <div class="rp-faq-cta alert alert-secondary my-4"><strong>Open tool</strong> <a href="/pdf/password" class="alert-link fw-semibold">Go →</a></div>
            
            <p>Pillar hub: <a href="/guides/secure-pdf-workflow">secure PDF workflow</a> · <a href="/guides/pdf-security-compliance-guide">compliance hub</a>.</p>
            ...
            <p class="mt-4"><a href="/pdf/password" class="btn btn-primary">Protect PDF</a> · <a href="/guides/pdf-security-compliance-guide">Compliance hub</a></p>
            """;

        private const string UnlockPdf = """
            <h2>Unlock PDF — Remove Password When You Know the Passphrase (2026)</h2>
            <p>RatPDF <a href="/pdf/unlockpdf">Unlock PDF</a> — Archive team decrypts legacy board pack for merge and compress chain.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Unlock PDF — Remove Password When You Know the Passphrase (2026)</figcaption></figure>
            ...
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Apply control</strong> <a href="/pdf/unlockpdf" class="alert-link fw-semibold">Unlock PDF →</a></div>
            ...
            <h2>Workflow deep dive — Unlock PDF — Remove Password When You Know the Passphrase (2026)</h2>
            <p>Security controls require verification — never assume overlay redaction or watermark equals protection.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Unlock PDF — Remove Password When You Know the Passphrase (2026)</figcaption></figure>
            <h2>Policy</h2>
            <p>Document approver and lawful basis before external send — especially GDPR DSAR and HIPAA PHI.</p>
            <div class="rp-faq-cta alert alert-secondary my-4"><strong>Open tool</strong> <a href="/pdf/unlockpdf" class="alert-link fw-semibold">Go →</a></div>
            ...
            <p class="mt-4"><a href="/pdf/unlockpdf" class="btn btn-primary">Unlock PDF</a> · <a href="/guides/pdf-security-compliance-guide">Compliance hub</a></p>
            """;

        private const string WatermarkPdf = """
            <h2>Watermark PDF — DRAFT &amp; CONFIDENTIAL Labels Online (2026)</h2>
            <p>RatPDF <a href="/pdf/watermark">Watermark PDF</a> — Legal marks draft contract CONFIDENTIAL before partner review.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Watermark PDF — DRAFT &amp; CONFIDENTIAL Labels Online (2026)</figcaption></figure>
            ...
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Apply control</strong> <a href="/pdf/watermark" class="alert-link fw-semibold">Watermark PDF →</a></div>
            ...
            <h2>Workflow deep dive — Watermark PDF — DRAFT &amp; CONFIDENTIAL Labels Online (2026)</h2>
            <p>Security controls require verification — never assume overlay redaction or watermark equals protection.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Watermark PDF — DRAFT &amp; CONFIDENTIAL Labels Online (2026)</figcaption></figure>
            <h2>Policy</h2>
            <p>Document approver and lawful basis before external send — especially GDPR DSAR and HIPAA PHI.</p>
            <div class="rp-faq-cta alert alert-secondary my-4"><strong>Open tool</strong> <a href="/pdf/watermark" class="alert-link fw-semibold">Go →</a></div>
            ...
            <p class="mt-4"><a href="/pdf/watermark" class="btn btn-primary">Watermark PDF</a> · <a href="/guides/pdf-security-compliance-guide">Compliance hub</a></p>
            """;

        private const string PdfRedaction = """
            <h2>PDF Redaction — Permanently Remove Sensitive Text Online (2026)</h2>
            <p>RatPDF <a href="/pdf-redaction">PDF Redaction</a> — Paralegal redacts SSN and account numbers before discovery production.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF Redaction — Permanently Remove Sensitive Text Online (2026)</figcaption></figure>
            ...
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Apply control</strong> <a href="/pdf-redaction" class="alert-link fw-semibold">PDF Redaction →</a></div>
            ...
            <h2>Workflow deep dive — PDF Redaction — Permanently Remove Sensitive Text Online (2026)</h2>
            <p>Security controls require verification — never assume overlay redaction or watermark equals protection.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF Redaction — Permanently Remove Sensitive Text Online (2026)</figcaption></figure>
            <h2>Policy</h2>
            <p>Document approver and lawful basis before external send — especially GDPR DSAR and HIPAA PHI.</p>
            <div class="rp-faq-cta alert alert-secondary my-4"><strong>Open tool</strong> <a href="/pdf-redaction" class="alert-link fw-semibold">Go →</a></div>
            ...
            <p class="mt-4"><a href="/pdf-redaction" class="btn btn-primary">PDF Redaction</a> · <a href="/guides/pdf-security-compliance-guide">Compliance hub</a></p>
            """;

        private const string HipaaPdfHandling = """
            <h2>HIPAA PDF Handling — PHI in Attachments &amp; Redaction Workflow (2026)</h2>
            <p>RatPDF <a href="/pdf/password">Protect PDF</a> — Clinic admin encrypts discharge summary PDF before portal upload.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> HIPAA PDF Handling — PHI in Attachments &amp; Redaction Workflow (2026)</figcaption></figure>
            ...
            <h2>Workflow deep dive — HIPAA PDF Handling — PHI in Attachments &amp; Redaction Workflow (2026)</h2>
            <p>Security controls require verification — never assume overlay redaction or watermark equals protection.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> HIPAA PDF Handling — PHI in Attachments &amp; Redaction Workflow (2026)</figcaption></figure>
            <h2>Policy</h2>
            <p>Document approver and lawful basis before external send — especially GDPR DSAR and HIPAA PHI.</p>
        ...
        private const string Section508Pdf = """
            <h2>Section 508 PDF — Federal Accessibility Requirements Checklist (2026)</h2>
            <p>RatPDF <a href="/pdf/ocrpdf">OCR PDF</a> — Agency comms team remediates annual report PDF for federal publication.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Section 508 PDF — Federal Accessibility Requirements Checklist (2026)</figcaption></figure>
            ...
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Apply control</strong> <a href="/pdf/ocrpdf" class="alert-link fw-semibold">OCR PDF →</a></div>
            ...
            <h2>Workflow deep dive — Section 508 PDF — Federal Accessibility Requirements Checklist (2026)</h2>
            <p>Security controls require verification — never assume overlay redaction or watermark equals protection.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Section 508 PDF — Federal Accessibility Requirements Checklist (2026)</figcaption></figure>
            <h2>Policy</h2>
            <p>Document approver and lawful basis before external send — especially GDPR DSAR and HIPAA PHI.</p>
            ...
            <p class="mt-4"><a href="/pdf/ocrpdf" class="btn btn-primary">OCR PDF</a> · <a href="/guides/pdf-security-compliance-guide">Compliance hub</a></p>
            """;

        private const string SecurePdfWorkflow = """
            <h2>Secure PDF Workflow Hub — Protect, Watermark, Redact &amp; Unlock (2026)</h2>
            <p>RatPDF <a href="/guides/pdf-tools">PDF tools hub</a> — IT security one-pager for which RatPDF control applies to each risk.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Secure PDF Workflow Hub — Protect, Watermark, Redact &amp; Unlock (2026)</figcaption></figure>
            ...
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Apply control</strong> <a href="/guides/pdf-tools" class="alert-link fw-semibold">PDF tools hub →</a></div>
            ...
            <h2>Workflow deep dive — Secure PDF Workflow Hub — Protect, Watermark, Redact &amp; Unlock (2026)</h2>
            <p>Security controls require verification — never assume overlay redaction or watermark equals protection.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Secure PDF Workflow Hub — Protect, Watermark, Redact &amp; Unlock (2026)</figcaption></figure>
            <h2>Policy</h2>
            <p>Document approver and lawful basis before external send — especially GDPR DSAR and HIPAA PHI.</p>
            ...
            <p class="mt-4"><a href="/guides/pdf-tools" class="btn btn-primary">PDF tools hub</a> · <a href="/guides/pdf-security-compliance-guide">Compliance hub</a></p>
            """;

        private const string BlackoutTextInPdf = """
            <h2>Blackout Text in PDF — True Redaction vs Fake Black Boxes (2026)</h2>
            <p>RatPDF <a href="/pdf-redaction">PDF Redaction</a> — FOIA officer removes witness names — must not be recoverable via copy-paste.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Blackout Text in PDF — True Redaction vs Fake Black Boxes (2026)</figcaption></figure>
            ...
            <h2>Workflow deep dive — Blackout Text in PDF — True Redaction vs Fake Black Boxes (2026)</h2>
            <p>Security controls require verification — never assume overlay redaction or watermark equals protection.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Blackout Text in PDF — True Redaction vs Fake Black Boxes (2026)</figcaption></figure>
            <h2>Policy</h2>
            <p>Document approver and lawful basis before external send — especially GDPR DSAR and HIPAA PHI.</p>
        ...
        private const string RemovePasswordFromPdf = """
            <h2>Remove Password from PDF — Decrypt When Authorized (2026)</h2>
            <p>RatPDF <a href="/pdf/unlockpdf">Unlock PDF</a> — Operations removes owner password to enable merge before re-encrypting final pack.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Remove Password from PDF — Decrypt When Authorized (2026)</figcaption></figure>
            ...
            <h2>Workflow deep dive — Remove Password from PDF — Decrypt When Authorized (2026)</h2>
            <p>Security controls require verification — never assume overlay redaction or watermark equals protection.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Remove Password from PDF — Decrypt When Authorized (2026)</figcaption></figure>
            <h2>Policy</h2>
            <p>Document approver and lawful basis before external send — especially GDPR DSAR and HIPAA PHI.</p>
        ...
        private const string PdfAccessibilityWcag = """
            <h2>PDF Accessibility WCAG — Tags, Alt Text &amp; Reading Order (2026)</h2>
            <p>RatPDF <a href="/pdf/ocrpdf">OCR PDF</a> — University publishes course pack PDF meeting WCAG 2.2 contrast and structure.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF Accessibility WCAG — Tags, Alt Text &amp; Reading Order (2026)</figcaption></figure>
            ...
            <h2>Workflow deep dive — PDF Accessibility WCAG — Tags, Alt Text &amp; Reading Order (2026)</h2>
            <p>Security controls require verification — never assume overlay redaction or watermark equals protection.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF Accessibility WCAG — Tags, Alt Text &amp; Reading Order (2026)</figcaption></figure>
            <h2>Policy</h2>
            <p>Document approver and lawful basis before external send — especially GDPR DSAR and HIPAA PHI.</p>
        ...
        private const string GdprPdfRedactionWorkflow = """
            <h2>GDPR PDF Redaction Workflow — DSAR &amp; Minimisation Steps (2026)</h2>
            <p>RatPDF <a href="/pdf-redaction">PDF Redaction</a> — DPO team redacts third-party names from contract PDF for data subject access response.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> GDPR PDF Redaction Workflow — DSAR &amp; Minimisation Steps (2026)</figcaption></figure>
            ...
            <h2>Workflow deep dive — GDPR PDF Redaction Workflow — DSAR &amp; Minimisation Steps (2026)</h2>
            <p>Security controls require verification — never assume overlay redaction or watermark equals protection.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> GDPR PDF Redaction Workflow — DSAR &amp; Minimisation Steps (2026)</figcaption></figure>
            <h2>Policy</h2>
            <p>Document approver and lawful basis before external send — especially GDPR DSAR and HIPAA PHI.</p>
        ...
        private const string HipaaCompliantPdfEmail = """
            <h2>HIPAA Compliant PDF Email — PHI Attachment Controls (2026)</h2>
            <p>RatPDF <a href="/pdf/password">Protect PDF</a> — Billing sends encrypted statement PDF — never password in same email thread.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> HIPAA Compliant PDF Email — PHI Attachment Controls (2026)</figcaption></figure>
            ...
            <h2>Workflow deep dive — HIPAA Compliant PDF Email — PHI Attachment Controls (2026)</h2>
            <p>Security controls require verification — never assume overlay redaction or watermark equals protection.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> HIPAA Compliant PDF Email — PHI Attachment Controls (2026)</figcaption></figure>
            <h2>Policy</h2>
            <p>Document approver and lawful basis before external send — especially GDPR DSAR and HIPAA PHI.</p>
        ...
        private const string PdfAccessibilityChecker = """
            <h2>PDF Accessibility Checker — Manual QA &amp; Tool Limits (2026)</h2>
            <p>RatPDF <a href="/pdf/ocrpdf">OCR PDF</a> — Comms runs checklist before publishing public benefits PDF.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF Accessibility Checker — Manual QA &amp; Tool Limits (2026)</figcaption></figure>
            ...
            <h2>Workflow deep dive — PDF Accessibility Checker — Manual QA &amp; Tool Limits (2026)</h2>
            <p>Security controls require verification — never assume overlay redaction or watermark equals protection.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF Accessibility Checker — Manual QA &amp; Tool Limits (2026)</figcaption></figure>
            <h2>Policy</h2>
            <p>Document approver and lawful basis before external send — especially GDPR DSAR and HIPAA PHI.</p>
        ...
        private const string TaggedPdfChecklist = """
            <h2>Tagged PDF Checklist — Structure Tree &amp; Screen Reader QA (2026)</h2>
            <p>RatPDF <a href="/pdf/ocrpdf">OCR PDF</a> — Publisher verifies heading tags before government RFP submission.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Tagged PDF Checklist — Structure Tree &amp; Screen Reader QA (2026)</figcaption></figure>
            ...
            <h2>Workflow deep dive — Tagged PDF Checklist — Structure Tree &amp; Screen Reader QA (2026)</h2>
            <p>Security controls require verification — never assume overlay redaction or watermark equals protection.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Tagged PDF Checklist — Structure Tree &amp; Screen Reader QA (2026)</figcaption></figure>
            <h2>Policy</h2>
            <p>Document approver and lawful basis before external send — especially GDPR DSAR and HIPAA PHI.</p>
        ...
        private const string RedactPdfDiscovery = """
            <h2>Redact PDF for Discovery — Privilege &amp; PII in Litigation (2026)</h2>
            <p>RatPDF <a href="/pdf-redaction">PDF Redaction</a> — Law firm produces Bates-stamped PDF set with privilege log for redacted segments.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Redact PDF for Discovery — Privilege &amp; PII in Litigation (2026)</figcaption></figure>
            ...
            <h2>Workflow deep dive — Redact PDF for Discovery — Privilege &amp; PII in Litigation (2026)</h2>
            <p>Security controls require verification — never assume overlay redaction or watermark equals protection.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Redact PDF for Discovery — Privilege &amp; PII in Litigation (2026)</figcaption></figure>
            <h2>Policy</h2>
            <p>Document approver and lawful basis before external send — especially GDPR DSAR and HIPAA PHI.</p>
        ...
        private const string PdfMetadataRemove = """
            <h2>PDF Metadata Remove — Author, Title &amp; Hidden Properties (2026)</h2>
            <p>RatPDF <a href="/pdf/pdfmetadata">PDF Metadata</a> — Anonymise author field on external-share draft before client send.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF Metadata Remove — Author, Title &amp; Hidden Properties (2026)</figcaption></figure>
            ...
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Apply control</strong> <a href="/pdf/pdfmetadata" class="alert-link fw-semibold">PDF Metadata →</a></div>
            ...
            <h2>Workflow deep dive — PDF Metadata Remove — Author, Title &amp; Hidden Properties (2026)</h2>
            <p>Security controls require verification — never assume overlay redaction or watermark equals protection.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF Metadata Remove — Author, Title &amp; Hidden Properties (2026)</figcaption></figure>
            <h2>Policy</h2>
            <p>Document approver and lawful basis before external send — especially GDPR DSAR and HIPAA PHI.</p>
            <div class="rp-faq-cta alert alert-secondary my-4"><strong>Open tool</strong> <a href="/pdf/pdfmetadata" class="alert-link fw-semibold">Go →</a></div>
            ...
            <p class="mt-4"><a href="/pdf/pdfmetadata" class="btn btn-primary">PDF Metadata</a> · <a href="/guides/pdf-security-compliance-guide">Compliance hub</a></p>
            """;

        private const string PdfSecurityComplianceGuide = """
            <h2>PDF Security &amp; Compliance Hub — GDPR, HIPAA, 508, Redaction (2026)</h2>
            <p>RatPDF <a href="/guides/pdf-tools">PDF tools hub</a> — Compliance officer index linking security tools to regulatory frameworks.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF Security &amp; Compliance Hub — GDPR, HIPAA, 508, Redaction (2026)</figcaption></figure>
            ...
            <h2>Workflow deep dive — PDF Security &amp; Compliance Hub — GDPR, HIPAA, 508, Redaction (2026)</h2>
            <p>Security controls require verification — never assume overlay redaction or watermark equals protection.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF Security &amp; Compliance Hub — GDPR, HIPAA, 508, Redaction (2026)</figcaption></figure>
            <h2>Policy</h2>
            <p>Document approver and lawful basis before external send — especially GDPR DSAR and HIPAA PHI.</p>
