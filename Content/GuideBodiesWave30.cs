...
{
    /// <summary>Wave 30 — University application batch 2 + compress technical batch.</summary>
    internal static class GuideBodiesWave30
    {
        public static string? Get(string slug) => slug switch
        {
            "university-application-pdf-workflow-mexico" => UniversityApplicationPdfWorkflowMexico,
            "university-application-pdf-workflow-netherlands" => UniversityApplicationPdfWorkflowNetherlands,
            "university-application-pdf-workflow-new-zealand" => UniversityApplicationPdfWorkflowNewZealand,
            "university-application-pdf-workflow-singapore" => UniversityApplicationPdfWorkflowSingapore,
            "university-application-pdf-workflow-south-africa" => UniversityApplicationPdfWorkflowSouthAfrica,
            "university-application-pdf-workflow-south-korea" => UniversityApplicationPdfWorkflowSouthKorea,
            "university-application-pdf-workflow-spain" => UniversityApplicationPdfWorkflowSpain,
            "university-application-pdf-workflow-uae" => UniversityApplicationPdfWorkflowUae,
            "university-application-pdf-workflow-uk" => UniversityApplicationPdfWorkflowUk,
            "university-application-pdf-workflow-usa" => UniversityApplicationPdfWorkflowUsa,
            "irs-tax-pdf-format" => IrsTaxPdfFormat,
            "compress-bank-statement-pdf" => CompressBankStatementPdf,
            "compress-scanned-vs-digital-pdf" => CompressScannedVsDigitalPdf,
            "ghostscript-pdf-compression" => GhostscriptPdfCompression,
            "compress-pdf-accountants" => CompressPdfAccountants,
            "compress-pdf-lawyers" => CompressPdfLawyers,
            "why-is-pdf-file-so-large" => WhyIsPdfFileSoLarge,
            _ => null
        };

        private const string UniversityApplicationPdfWorkflowMexico = """
            <h2>University Application PDF Workflow Mexico — SISU &amp; Histórico (2026)</h2>
            <p>Example: Applicant compresses histórico escolar and ENEM resultado PDF for university portal.</p>
            <p class="lead">Pillar: <a href="/guides/university-application-pdf-workflow-india">university application workflow India (reference)</a> · Related: <a href="/guides/visa-application-pdf-workflow-mexico">/guides/visa-application-pdf-workflow-mexico</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> University Application PDF Workflow Mexico — SISU &amp; Histórico (2026)</figcaption></figure>
            
            <h2>University application — Mexico</h2>
            <p><strong>Typical documents:</strong> Histórico escolar, diploma, ENEM, CURP/INE scan, passport.</p>
            <p><strong>Portal caps:</strong> SISU, private university portals — 2–5 MB per document.</p>
            <p>CURP and nombre must stay legible — Less compression if digits blur.</p>
            <h2>Workflow</h2>
            <ol>
            ...
            <li>Visa pack separate — <a href="/guides/visa-application-pdf-workflow-mexico">visa workflow</a></li>
            </ol>
        ...
        private const string UniversityApplicationPdfWorkflowNetherlands = """
            <h2>University Application PDF Workflow Netherlands — Studielink (2026)</h2>
            <p>Example: International student merges diploma and English test PDF for Studielink upload.</p>
            <p class="lead">Pillar: <a href="/guides/university-application-pdf-workflow-india">university application workflow India (reference)</a> · Related: <a href="/guides/visa-application-pdf-workflow-netherlands">/guides/visa-application-pdf-workflow-netherlands</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> University Application PDF Workflow Netherlands — Studielink (2026)</figcaption></figure>
            
            <h2>University application — Netherlands</h2>
            <p><strong>Typical documents:</strong> Diploma, transcript, passport, IELTS/TOEFL, motivation letter PDF if required.</p>
            <p><strong>Portal caps:</strong> Studielink and individual hogeschool/universiteit portals — 2–5 MB.</p>
            <p>Nuffic credential evaluation PDF separate — do not merge with transcript slot.</p>
            <h2>Workflow</h2>
            <ol>
            <li>Scan 200–300 DPI — crop borders — straight edges</li>
            <li>Order per portal FAQ — ID → transcripts → tests → supporting</li>
            <li><a href="/pdf/merge">Merge PDF</a> only when portal allows one file per category</li>
            <li><a href="/pdf/compress">Compress PDF</a> — verify IDs and seals at 100% zoom</li>
            <li>Visa pack separate — <a href="/guides/visa-application-pdf-workflow-netherlands">visa workflow</a></li>
            </ol>
            <p>Batch 1: <a href="/guides/university-application-pdf-workflow-australia">Australia</a> · <a href="/guides/university-application-pdf-workflow-canada">Canada</a> · <a href="/guides/university-application-pdf-workflow-india">India</a>.</p>
            <p>Hub: <a href="/guides/compress-pdf-for-university-application">university compress</a> · <a href="/guides/university-pdf-upload-requirements">upload requirements</a>.</p>
        ...
        private const string UniversityApplicationPdfWorkflowNewZealand = """
            <h2>University Application PDF Workflow New Zealand — NZQA &amp; Direct Apply (2026)</h2>
            <p>Example: Student compresses NZQA record of achievement PDF for uni application portal.</p>
            <p class="lead">Pillar: <a href="/guides/university-application-pdf-workflow-india">university application workflow India (reference)</a> · Related: <a href="/guides/visa-application-pdf-workflow-new-zealand">/guides/visa-application-pdf-workflow-new-zealand</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> University Application PDF Workflow New Zealand — NZQA &amp; Direct Apply (2026)</figcaption></figure>
            
            <h2>University application — New Zealand</h2>
            <p><strong>Typical documents:</strong> NZQA transcript, passport, English test, referee forms.</p>
            <p><strong>Portal caps:</strong> Direct uni portals — often 10 MB still compress multi-page scans.</p>
            <p>Immigration NZ visa pack separate from admission upload.</p>
            <h2>Workflow</h2>
            <ol>
            <li>Scan 200–300 DPI — crop borders — straight edges</li>
            <li>Order per portal FAQ — ID → transcripts → tests → supporting</li>
            <li><a href="/pdf/merge">Merge PDF</a> only when portal allows one file per category</li>
            <li><a href="/pdf/compress">Compress PDF</a> — verify IDs and seals at 100% zoom</li>
            <li>Visa pack separate — <a href="/guides/visa-application-pdf-workflow-new-zealand">visa workflow</a></li>
            </ol>
            <p>Batch 1: <a href="/guides/university-application-pdf-workflow-australia">Australia</a> · <a href="/guides/university-application-pdf-workflow-canada">Canada</a> · <a href="/guides/university-application-pdf-workflow-india">India</a>.</p>
            <p>Hub: <a href="/guides/compress-pdf-for-university-application">university compress</a> · <a href="/guides/university-pdf-upload-requirements">upload requirements</a>.</p>
        ...
        private const string UniversityApplicationPdfWorkflowSingapore = """
            <h2>University Application PDF Workflow Singapore — NUS/NTU &amp; MOE (2026)</h2>
            <p>Example: International applicant merges A-level transcript and passport PDF for direct apply.</p>
            <p class="lead">Pillar: <a href="/guides/university-application-pdf-workflow-india">university application workflow India (reference)</a> · Related: <a href="/guides/visa-application-pdf-workflow-singapore">/guides/visa-application-pdf-workflow-singapore</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> University Application PDF Workflow Singapore — NUS/NTU &amp; MOE (2026)</figcaption></figure>
            
            <h2>University application — Singapore</h2>
            <p><strong>Typical documents:</strong> Transcripts, exam results, passport, English proficiency cert.</p>
            <p><strong>Portal caps:</strong> NUS, NTU, SMU direct portals — 2–5 MB per slot.</p>
            <p>MOE attestation may be separate document — read programme FAQ.</p>
            <h2>Workflow</h2>
            <ol>
            <li>Scan 200–300 DPI — crop borders — straight edges</li>
            <li>Order per portal FAQ — ID → transcripts → tests → supporting</li>
            <li><a href="/pdf/merge">Merge PDF</a> only when portal allows one file per category</li>
            <li><a href="/pdf/compress">Compress PDF</a> — verify IDs and seals at 100% zoom</li>
            <li>Visa pack separate — <a href="/guides/visa-application-pdf-workflow-singapore">visa workflow</a></li>
            </ol>
            <p>Batch 1: <a href="/guides/university-application-pdf-workflow-australia">Australia</a> · <a href="/guides/university-application-pdf-workflow-canada">Canada</a> · <a href="/guides/university-application-pdf-workflow-india">India</a>.</p>
            <p>Hub: <a href="/guides/compress-pdf-for-university-application">university compress</a> · <a href="/guides/university-pdf-upload-requirements">upload requirements</a>.</p>
        ...
        private const string UniversityApplicationPdfWorkflowSouthAfrica = """
            <h2>University Application PDF Workflow South Africa — Matric &amp; CAO (2026)</h2>
            <p>Example: Matriculant compresses NSC certificate and ID PDF for university application.</p>
            <p class="lead">Pillar: <a href="/guides/university-application-pdf-workflow-india">university application workflow India (reference)</a> · Related: <a href="/guides/visa-application-pdf-workflow-south-africa">/guides/visa-application-pdf-workflow-south-africa</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> University Application PDF Workflow South Africa — Matric &amp; CAO (2026)</figcaption></figure>
            
            <h2>University application — South Africa</h2>
            <p><strong>Typical documents:</strong> NSC matric certificate, ID book/scan, NBT results if required.</p>
            <p><strong>Portal caps:</strong> Direct university portals — 2–5 MB typical.</p>
            <p>Certified matric copy stamp must survive compress.</p>
            <h2>Workflow</h2>
            <ol>
            <li>Scan 200–300 DPI — crop borders — straight edges</li>
            <li>Order per portal FAQ — ID → transcripts → tests → supporting</li>
            <li><a href="/pdf/merge">Merge PDF</a> only when portal allows one file per category</li>
            <li><a href="/pdf/compress">Compress PDF</a> — verify IDs and seals at 100% zoom</li>
            <li>Visa pack separate — <a href="/guides/visa-application-pdf-workflow-south-africa">visa workflow</a></li>
            </ol>
            <p>Batch 1: <a href="/guides/university-application-pdf-workflow-australia">Australia</a> · <a href="/guides/university-application-pdf-workflow-canada">Canada</a> · <a href="/guides/university-application-pdf-workflow-india">India</a>.</p>
            <p>Hub: <a href="/guides/compress-pdf-for-university-application">university compress</a> · <a href="/guides/university-pdf-upload-requirements">upload requirements</a>.</p>
        ...
        private const string UniversityApplicationPdfWorkflowSouthKorea = """
            <h2>University Application PDF Workflow South Korea — Direct Apply &amp; EJU (2026)</h2>
            <p>Example: Applicant compresses high school transcript and EJU score PDF for Korean uni portal.</p>
            <p class="lead">Pillar: <a href="/guides/university-application-pdf-workflow-india">university application workflow India (reference)</a> · Related: <a href="/guides/visa-application-pdf-workflow-south-korea">/guides/visa-application-pdf-workflow-south-korea</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> University Application PDF Workflow South Korea — Direct Apply &amp; EJU (2026)</figcaption></figure>
            
            <h2>University application — South Korea</h2>
            <p><strong>Typical documents:</strong> Transcript, graduation certificate, EJU, TOPIK, passport.</p>
            <p><strong>Portal caps:</strong> Individual university Korean portals — strict file naming.</p>
            <p>D-2 visa documents separate from admission portal upload.</p>
            <h2>Workflow</h2>
            <ol>
            <li>Scan 200–300 DPI — crop borders — straight edges</li>
            <li>Order per portal FAQ — ID → transcripts → tests → supporting</li>
            <li><a href="/pdf/merge">Merge PDF</a> only when portal allows one file per category</li>
            <li><a href="/pdf/compress">Compress PDF</a> — verify IDs and seals at 100% zoom</li>
            <li>Visa pack separate — <a href="/guides/visa-application-pdf-workflow-south-korea">visa workflow</a></li>
            </ol>
            <p>Batch 1: <a href="/guides/university-application-pdf-workflow-australia">Australia</a> · <a href="/guides/university-application-pdf-workflow-canada">Canada</a> · <a href="/guides/university-application-pdf-workflow-india">India</a>.</p>
            <p>Hub: <a href="/guides/compress-pdf-for-university-application">university compress</a> · <a href="/guides/university-pdf-upload-requirements">upload requirements</a>.</p>
        ...
        private const string UniversityApplicationPdfWorkflowSpain = """
            <h2>University Application PDF Workflow Spain — UNEDasiss &amp; Direct (2026)</h2>
            <p>Example: Non-EU student merges notarized transcript and passport PDF for UNEDasiss.</p>
            <p class="lead">Pillar: <a href="/guides/university-application-pdf-workflow-india">university application workflow India (reference)</a> · Related: <a href="/guides/visa-application-pdf-workflow-spain">/guides/visa-application-pdf-workflow-spain</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> University Application PDF Workflow Spain — UNEDasiss &amp; Direct (2026)</figcaption></figure>
            
            <h2>University application — Spain</h2>
            <p><strong>Typical documents:</strong> Transcript, diploma homologación, passport, Spanish test cert.</p>
            <p><strong>Portal caps:</strong> UNEDasiss, universidad portals — 2–5 MB per slot.</p>
            <p>Homologación PDF often separate slot — no convenience merge.</p>
            <h2>Workflow</h2>
            <ol>
            <li>Scan 200–300 DPI — crop borders — straight edges</li>
            <li>Order per portal FAQ — ID → transcripts → tests → supporting</li>
            <li><a href="/pdf/merge">Merge PDF</a> only when portal allows one file per category</li>
            <li><a href="/pdf/compress">Compress PDF</a> — verify IDs and seals at 100% zoom</li>
            <li>Visa pack separate — <a href="/guides/visa-application-pdf-workflow-spain">visa workflow</a></li>
            </ol>
            <p>Batch 1: <a href="/guides/university-application-pdf-workflow-australia">Australia</a> · <a href="/guides/university-application-pdf-workflow-canada">Canada</a> · <a href="/guides/university-application-pdf-workflow-india">India</a>.</p>
            <p>Hub: <a href="/guides/compress-pdf-for-university-application">university compress</a> · <a href="/guides/university-pdf-upload-requirements">upload requirements</a>.</p>
        ...
        private const string UniversityApplicationPdfWorkflowUae = """
            <h2>University Application PDF Workflow UAE — MOE Attestation &amp; Apply (2026)</h2>
            <p>Example: Resident student merges attested degree and Emirates ID PDF for university portal.</p>
            <p class="lead">Pillar: <a href="/guides/university-application-pdf-workflow-india">university application workflow India (reference)</a> · Related: <a href="/guides/visa-application-pdf-workflow-uae">/guides/visa-application-pdf-workflow-uae</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> University Application PDF Workflow UAE — MOE Attestation &amp; Apply (2026)</figcaption></figure>
            
            <h2>University application — UAE</h2>
            <p><strong>Typical documents:</strong> Attested certificates, Emirates ID, passport, English test.</p>
            <p><strong>Portal caps:</strong> UAE university portals — 2–5 MB per document.</p>
            <p>MOE attestation stamp must be readable at 100% zoom after compress.</p>
            <h2>Workflow</h2>
            <ol>
            <li>Scan 200–300 DPI — crop borders — straight edges</li>
            <li>Order per portal FAQ — ID → transcripts → tests → supporting</li>
            <li><a href="/pdf/merge">Merge PDF</a> only when portal allows one file per category</li>
            <li><a href="/pdf/compress">Compress PDF</a> — verify IDs and seals at 100% zoom</li>
            <li>Visa pack separate — <a href="/guides/visa-application-pdf-workflow-uae">visa workflow</a></li>
            </ol>
            <p>Batch 1: <a href="/guides/university-application-pdf-workflow-australia">Australia</a> · <a href="/guides/university-application-pdf-workflow-canada">Canada</a> · <a href="/guides/university-application-pdf-workflow-india">India</a>.</p>
            <p>Hub: <a href="/guides/compress-pdf-for-university-application">university compress</a> · <a href="/guides/university-pdf-upload-requirements">upload requirements</a>.</p>
        ...
        private const string UniversityApplicationPdfWorkflowUk = """
            <h2>University Application PDF Workflow UK — UCAS &amp; Direct (2026)</h2>
            <p>Example: UCAS applicant compresses reference PDF and portfolio excerpt for supplementary upload.</p>
            <p class="lead">Pillar: <a href="/guides/university-application-pdf-workflow-india">university application workflow India (reference)</a> · Related: <a href="/guides/visa-application-pdf-workflow-uk">/guides/visa-application-pdf-workflow-uk</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> University Application PDF Workflow UK — UCAS &amp; Direct (2026)</figcaption></figure>
            
            <h2>University application — UK</h2>
            <p><strong>Typical documents:</strong> UCAS application PDF exports, references, portfolio, passport for direct apply.</p>
            <p><strong>Portal caps:</strong> UCAS upload slots — <a href="/guides/compress-pdf-ucas">UCAS compress guide</a> — direct uni varies.</p>
            <p>Student visa CAS documents separate from UCAS admission upload.</p>
            <h2>Workflow</h2>
            <ol>
            <li>Scan 200–300 DPI — crop borders — straight edges</li>
            <li>Order per portal FAQ — ID → transcripts → tests → supporting</li>
            <li><a href="/pdf/merge">Merge PDF</a> only when portal allows one file per category</li>
            <li><a href="/pdf/compress">Compress PDF</a> — verify IDs and seals at 100% zoom</li>
            <li>Visa pack separate — <a href="/guides/visa-application-pdf-workflow-uk">visa workflow</a></li>
            </ol>
            <p>Batch 1: <a href="/guides/university-application-pdf-workflow-australia">Australia</a> · <a href="/guides/university-application-pdf-workflow-canada">Canada</a> · <a href="/guides/university-application-pdf-workflow-india">India</a>.</p>
            <p>Hub: <a href="/guides/compress-pdf-for-university-application">university compress</a> · <a href="/guides/university-pdf-upload-requirements">upload requirements</a>.</p>
        ...
        private const string UniversityApplicationPdfWorkflowUsa = """
            <h2>University Application PDF Workflow USA — Common App &amp; Transcripts (2026)</h2>
            <p>Example: Senior compresses portfolio PDF and supplemental materials for Common App upload.</p>
            <p class="lead">Pillar: <a href="/guides/university-application-pdf-workflow-india">university application workflow India (reference)</a> · Related: <a href="/guides/visa-application-pdf-workflow-usa">/guides/visa-application-pdf-workflow-usa</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> University Application PDF Workflow USA — Common App &amp; Transcripts (2026)</figcaption></figure>
            
            <h2>University application — USA</h2>
            <p><strong>Typical documents:</strong> Transcripts via counselor, portfolio, supplemental essays PDF, test score reports.</p>
            <p><strong>Portal caps:</strong> Common App — <a href="/guides/compress-pdf-common-app">Common App compress</a> — Coalition and direct.</p>
            <p>F-1 visa I-20 pack separate from undergraduate admission portal.</p>
            <h2>Workflow</h2>
            <ol>
            <li>Scan 200–300 DPI — crop borders — straight edges</li>
            <li>Order per portal FAQ — ID → transcripts → tests → supporting</li>
            <li><a href="/pdf/merge">Merge PDF</a> only when portal allows one file per category</li>
            <li><a href="/pdf/compress">Compress PDF</a> — verify IDs and seals at 100% zoom</li>
            <li>Visa pack separate — <a href="/guides/visa-application-pdf-workflow-usa">visa workflow</a></li>
            </ol>
            <p>Batch 1: <a href="/guides/university-application-pdf-workflow-australia">Australia</a> · <a href="/guides/university-application-pdf-workflow-canada">Canada</a> · <a href="/guides/university-application-pdf-workflow-india">India</a>.</p>
            <p>Hub: <a href="/guides/compress-pdf-for-university-application">university compress</a> · <a href="/guides/university-pdf-upload-requirements">upload requirements</a>.</p>
        ...
        private const string IrsTaxPdfFormat = """
            <h2>IRS Tax Document PDF Format — Records, Invoices &amp; Storage (2026)</h2>
            <p>Example: SMB archives client invoices as searchable PDF with consistent filename schema for IRS recordkeeping.</p>
            <p class="lead">Pillar: <a href="/guides/tax-document-pdf-workflow-usa">tax document workflow USA</a> · Related: <a href="/guides/invoice-pdf-workflow-india">/guides/invoice-pdf-workflow-india</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> IRS Tax Document PDF Format — Records, Invoices &amp; Storage (2026)</figcaption></figure>
            ...
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Start workflow</strong> <a href="/invoice/create" class="alert-link fw-semibold">Create Invoice →</a></div>
            ...
            <p class="mt-4"><a href="/invoice/create" class="btn btn-primary">Create Invoice</a> · <a href="/guides/tax-document-pdf-workflow-usa">Full guide</a></p>
            """;

        private const string CompressBankStatementPdf = """
            <h2>Compress Bank Statement PDF — Email &amp; Loan Portal Upload (2026)</h2>
            <p>Example: Mortgage broker compresses 6-month Chase netbank PDF from 8 MB to 2 MB for lender portal.</p>
            <p class="lead">Pillar: <a href="/guides/bank-statement-pdf-workflow-usa">bank statement workflow USA</a> · Related: <a href="/guides/compress-pdf-for-visa-application">/guides/compress-pdf-for-visa-application</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Compress Bank Statement PDF — Email &amp; Loan Portal Upload (2026)</figcaption></figure>
        ...
        private const string CompressScannedVsDigitalPdf = """
            <h2>Compress Scanned PDF vs Digital PDF — Which Shrinks More? (2026)</h2>
            <p>Example: Ops team compares Recommended compress on Word export vs 300 DPI scan — scan needs Less first.</p>
            <p class="lead">Pillar: <a href="/guides/compress-pdf-guide">compress PDF guide</a> · Related: <a href="/guides/why-is-pdf-file-so-large">/guides/why-is-pdf-file-so-large</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Compress Scanned PDF vs Digital PDF — Which Shrinks More? (2026)</figcaption></figure>
        ...
        private const string GhostscriptPdfCompression = """
            <h2>Ghostscript PDF Compression Explained — How RatPDF Shrinks Files (2026)</h2>
            <p>Example: IT documents Less vs Recommended vs Extreme on board pack before rolling out compress SOP.</p>
            <p class="lead">Pillar: <a href="/guides/pdf-compression-benchmark">compression benchmark guide</a> · Related: <a href="/guides/compress-pdf-guide">/guides/compress-pdf-guide</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Ghostscript PDF Compression Explained — How RatPDF Shrinks Files (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/compress" class="btn btn-primary">Compress PDF</a> · <a href="/guides/pdf-compression-benchmark">Full guide</a></p>
            """;

        private const string CompressPdfAccountants = """
            <h2>Compress PDF for Accountants — Client Packs &amp; Portal Uploads (2026)</h2>
            <p>Example: CA firm compresses quarterly trial balance PDF export from 18 MB to 9 MB for client email.</p>
            <p class="lead">Pillar: <a href="/guides/merge-pdf-accountants">merge PDF for accountants</a> · Related: <a href="/guides/pdf-workflow-accountants">/guides/pdf-workflow-accountants</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Compress PDF for Accountants — Client Packs &amp; Portal Uploads (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/compress" class="btn btn-primary">Compress PDF</a> · <a href="/guides/merge-pdf-accountants">Full guide</a></p>
            """;

        private const string CompressPdfLawyers = """
            <h2>Compress PDF for Lawyers — E-Filing &amp; Discovery Uploads (2026)</h2>
            <p>Example: Paralegal compresses 42 MB exhibit PDF to 28 MB for CM/ECF upload after merge.</p>
            <p class="lead">Pillar: <a href="/guides/merge-pdf-court-filing">merge PDF for court filing</a> · Related: <a href="/guides/pdf-workflow-lawyers">/guides/pdf-workflow-lawyers</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Compress PDF for Lawyers — E-Filing &amp; Discovery Uploads (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/compress" class="btn btn-primary">Compress PDF</a> · <a href="/guides/merge-pdf-court-filing">Full guide</a></p>
            """;

        private const string WhyIsPdfFileSoLarge = """
            <h2>Why Is My PDF So Large? — Causes &amp; Fixes (2026)</h2>
            <p>Example: User discovers 80 MB PDF is 600 DPI phone photos — re-scan at 200 DPI then compress.</p>
            <p class="lead">Pillar: <a href="/guides/compress-pdf-guide">compress PDF guide</a> · Related: <a href="/guides/compress-scanned-vs-digital-pdf">/guides/compress-scanned-vs-digital-pdf</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Why Is My PDF So Large? — Causes &amp; Fixes (2026)</figcaption></figure>
