namespace ratpdf.Content
{
    ...
    internal static class GuideBodiesWave43
    {
        ...
        {
            "bank-statement-pdf-workflow-turkey" => BankStatementPdfWorkflowTurkey,
            "bank-statement-pdf-workflow-egypt" => BankStatementPdfWorkflowEgypt,
            "bank-statement-pdf-workflow-morocco" => BankStatementPdfWorkflowMorocco,
            "bank-statement-pdf-workflow-nigeria" => BankStatementPdfWorkflowNigeria,
            "bank-statement-pdf-workflow-kenya" => BankStatementPdfWorkflowKenya,
            "bank-statement-pdf-workflow-thailand" => BankStatementPdfWorkflowThailand,
            "bank-statement-pdf-workflow-vietnam" => BankStatementPdfWorkflowVietnam,
            "bank-statement-pdf-workflow-indonesia" => BankStatementPdfWorkflowIndonesia,
            "bank-statement-pdf-workflow-malaysia" => BankStatementPdfWorkflowMalaysia,
            "bank-statement-pdf-workflow-philippines" => BankStatementPdfWorkflowPhilippines,
            "bank-statement-pdf-workflow-china" => BankStatementPdfWorkflowChina,
            "bank-statement-pdf-workflow-taiwan" => BankStatementPdfWorkflowTaiwan,
            "bank-statement-pdf-workflow-hong-kong" => BankStatementPdfWorkflowHongKong,
            "pdf-form-digital-signature-field" => PdfFormDigitalSignatureField,
            "remove-metadata-from-pdf" => RemoveMetadataFromPdf,
            "remediate-pdf-accessibility" => RemediatePdfAccessibility,
            "pdf-error-file-damaged" => PdfErrorFileDamaged,
            _ => null
        };

        private const string BankStatementPdfWorkflowTurkey = """
            <h2>Bank Statement PDF Workflow Turkey — Visa Evidence (2026)</h2>
            <p>Example: Business visitor compresses İş Bankası statement PDF for Turkey visa invitation evidence.</p>
            <p class="lead">Pillar: <a href="/guides/visa-application-pdf-workflow-turkey">Turkey visa workflow</a> · Related: <a href="/guides/bank-statement-pdf-visa">/guides/bank-statement-pdf-visa</a> · Tool page: <a href="/compress-pdf-for-visa-application">/compress-pdf-for-visa-application</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Bank Statement PDF Workflow Turkey — Visa Evidence (2026)</figcaption></figure>
            
            <h2>Turkey bank PDF workflow</h2>
            <p>Official export: Ziraat / İş Bankası netbank — not mobile screenshot — all pages — account holder visible.</p>
            <ol>
            ...
            <p>Pillar: <a href="/guides/visa-application-pdf-workflow-turkey">Turkey visa workflow</a> · <a href="/guides/bank-statement-pdf-visa">bank statement visa</a>.</p>
            ...
            <p class="mt-4"><a href="/pdf/compress" class="btn btn-primary">Compress PDF</a> · <a href="/guides/visa-application-pdf-workflow-turkey">Full guide</a></p>
            """;

        private const string BankStatementPdfWorkflowEgypt = """
            <h2>Bank Statement PDF Workflow Egypt — Visa Evidence (2026)</h2>
            <p>Example: Tourist compresses CIB six-month PDF for Egypt visa funds proof.</p>
            <p class="lead">Pillar: <a href="/guides/visa-application-pdf-workflow-egypt">Egypt visa workflow</a> · Related: <a href="/guides/bank-statement-pdf-visa">/guides/bank-statement-pdf-visa</a> · Tool page: <a href="/compress-pdf-for-visa-application">/compress-pdf-for-visa-application</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Bank Statement PDF Workflow Egypt — Visa Evidence (2026)</figcaption></figure>
            
            <h2>Egypt bank PDF workflow</h2>
            <p>Official export: NBE / CIB export — not mobile screenshot — all pages — account holder visible.</p>
            <ol>
            <li>Download netbank PDF — last 3–6 months per embassy rules</li>
            <li><a href="/pdf/compress">Compress</a> — Less on scans</li>
            <li>Verify salary credits and closing balance at 100% zoom</li>
            </ol>
            <p>Pillar: <a href="/guides/visa-application-pdf-workflow-egypt">Egypt visa workflow</a> · <a href="/guides/bank-statement-pdf-visa">bank statement visa</a>.</p>
            <p>Tool: <a href="/compress-pdf-for-visa-application">/compress-pdf-for-visa-application</a></p>
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Start workflow</strong> <a href="/pdf/compress" class="alert-link fw-semibold">Compress PDF →</a></div>
            ...
            <p class="mt-4"><a href="/pdf/compress" class="btn btn-primary">Compress PDF</a> · <a href="/guides/visa-application-pdf-workflow-egypt">Full guide</a></p>
            """;

        private const string BankStatementPdfWorkflowMorocco = """
            <h2>Bank Statement PDF Workflow Morocco — Visa Evidence (2026)</h2>
            <p>Example: Applicant compresses Attijariwafa bank PDF for Morocco visa financial slot.</p>
            <p class="lead">Pillar: <a href="/guides/visa-application-pdf-workflow-morocco">Morocco visa workflow</a> · Related: <a href="/guides/bank-statement-pdf-visa">/guides/bank-statement-pdf-visa</a> · Tool page: <a href="/compress-pdf-for-visa-application">/compress-pdf-for-visa-application</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Bank Statement PDF Workflow Morocco — Visa Evidence (2026)</figcaption></figure>
            
            <h2>Morocco bank PDF workflow</h2>
            <p>Official export: Attijariwafa / BMCE — not mobile screenshot — all pages — account holder visible.</p>
            <ol>
            <li>Download netbank PDF — last 3–6 months per embassy rules</li>
            <li><a href="/pdf/compress">Compress</a> — Less on scans</li>
            <li>Verify salary credits and closing balance at 100% zoom</li>
            </ol>
            <p>Pillar: <a href="/guides/visa-application-pdf-workflow-morocco">Morocco visa workflow</a> · <a href="/guides/bank-statement-pdf-visa">bank statement visa</a>.</p>
            <p>Tool: <a href="/compress-pdf-for-visa-application">/compress-pdf-for-visa-application</a></p>
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Start workflow</strong> <a href="/pdf/compress" class="alert-link fw-semibold">Compress PDF →</a></div>
            ...
            <p class="mt-4"><a href="/pdf/compress" class="btn btn-primary">Compress PDF</a> · <a href="/guides/visa-application-pdf-workflow-morocco">Full guide</a></p>
            """;

        private const string BankStatementPdfWorkflowNigeria = """
            <h2>Bank Statement PDF Workflow Nigeria — Visa Evidence (2026)</h2>
            <p>Example: Student compresses Zenith sponsor statement PDF for Nigeria visa upload.</p>
            <p class="lead">Pillar: <a href="/guides/visa-application-pdf-workflow-nigeria">Nigeria visa workflow</a> · Related: <a href="/guides/bank-statement-pdf-visa">/guides/bank-statement-pdf-visa</a> · Tool page: <a href="/compress-pdf-for-visa-application">/compress-pdf-for-visa-application</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Bank Statement PDF Workflow Nigeria — Visa Evidence (2026)</figcaption></figure>
            
            <h2>Nigeria bank PDF workflow</h2>
            <p>Official export: GTBank / Zenith — not mobile screenshot — all pages — account holder visible.</p>
            <ol>
            <li>Download netbank PDF — last 3–6 months per embassy rules</li>
            <li><a href="/pdf/compress">Compress</a> — Less on scans</li>
            <li>Verify salary credits and closing balance at 100% zoom</li>
            </ol>
            <p>Pillar: <a href="/guides/visa-application-pdf-workflow-nigeria">Nigeria visa workflow</a> · <a href="/guides/bank-statement-pdf-visa">bank statement visa</a>.</p>
            <p>Tool: <a href="/compress-pdf-for-visa-application">/compress-pdf-for-visa-application</a></p>
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Start workflow</strong> <a href="/pdf/compress" class="alert-link fw-semibold">Compress PDF →</a></div>
            ...
            <p class="mt-4"><a href="/pdf/compress" class="btn btn-primary">Compress PDF</a> · <a href="/guides/visa-application-pdf-workflow-nigeria">Full guide</a></p>
            """;

        private const string BankStatementPdfWorkflowKenya = """
            <h2>Bank Statement PDF Workflow Kenya — Visa Evidence (2026)</h2>
            <p>Example: Applicant compresses Equity Bank PDF for Kenya eVisa financial evidence.</p>
            <p class="lead">Pillar: <a href="/guides/visa-application-pdf-workflow-kenya">Kenya visa workflow</a> · Related: <a href="/guides/bank-statement-pdf-visa">/guides/bank-statement-pdf-visa</a> · Tool page: <a href="/compress-pdf-for-visa-application">/compress-pdf-for-visa-application</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Bank Statement PDF Workflow Kenya — Visa Evidence (2026)</figcaption></figure>
            
            <h2>Kenya bank PDF workflow</h2>
            <p>Official export: Equity / KCB netbank — not mobile screenshot — all pages — account holder visible.</p>
            <ol>
            <li>Download netbank PDF — last 3–6 months per embassy rules</li>
            <li><a href="/pdf/compress">Compress</a> — Less on scans</li>
            <li>Verify salary credits and closing balance at 100% zoom</li>
            </ol>
            <p>Pillar: <a href="/guides/visa-application-pdf-workflow-kenya">Kenya visa workflow</a> · <a href="/guides/bank-statement-pdf-visa">bank statement visa</a>.</p>
            <p>Tool: <a href="/compress-pdf-for-visa-application">/compress-pdf-for-visa-application</a></p>
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Start workflow</strong> <a href="/pdf/compress" class="alert-link fw-semibold">Compress PDF →</a></div>
            ...
            <p class="mt-4"><a href="/pdf/compress" class="btn btn-primary">Compress PDF</a> · <a href="/guides/visa-application-pdf-workflow-kenya">Full guide</a></p>
            """;

        private const string BankStatementPdfWorkflowThailand = """
            <h2>Bank Statement PDF Workflow Thailand — Visa Evidence (2026)</h2>
            <p>Example: Tourist compresses Kasikorn statement PDF for Thailand visa funds.</p>
            <p class="lead">Pillar: <a href="/guides/visa-application-pdf-workflow-thailand">Thailand visa workflow</a> · Related: <a href="/guides/bank-statement-pdf-visa">/guides/bank-statement-pdf-visa</a> · Tool page: <a href="/compress-pdf-for-visa-application">/compress-pdf-for-visa-application</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Bank Statement PDF Workflow Thailand — Visa Evidence (2026)</figcaption></figure>
            
            <h2>Thailand bank PDF workflow</h2>
            <p>Official export: Bangkok Bank / Kasikorn — not mobile screenshot — all pages — account holder visible.</p>
            <ol>
            <li>Download netbank PDF — last 3–6 months per embassy rules</li>
            <li><a href="/pdf/compress">Compress</a> — Less on scans</li>
            <li>Verify salary credits and closing balance at 100% zoom</li>
            </ol>
            <p>Pillar: <a href="/guides/visa-application-pdf-workflow-thailand">Thailand visa workflow</a> · <a href="/guides/bank-statement-pdf-visa">bank statement visa</a>.</p>
            <p>Tool: <a href="/compress-pdf-for-visa-application">/compress-pdf-for-visa-application</a></p>
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Start workflow</strong> <a href="/pdf/compress" class="alert-link fw-semibold">Compress PDF →</a></div>
            ...
            <p class="mt-4"><a href="/pdf/compress" class="btn btn-primary">Compress PDF</a> · <a href="/guides/visa-application-pdf-workflow-thailand">Full guide</a></p>
            """;

        private const string BankStatementPdfWorkflowVietnam = """
            <h2>Bank Statement PDF Workflow Vietnam — Visa Evidence (2026)</h2>
            <p>Example: Visitor compresses Vietcombank PDF for Vietnam eVisa financial proof.</p>
            <p class="lead">Pillar: <a href="/guides/visa-application-pdf-workflow-vietnam">Vietnam visa workflow</a> · Related: <a href="/guides/bank-statement-pdf-visa">/guides/bank-statement-pdf-visa</a> · Tool page: <a href="/compress-pdf-for-visa-application">/compress-pdf-for-visa-application</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Bank Statement PDF Workflow Vietnam — Visa Evidence (2026)</figcaption></figure>
            
            <h2>Vietnam bank PDF workflow</h2>
            <p>Official export: Vietcombank / Techcombank — not mobile screenshot — all pages — account holder visible.</p>
            <ol>
            <li>Download netbank PDF — last 3–6 months per embassy rules</li>
            <li><a href="/pdf/compress">Compress</a> — Less on scans</li>
            <li>Verify salary credits and closing balance at 100% zoom</li>
            </ol>
            <p>Pillar: <a href="/guides/visa-application-pdf-workflow-vietnam">Vietnam visa workflow</a> · <a href="/guides/bank-statement-pdf-visa">bank statement visa</a>.</p>
            <p>Tool: <a href="/compress-pdf-for-visa-application">/compress-pdf-for-visa-application</a></p>
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Start workflow</strong> <a href="/pdf/compress" class="alert-link fw-semibold">Compress PDF →</a></div>
            ...
            <p class="mt-4"><a href="/pdf/compress" class="btn btn-primary">Compress PDF</a> · <a href="/guides/visa-application-pdf-workflow-vietnam">Full guide</a></p>
            """;

        private const string BankStatementPdfWorkflowIndonesia = """
            <h2>Bank Statement PDF Workflow Indonesia — Visa Evidence (2026)</h2>
            <p>Example: Digital nomad compresses BCA export for Indonesia visa portal.</p>
            <p class="lead">Pillar: <a href="/guides/visa-application-pdf-workflow-indonesia">Indonesia visa workflow</a> · Related: <a href="/guides/bank-statement-pdf-visa">/guides/bank-statement-pdf-visa</a> · Tool page: <a href="/compress-pdf-for-visa-application">/compress-pdf-for-visa-application</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Bank Statement PDF Workflow Indonesia — Visa Evidence (2026)</figcaption></figure>
            
            <h2>Indonesia bank PDF workflow</h2>
            <p>Official export: BCA / Mandiri — not mobile screenshot — all pages — account holder visible.</p>
            <ol>
            <li>Download netbank PDF — last 3–6 months per embassy rules</li>
            <li><a href="/pdf/compress">Compress</a> — Less on scans</li>
            <li>Verify salary credits and closing balance at 100% zoom</li>
            </ol>
            <p>Pillar: <a href="/guides/visa-application-pdf-workflow-indonesia">Indonesia visa workflow</a> · <a href="/guides/bank-statement-pdf-visa">bank statement visa</a>.</p>
            <p>Tool: <a href="/compress-pdf-for-visa-application">/compress-pdf-for-visa-application</a></p>
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Start workflow</strong> <a href="/pdf/compress" class="alert-link fw-semibold">Compress PDF →</a></div>
            ...
            <p class="mt-4"><a href="/pdf/compress" class="btn btn-primary">Compress PDF</a> · <a href="/guides/visa-application-pdf-workflow-indonesia">Full guide</a></p>
            """;

        private const string BankStatementPdfWorkflowMalaysia = """
            <h2>Bank Statement PDF Workflow Malaysia — Visa Evidence (2026)</h2>
            <p>Example: Student compresses Maybank PDF for Malaysia visa sponsor evidence.</p>
            <p class="lead">Pillar: <a href="/guides/visa-application-pdf-workflow-malaysia">Malaysia visa workflow</a> · Related: <a href="/guides/bank-statement-pdf-visa">/guides/bank-statement-pdf-visa</a> · Tool page: <a href="/compress-pdf-for-visa-application">/compress-pdf-for-visa-application</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Bank Statement PDF Workflow Malaysia — Visa Evidence (2026)</figcaption></figure>
            
            <h2>Malaysia bank PDF workflow</h2>
            <p>Official export: Maybank / CIMB — not mobile screenshot — all pages — account holder visible.</p>
            <ol>
            <li>Download netbank PDF — last 3–6 months per embassy rules</li>
            <li><a href="/pdf/compress">Compress</a> — Less on scans</li>
            <li>Verify salary credits and closing balance at 100% zoom</li>
            </ol>
            <p>Pillar: <a href="/guides/visa-application-pdf-workflow-malaysia">Malaysia visa workflow</a> · <a href="/guides/bank-statement-pdf-visa">bank statement visa</a>.</p>
            <p>Tool: <a href="/compress-pdf-for-visa-application">/compress-pdf-for-visa-application</a></p>
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Start workflow</strong> <a href="/pdf/compress" class="alert-link fw-semibold">Compress PDF →</a></div>
            ...
            <p class="mt-4"><a href="/pdf/compress" class="btn btn-primary">Compress PDF</a> · <a href="/guides/visa-application-pdf-workflow-malaysia">Full guide</a></p>
            """;

        private const string BankStatementPdfWorkflowPhilippines = """
            <h2>Bank Statement PDF Workflow Philippines — Visa Evidence (2026)</h2>
            <p>Example: Worker compresses BPI statement PDF for Philippines visa slot.</p>
            <p class="lead">Pillar: <a href="/guides/visa-application-pdf-workflow-philippines">Philippines visa workflow</a> · Related: <a href="/guides/bank-statement-pdf-visa">/guides/bank-statement-pdf-visa</a> · Tool page: <a href="/compress-pdf-for-visa-application">/compress-pdf-for-visa-application</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Bank Statement PDF Workflow Philippines — Visa Evidence (2026)</figcaption></figure>
            
            <h2>Philippines bank PDF workflow</h2>
            <p>Official export: BDO / BPI — not mobile screenshot — all pages — account holder visible.</p>
            <ol>
            <li>Download netbank PDF — last 3–6 months per embassy rules</li>
            <li><a href="/pdf/compress">Compress</a> — Less on scans</li>
            <li>Verify salary credits and closing balance at 100% zoom</li>
            </ol>
            <p>Pillar: <a href="/guides/visa-application-pdf-workflow-philippines">Philippines visa workflow</a> · <a href="/guides/bank-statement-pdf-visa">bank statement visa</a>.</p>
            <p>Tool: <a href="/compress-pdf-for-visa-application">/compress-pdf-for-visa-application</a></p>
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Start workflow</strong> <a href="/pdf/compress" class="alert-link fw-semibold">Compress PDF →</a></div>
            ...
            <p class="mt-4"><a href="/pdf/compress" class="btn btn-primary">Compress PDF</a> · <a href="/guides/visa-application-pdf-workflow-philippines">Full guide</a></p>
            """;

        private const string BankStatementPdfWorkflowChina = """
            <h2>Bank Statement PDF Workflow China — Visa Evidence (2026)</h2>
            <p>Example: Applicant compresses bilingual Bank of China PDF for CVASC visa center.</p>
            <p class="lead">Pillar: <a href="/guides/visa-application-pdf-workflow-china">China visa workflow</a> · Related: <a href="/guides/bank-statement-pdf-visa">/guides/bank-statement-pdf-visa</a> · Tool page: <a href="/compress-pdf-for-visa-application">/compress-pdf-for-visa-application</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Bank Statement PDF Workflow China — Visa Evidence (2026)</figcaption></figure>
            
            <h2>China bank PDF workflow</h2>
            <p>Official export: ICBC / Bank of China — not mobile screenshot — all pages — account holder visible.</p>
            <ol>
            <li>Download netbank PDF — last 3–6 months per embassy rules</li>
            <li><a href="/pdf/compress">Compress</a> — Less on scans</li>
            <li>Verify salary credits and closing balance at 100% zoom</li>
            </ol>
            <p>Pillar: <a href="/guides/visa-application-pdf-workflow-china">China visa workflow</a> · <a href="/guides/bank-statement-pdf-visa">bank statement visa</a>.</p>
            <p>Tool: <a href="/compress-pdf-for-visa-application">/compress-pdf-for-visa-application</a></p>
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Start workflow</strong> <a href="/pdf/compress" class="alert-link fw-semibold">Compress PDF →</a></div>
            ...
            <p class="mt-4"><a href="/pdf/compress" class="btn btn-primary">Compress PDF</a> · <a href="/guides/visa-application-pdf-workflow-china">Full guide</a></p>
            """;

        private const string BankStatementPdfWorkflowTaiwan = """
            <h2>Bank Statement PDF Workflow Taiwan — Visa Evidence (2026)</h2>
            <p>Example: Researcher compresses CTBC funds PDF for Taiwan visa application.</p>
            <p class="lead">Pillar: <a href="/guides/visa-application-pdf-workflow-taiwan">Taiwan visa workflow</a> · Related: <a href="/guides/bank-statement-pdf-visa">/guides/bank-statement-pdf-visa</a> · Tool page: <a href="/compress-pdf-for-visa-application">/compress-pdf-for-visa-application</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Bank Statement PDF Workflow Taiwan — Visa Evidence (2026)</figcaption></figure>
            
            <h2>Taiwan bank PDF workflow</h2>
            <p>Official export: CTBC / Cathay United — not mobile screenshot — all pages — account holder visible.</p>
            <ol>
            <li>Download netbank PDF — last 3–6 months per embassy rules</li>
            <li><a href="/pdf/compress">Compress</a> — Less on scans</li>
            <li>Verify salary credits and closing balance at 100% zoom</li>
            </ol>
            <p>Pillar: <a href="/guides/visa-application-pdf-workflow-taiwan">Taiwan visa workflow</a> · <a href="/guides/bank-statement-pdf-visa">bank statement visa</a>.</p>
            <p>Tool: <a href="/compress-pdf-for-visa-application">/compress-pdf-for-visa-application</a></p>
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Start workflow</strong> <a href="/pdf/compress" class="alert-link fw-semibold">Compress PDF →</a></div>
            ...
            <p class="mt-4"><a href="/pdf/compress" class="btn btn-primary">Compress PDF</a> · <a href="/guides/visa-application-pdf-workflow-taiwan">Full guide</a></p>
            """;

        private const string BankStatementPdfWorkflowHongKong = """
            <h2>Bank Statement PDF Workflow Hong Kong — Visa Evidence (2026)</h2>
            <p>Example: Visitor compresses Hang Seng statement PDF for Hong Kong visa funds.</p>
            <p class="lead">Pillar: <a href="/guides/visa-application-pdf-workflow-hong-kong">Hong Kong visa workflow</a> · Related: <a href="/guides/bank-statement-pdf-visa">/guides/bank-statement-pdf-visa</a> · Tool page: <a href="/compress-pdf-for-visa-application">/compress-pdf-for-visa-application</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Bank Statement PDF Workflow Hong Kong — Visa Evidence (2026)</figcaption></figure>
            
            <h2>Hong Kong bank PDF workflow</h2>
            <p>Official export: HSBC HK / Hang Seng — not mobile screenshot — all pages — account holder visible.</p>
            <ol>
            <li>Download netbank PDF — last 3–6 months per embassy rules</li>
            <li><a href="/pdf/compress">Compress</a> — Less on scans</li>
            <li>Verify salary credits and closing balance at 100% zoom</li>
            </ol>
            <p>Pillar: <a href="/guides/visa-application-pdf-workflow-hong-kong">Hong Kong visa workflow</a> · <a href="/guides/bank-statement-pdf-visa">bank statement visa</a>.</p>
            <p>Tool: <a href="/compress-pdf-for-visa-application">/compress-pdf-for-visa-application</a></p>
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Start workflow</strong> <a href="/pdf/compress" class="alert-link fw-semibold">Compress PDF →</a></div>
            ...
            <p class="mt-4"><a href="/pdf/compress" class="btn btn-primary">Compress PDF</a> · <a href="/guides/visa-application-pdf-workflow-hong-kong">Full guide</a></p>
            """;

        private const string PdfFormDigitalSignatureField = """
            <h2>PDF Form Digital Signature Field — Add &amp; Validate (2026)</h2>
            <p>Example: HR adds signature field to offer letter PDF — candidate signs in browser — flatten before archive.</p>
            <p class="lead">Pillar: <a href="/guides/beginner-digital-signature-basics">digital signature basics</a> · Related: <a href="/guides/glossary-digital-signature">/guides/glossary-digital-signature</a> · Tool page: <a href="/pdf/signtext">/pdf/signtext</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF Form Digital Signature Field — Add &amp; Validate (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/signtext" class="btn btn-primary">Sign PDF</a> · <a href="/guides/beginner-digital-signature-basics">Full guide</a></p>
            """;

        private const string RemoveMetadataFromPdf = """
            <h2>Remove Metadata from PDF — Author &amp; Hidden Paths (2026)</h2>
            <p>Example: Legal strips internal author path from draft MSA PDF before client share on procurement portal.</p>
            <p class="lead">Pillar: <a href="/guides/pdf-metadata-remove">PDF metadata remove</a> · Related: <a href="/guides/beginner-pdf-metadata-explained">/guides/beginner-pdf-metadata-explained</a> · Tool page: <a href="/pdf/pdfmetadata">/pdf/pdfmetadata</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Remove Metadata from PDF — Author &amp; Hidden Paths (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/pdfmetadata" class="btn btn-primary">PDF Metadata</a> · <a href="/guides/pdf-metadata-remove">Full guide</a></p>
            """;

        private const string RemediatePdfAccessibility = """
            <h2>Remediate PDF Accessibility — Tags &amp; Alt Text (2026)</h2>
            <p>Example: Publisher adds alt text and fixes reading order on annual report PDF before government RFP submit.</p>
            <p class="lead">Pillar: <a href="/guides/pdf-ua-accessibility">PDF/UA accessibility</a> · Related: <a href="/guides/pdf-ua-compliance-guide">/guides/pdf-ua-compliance-guide</a> · Tool page: <a href="/pdf/ocrpdf">/pdf/ocrpdf</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Remediate PDF Accessibility — Tags &amp; Alt Text (2026)</figcaption></figure>
        ...
        private const string PdfErrorFileDamaged = """
            <h2>PDF File Damaged — Cannot Be Repaired Fix (2026)</h2>
            <p>Example: USB copy interrupted — Acrobat says file damaged — re-download from source — compress recovers readable copy.</p>
            <p class="lead">Pillar: <a href="/guides/pdf-file-corrupted">PDF file corrupted</a> · Related: <a href="/guides/corrupted-pdf-repair">/guides/corrupted-pdf-repair</a> · Tool page: <a href="/pdf/compress">/pdf/compress</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF File Damaged — Cannot Be Repaired Fix (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/compress" class="btn btn-primary">Compress PDF</a> · <a href="/guides/pdf-file-corrupted">Full guide</a></p>
            """;
