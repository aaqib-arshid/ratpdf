namespace ratpdf.Content
{
    ...
    internal static class GuideBodiesWave51
    {
        ...
        {
            "merge-pdf-for-insurance" => MergePdfForInsurance,
            "merge-pdf-for-education" => MergePdfForEducation,
            "merge-pdf-for-nonprofits" => MergePdfForNonprofits,
            "merge-pdf-for-government" => MergePdfForGovernment,
            "merge-pdf-for-freelancers" => MergePdfForFreelancers,
            "merge-pdf-for-consultants" => MergePdfForConsultants,
            "merge-pdf-for-architects" => MergePdfForArchitects,
            "merge-pdf-for-engineers" => MergePdfForEngineers,
            "merge-pdf-for-researchers" => MergePdfForResearchers,
            "merge-pdf-for-journalists" => MergePdfForJournalists,
            "merge-pdf-for-hr-teams" => MergePdfForHrTeams,
            "merge-pdf-for-sales-teams" => MergePdfForSalesTeams,
            "merge-pdf-for-marketing-teams" => MergePdfForMarketingTeams,
            "convert-pdf-on-iphone" => ConvertPdfOnIphone,
            "convert-pdf-on-ipad" => ConvertPdfOnIpad,
            "convert-pdf-on-chromebook" => ConvertPdfOnChromebook,
            "convert-pdf-on-linux" => ConvertPdfOnLinux,
            _ => null
        };

        private const string MergePdfForInsurance = """
            <h2>Merge PDF for Insurance — Policy packs Workflow (2026)</h2>
            <p>Example: Agent merges declaration, endorsement, and ID card PDFs before client binder delivery.</p>
            <p class="lead">Pillar: <a href="/guides/merge-pdf">merge PDF guide</a> · Related: <a href="/guides/best-browser-pdf-tools-for-insurance-agents">/guides/best-browser-pdf-tools-for-insurance-agents</a> · Tool page: <a href="/pdf/merge">/pdf/merge</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Merge PDF for Insurance — Policy packs Workflow (2026)</figcaption></figure>
            
            <h2>Merge PDF for Insurance</h2>
            <p>Typical pack: Policy packs — Agent merges declaration, endorsement, and ID card PDFs before client binder delivery.</p>
            <ol>
        ...
        private const string MergePdfForEducation = """
            <h2>Merge PDF for Education — Course packs Workflow (2026)</h2>
            <p>Example: Registrar merges syllabus, calendar, and policy PDFs for student orientation packet.</p>
            ...
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Merge PDF for Education — Course packs Workflow (2026)</figcaption></figure>
            
            <h2>Merge PDF for Education</h2>
            <p>Typical pack: Course packs — Registrar merges syllabus, calendar, and policy PDFs for student orientation packet.</p>
            <ol>
            <li>Numeric filename prefixes — <code>01_</code>, <code>02_</code></li>
            <li><a href="/pdf/merge">Merge</a> in delivery order</li>
            <li><a href="/pdf/watermark">Watermark</a> DRAFT if pre-approval</li>
        ...
        private const string MergePdfForNonprofits = """
            <h2>Merge PDF for Nonprofits — Grant packs Workflow (2026)</h2>
            <p>Example: Program lead merges narrative, budget, and LOI PDFs before foundation portal upload.</p>
            ...
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Merge PDF for Nonprofits — Grant packs Workflow (2026)</figcaption></figure>
            
            <h2>Merge PDF for Nonprofits</h2>
            <p>Typical pack: Grant packs — Program lead merges narrative, budget, and LOI PDFs before foundation portal upload.</p>
            <ol>
            <li>Numeric filename prefixes — <code>01_</code>, <code>02_</code></li>
            <li><a href="/pdf/merge">Merge</a> in delivery order</li>
            <li><a href="/pdf/watermark">Watermark</a> DRAFT if pre-approval</li>
        ...
        private const string MergePdfForGovernment = """
            <h2>Merge PDF for Government — RFP volumes Workflow (2026)</h2>
            ...
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Merge PDF for Government — RFP volumes Workflow (2026)</figcaption></figure>
            
            <h2>Merge PDF for Government</h2>
            <p>Typical pack: RFP volumes — Contractor merges technical and cost volume PDFs in SAM submission order.</p>
            <ol>
            <li>Numeric filename prefixes — <code>01_</code>, <code>02_</code></li>
            <li><a href="/pdf/merge">Merge</a> in delivery order</li>
            <li><a href="/pdf/watermark">Watermark</a> DRAFT if pre-approval</li>
        ...
        private const string MergePdfForFreelancers = """
            <h2>Merge PDF for Freelancers — Client deliverables Workflow (2026)</h2>
            <p>Example: Designer merges mockup, spec, and invoice PDFs before milestone email to client.</p>
            ...
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Merge PDF for Freelancers — Client deliverables Workflow (2026)</figcaption></figure>
            
            <h2>Merge PDF for Freelancers</h2>
            <p>Typical pack: Client deliverables — Designer merges mockup, spec, and invoice PDFs before milestone email to client.</p>
            <ol>
            <li>Numeric filename prefixes — <code>01_</code>, <code>02_</code></li>
            <li><a href="/pdf/merge">Merge</a> in delivery order</li>
            <li><a href="/pdf/watermark">Watermark</a> DRAFT if pre-approval</li>
        ...
        private const string MergePdfForConsultants = """
            <h2>Merge PDF for Consultants — Engagement packs Workflow (2026)</h2>
            <p>Example: Consultant merges SOW, timeline, and case study PDFs — watermark DRAFT until sign.</p>
            ...
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Merge PDF for Consultants — Engagement packs Workflow (2026)</figcaption></figure>
            
            <h2>Merge PDF for Consultants</h2>
            <p>Typical pack: Engagement packs — Consultant merges SOW, timeline, and case study PDFs — watermark DRAFT until sign.</p>
            <ol>
            <li>Numeric filename prefixes — <code>01_</code>, <code>02_</code></li>
            <li><a href="/pdf/merge">Merge</a> in delivery order</li>
            <li><a href="/pdf/watermark">Watermark</a> DRAFT if pre-approval</li>
        ...
        private const string MergePdfForArchitects = """
            <h2>Merge PDF for Architects — Submittal sets Workflow (2026)</h2>
            <p>Example: Architect merges drawing index, spec section, and product data PDFs for GC review.</p>
            <p class="lead">Pillar: <a href="/guides/merge-pdf">merge PDF guide</a> · Related: <a href="/guides/best-browser-pdf-tools-for-construction-managers">/guides/best-browser-pdf-tools-for-construction-managers</a> · Tool page: <a href="/pdf/merge">/pdf/merge</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Merge PDF for Architects — Submittal sets Workflow (2026)</figcaption></figure>
            
            <h2>Merge PDF for Architects</h2>
            <p>Typical pack: Submittal sets — Architect merges drawing index, spec section, and product data PDFs for GC review.</p>
            <ol>
            <li>Numeric filename prefixes — <code>01_</code>, <code>02_</code></li>
            <li><a href="/pdf/merge">Merge</a> in delivery order</li>
            <li><a href="/pdf/watermark">Watermark</a> DRAFT if pre-approval</li>
        ...
        private const string MergePdfForEngineers = """
            <h2>Merge PDF for Engineers — Spec bundles Workflow (2026)</h2>
            <p>Example: Engineer merges calculation, drawing, and test report PDFs for permit submittal.</p>
            ...
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Merge PDF for Engineers — Spec bundles Workflow (2026)</figcaption></figure>
            
            <h2>Merge PDF for Engineers</h2>
            <p>Typical pack: Spec bundles — Engineer merges calculation, drawing, and test report PDFs for permit submittal.</p>
            <ol>
            <li>Numeric filename prefixes — <code>01_</code>, <code>02_</code></li>
            <li><a href="/pdf/merge">Merge</a> in delivery order</li>
            <li><a href="/pdf/watermark">Watermark</a> DRAFT if pre-approval</li>
        ...
        private const string MergePdfForResearchers = """
            <h2>Merge PDF for Researchers — Publication packs Workflow (2026)</h2>
            <p>Example: PI merges manuscript, supplementary, and ethics approval PDFs for journal upload.</p>
            ...
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Merge PDF for Researchers — Publication packs Workflow (2026)</figcaption></figure>
            
            <h2>Merge PDF for Researchers</h2>
            <p>Typical pack: Publication packs — PI merges manuscript, supplementary, and ethics approval PDFs for journal upload.</p>
            <ol>
            <li>Numeric filename prefixes — <code>01_</code>, <code>02_</code></li>
            <li><a href="/pdf/merge">Merge</a> in delivery order</li>
            <li><a href="/pdf/watermark">Watermark</a> DRAFT if pre-approval</li>
        ...
        private const string MergePdfForJournalists = """
            <h2>Merge PDF for Journalists — FOI bundles Workflow (2026)</h2>
            <p>Example: Reporter merges redacted FOI pages and source exhibit PDFs for editor review.</p>
            <p class="lead">Pillar: <a href="/guides/merge-pdf">merge PDF guide</a> · Related: <a href="/guides/best-browser-pdf-tools-for-journalists">/guides/best-browser-pdf-tools-for-journalists</a> · Tool page: <a href="/pdf/merge">/pdf/merge</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Merge PDF for Journalists — FOI bundles Workflow (2026)</figcaption></figure>
            
            <h2>Merge PDF for Journalists</h2>
            <p>Typical pack: FOI bundles — Reporter merges redacted FOI pages and source exhibit PDFs for editor review.</p>
            <ol>
            <li>Numeric filename prefixes — <code>01_</code>, <code>02_</code></li>
            <li><a href="/pdf/merge">Merge</a> in delivery order</li>
            <li><a href="/pdf/watermark">Watermark</a> DRAFT if pre-approval</li>
        ...
        private const string MergePdfForHrTeams = """
            <h2>Merge PDF for HR Teams — Onboarding packs Workflow (2026)</h2>
            <p>Example: HR merges offer letter, benefits, and policy PDFs before new hire day-one packet.</p>
            ...
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Merge PDF for HR Teams — Onboarding packs Workflow (2026)</figcaption></figure>
            
            <h2>Merge PDF for HR Teams</h2>
            <p>Typical pack: Onboarding packs — HR merges offer letter, benefits, and policy PDFs before new hire day-one packet.</p>
            <ol>
            <li>Numeric filename prefixes — <code>01_</code>, <code>02_</code></li>
            <li><a href="/pdf/merge">Merge</a> in delivery order</li>
            <li><a href="/pdf/watermark">Watermark</a> DRAFT if pre-approval</li>
        ...
        private const string MergePdfForSalesTeams = """
            <h2>Merge PDF for Sales Teams — Proposal packs Workflow (2026)</h2>
            <p>Example: AE merges quote, case study, and security FAQ PDFs before enterprise prospect send.</p>
            <p class="lead">Pillar: <a href="/guides/merge-pdf">merge PDF guide</a> · Related: <a href="/guides/best-browser-pdf-tools-for-consultants">/guides/best-browser-pdf-tools-for-consultants</a> · Tool page: <a href="/pdf/merge">/pdf/merge</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Merge PDF for Sales Teams — Proposal packs Workflow (2026)</figcaption></figure>
            
            <h2>Merge PDF for Sales Teams</h2>
            <p>Typical pack: Proposal packs — AE merges quote, case study, and security FAQ PDFs before enterprise prospect send.</p>
            <ol>
            <li>Numeric filename prefixes — <code>01_</code>, <code>02_</code></li>
            <li><a href="/pdf/merge">Merge</a> in delivery order</li>
            <li><a href="/pdf/watermark">Watermark</a> DRAFT if pre-approval</li>
        ...
        private const string MergePdfForMarketingTeams = """
            <h2>Merge PDF for Marketing Teams — Campaign packs Workflow (2026)</h2>
            <p>Example: PM merges creative brief, media plan, and brand PDFs for stakeholder sign-off.</p>
            <p class="lead">Pillar: <a href="/guides/merge-pdf">merge PDF guide</a> · Related: <a href="/guides/best-browser-pdf-tools-for-marketers">/guides/best-browser-pdf-tools-for-marketers</a> · Tool page: <a href="/pdf/merge">/pdf/merge</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Merge PDF for Marketing Teams — Campaign packs Workflow (2026)</figcaption></figure>
            
            <h2>Merge PDF for Marketing Teams</h2>
            <p>Typical pack: Campaign packs — PM merges creative brief, media plan, and brand PDFs for stakeholder sign-off.</p>
            <ol>
            <li>Numeric filename prefixes — <code>01_</code>, <code>02_</code></li>
            <li><a href="/pdf/merge">Merge</a> in delivery order</li>
            <li><a href="/pdf/watermark">Watermark</a> DRAFT if pre-approval</li>
        ...
        private const string ConvertPdfOnIphone = """
            <h2>Convert PDF on iPhone — Safari Workflow (2026)</h2>
            <p>Example: Sales rep converts one-page spec PDF to Word on iPhone before quick client edit.</p>
            <p class="lead">Pillar: <a href="/guides/pdf-to-word-on-mac">PDF to Word on Mac (reference)</a> · Related: <a href="/guides/convert-pdf-on-android">/guides/convert-pdf-on-android</a> · Tool page: <a href="/pdf/pdftodoc">/pdf/pdftodoc</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Convert PDF on iPhone — Safari Workflow (2026)</figcaption></figure>
            
            <h2>Convert PDF on iPhone</h2>
            <p>Browser: Safari — PDF to Word without app install.</p>
            <ol>
            <li>Scanned PDF? — <a href="/pdf/ocrpdf">OCR</a> first</li>
            <li>Open Safari → <a href="/pdf/pdftodoc">PDF to Word</a></li>
        ...
        private const string ConvertPdfOnIpad = """
            <h2>Convert PDF on iPad — Safari Workflow (2026)</h2>
            <p>Example: Teacher converts scanned worksheet PDF to Word on iPad for classroom edit in Split View.</p>
            <p class="lead">Pillar: <a href="/guides/pdf-to-word-on-mac">PDF to Word on Mac (reference)</a> · Related: <a href="/guides/convert-pdf-on-android">/guides/convert-pdf-on-android</a> · Tool page: <a href="/pdf/pdftodoc">/pdf/pdftodoc</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Convert PDF on iPad — Safari Workflow (2026)</figcaption></figure>
            
            <h2>Convert PDF on iPad</h2>
            <p>Browser: Safari — PDF to Word without app install.</p>
            <ol>
            <li>Scanned PDF? — <a href="/pdf/ocrpdf">OCR</a> first</li>
            <li>Open Safari → <a href="/pdf/pdftodoc">PDF to Word</a></li>
        ...
        private const string ConvertPdfOnChromebook = """
            <h2>Convert PDF on Chromebook — Chrome Workflow (2026)</h2>
            <p>Example: Student converts chapter PDF to DOCX on school Chromebook for essay quotes.</p>
            <p class="lead">Pillar: <a href="/guides/pdf-to-word-on-mac">PDF to Word on Mac (reference)</a> · Related: <a href="/guides/convert-pdf-on-android">/guides/convert-pdf-on-android</a> · Tool page: <a href="/pdf/pdftodoc">/pdf/pdftodoc</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Convert PDF on Chromebook — Chrome Workflow (2026)</figcaption></figure>
            
            <h2>Convert PDF on Chromebook</h2>
            <p>Browser: Chrome — PDF to Word without app install.</p>
            <ol>
            <li>Scanned PDF? — <a href="/pdf/ocrpdf">OCR</a> first</li>
            <li>Open Chrome → <a href="/pdf/pdftodoc">PDF to Word</a></li>
            <li>Upload from Files/Downloads — download DOCX</li>
            <li>Edit in Word, Google Docs, or LibreOffice</li>
            </ol>
            <p>Hub: <a href="/guides/pdf-device-workflows-hub">device workflows</a> · <a href="/guides/pdf-to-word">PDF to Word</a>.</p>
        ...
        private const string ConvertPdfOnLinux = """
            <h2>Convert PDF on Linux — Firefox Workflow (2026)</h2>
            <p>Example: Analyst converts report PDF to Word on Ubuntu workstation without desktop Acrobat.</p>
            <p class="lead">Pillar: <a href="/guides/pdf-to-word-on-mac">PDF to Word on Mac (reference)</a> · Related: <a href="/guides/convert-pdf-on-android">/guides/convert-pdf-on-android</a> · Tool page: <a href="/pdf/pdftodoc">/pdf/pdftodoc</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Convert PDF on Linux — Firefox Workflow (2026)</figcaption></figure>
            
            <h2>Convert PDF on Linux</h2>
            <p>Browser: Firefox — PDF to Word without app install.</p>
            <ol>
            <li>Scanned PDF? — <a href="/pdf/ocrpdf">OCR</a> first</li>
            <li>Open Firefox → <a href="/pdf/pdftodoc">PDF to Word</a></li>
            <li>Upload from Files/Downloads — download DOCX</li>
            <li>Edit in Word, Google Docs, or LibreOffice</li>
            </ol>
            <p>Hub: <a href="/guides/pdf-device-workflows-hub">device workflows</a> · <a href="/guides/pdf-to-word">PDF to Word</a>.</p>
