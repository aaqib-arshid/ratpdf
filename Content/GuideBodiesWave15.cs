namespace ratpdf.Content
{
    ...
    internal static class GuideBodiesWave15
    {
        ...
        {
            "pdf-regional-workflows-hub" => PdfRegionalWorkflowsHub,
            "visa-application-pdf-workflow-usa" => VisaApplicationPdfWorkflowUsa,
            "visa-application-pdf-workflow-uk" => VisaApplicationPdfWorkflowUk,
            "visa-application-pdf-workflow-canada" => VisaApplicationPdfWorkflowCanada,
            "visa-application-pdf-workflow-australia" => VisaApplicationPdfWorkflowAustralia,
            "visa-application-pdf-workflow-india" => VisaApplicationPdfWorkflowIndia,
            "bank-statement-pdf-workflow-usa" => BankStatementPdfWorkflowUsa,
            "bank-statement-pdf-workflow-uk" => BankStatementPdfWorkflowUk,
            "bank-statement-pdf-workflow-india" => BankStatementPdfWorkflowIndia,
            "contract-pdf-workflow-usa" => ContractPdfWorkflowUsa,
            "contract-pdf-workflow-uk" => ContractPdfWorkflowUk,
            "invoice-pdf-workflow-india" => InvoicePdfWorkflowIndia,
            "tax-document-pdf-workflow-india" => TaxDocumentPdfWorkflowIndia,
            "university-application-pdf-workflow-india" => UniversityApplicationPdfWorkflowIndia,
            "india-job-portal-pdf-limits" => IndiaJobPortalPdfLimits,
            "pdf-workflow-government" => PdfWorkflowGovernment,
            "pdf-tools-government-applicants" => PdfToolsGovernmentApplicants,
            _ => null
        };

        private const string PdfRegionalWorkflowsHub = """
            <h2>PDF Regional Workflows Hub — Visa, Bank &amp; Government by Country (2026)</h2>
            <p>RatPDF <a href="/guides/pdf-tools">PDF tools hub</a> — Immigration consultant index linking country visa PDF packs and portal compress guides.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF Regional Workflows Hub — Visa, Bank &amp; Government by Country (2026)</figcaption></figure>
            ...
            <h2>Workflow deep dive — PDF Regional Workflows Hub — Visa, Bank &amp; Government by Country (2026)</h2>
            ...
            <p>Hub: <a href="/guides/pdf-regional-workflows-hub">Regional workflows hub</a> · <a href="/guides/compress-pdf-for-visa-application">Visa compress hub</a>.</p>
            ...
            <p class="mt-4"><a href="/guides/pdf-tools" class="btn btn-primary">PDF tools hub</a> · <a href="/guides/pdf-regional-workflows-hub">Regional hub</a></p>
            """;

        private const string VisaApplicationPdfWorkflowUsa = """
            <h2>Visa Application PDF Workflow USA — USCIS &amp; Embassy Uploads (2026)</h2>
            <p>RatPDF <a href="/pdf/merge">Merge PDF</a> — F-1 applicant merges financial PDFs then compresses before VFS upload slot.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Visa Application PDF Workflow USA — USCIS &amp; Embassy Uploads (2026)</figcaption></figure>
            
            <h2>United States visa PDF pack</h2>
            <p>Typical portal: <strong>USCIS / embassy portal</strong> — cap: varies by form — often 6–12 MB per upload. DS-160 confirmation, I-20, financials — separate uploads unless portal allows bundle.</p>
            <h2>Workflow</h2>
            <ol>
            <li>Gather PDFs — passport bio page, financials, invitation — numeric prefix filenames</li>
            <li>If portal allows <strong>one</strong> file: <a href="/guides/merge-pdf-visa-application">merge visa pack</a> then <a href="/guides/compress-pdf-for-visa-application">compress</a></li>
            ...
            <h2>Workflow deep dive — Visa Application PDF Workflow USA — USCIS &amp; Embassy Uploads (2026)</h2>
            <p>Regional portals punish wrong file size more often than wrong font — compress and merge discipline saves deadline panic.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Visa Application PDF Workflow USA — USCIS &amp; Embassy Uploads (2026)</figcaption></figure>
            <h2>Compliance note</h2>
            <p>Never alter amounts, dates, or MRZ data in compress — if illegible after compress, re-export from source bank or portal.</p>
        ...
        private const string VisaApplicationPdfWorkflowUk = """
            <h2>Visa Application PDF Workflow UK — UKVI Document Pack (2026)</h2>
            <p>RatPDF <a href="/pdf/merge">Merge PDF</a> — Student visa applicant orders CAS, funds, and passport scans for UKVI upload.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Visa Application PDF Workflow UK — UKVI Document Pack (2026)</figcaption></figure>
            
            <h2>United Kingdom visa PDF pack</h2>
            <p>Typical portal: <strong>UKVI / VFS Global</strong> — cap: often 6 MB per document slot. CAS, bank statements, TB test — check UKVI document list for your visa type.</p>
            <h2>Workflow</h2>
            <ol>
            <li>Gather PDFs — passport bio page, financials, invitation — numeric prefix filenames</li>
            <li>If portal allows <strong>one</strong> file: <a href="/guides/merge-pdf-visa-application">merge visa pack</a> then <a href="/guides/compress-pdf-ukvi">compress</a></li>
            <li>If <strong>per-slot</strong> uploads: compress each PDF separately — do not merge</li>
            <li>Verify MRZ, dates, and amounts at 100% zoom after compress</li>
            <li>Upload on stable Wi-Fi — do not refresh mid-transfer</li>
            </ol>
            ...
            <h2>Workflow deep dive — Visa Application PDF Workflow UK — UKVI Document Pack (2026)</h2>
            <p>Regional portals punish wrong file size more often than wrong font — compress and merge discipline saves deadline panic.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Visa Application PDF Workflow UK — UKVI Document Pack (2026)</figcaption></figure>
            <h2>Compliance note</h2>
            <p>Never alter amounts, dates, or MRZ data in compress — if illegible after compress, re-export from source bank or portal.</p>
        ...
        private const string VisaApplicationPdfWorkflowCanada = """
            <h2>Visa Application PDF Workflow Canada — IRCC PDF Checklist (2026)</h2>
            <p>RatPDF <a href="/pdf/merge">Merge PDF</a> — Study permit applicant compresses 4 MB bank PDF to pass IRCC per-file cap.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Visa Application PDF Workflow Canada — IRCC PDF Checklist (2026)</figcaption></figure>
            
            <h2>Canada visa PDF pack</h2>
            <p>Typical portal: <strong>IRCC secure account</strong> — cap: 4 MB per file typical on IRCC upload. LOA, proof of funds, police certificate — IRCC rejects oversize silently sometimes.</p>
            <h2>Workflow</h2>
            <ol>
            <li>Gather PDFs — passport bio page, financials, invitation — numeric prefix filenames</li>
            <li>If portal allows <strong>one</strong> file: <a href="/guides/merge-pdf-visa-application">merge visa pack</a> then <a href="/guides/compress-pdf-immigration-canada">compress</a></li>
            <li>If <strong>per-slot</strong> uploads: compress each PDF separately — do not merge</li>
            <li>Verify MRZ, dates, and amounts at 100% zoom after compress</li>
            <li>Upload on stable Wi-Fi — do not refresh mid-transfer</li>
            </ol>
            ...
            <h2>Workflow deep dive — Visa Application PDF Workflow Canada — IRCC PDF Checklist (2026)</h2>
            <p>Regional portals punish wrong file size more often than wrong font — compress and merge discipline saves deadline panic.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Visa Application PDF Workflow Canada — IRCC PDF Checklist (2026)</figcaption></figure>
            <h2>Compliance note</h2>
            <p>Never alter amounts, dates, or MRZ data in compress — if illegible after compress, re-export from source bank or portal.</p>
        ...
        private const string VisaApplicationPdfWorkflowAustralia = """
            <h2>Visa Application PDF Workflow Australia — ImmiAccount PDF Steps (2026)</h2>
            <p>RatPDF <a href="/pdf/merge">Merge PDF</a> — Subclass 500 applicant uploads GTE and financials under ImmiAccount 5 MB limit.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Visa Application PDF Workflow Australia — ImmiAccount PDF Steps (2026)</figcaption></figure>
            
            <h2>Australia visa PDF pack</h2>
            <p>Typical portal: <strong>ImmiAccount / Department of Home Affairs</strong> — cap: 5 MB per attachment common on ImmiAccount. GTE statement, OSHC, financial evidence — ImmiAccount logs upload errors in message centre.</p>
            <h2>Workflow</h2>
            <ol>
            <li>Gather PDFs — passport bio page, financials, invitation — numeric prefix filenames</li>
            <li>If portal allows <strong>one</strong> file: <a href="/guides/merge-pdf-visa-application">merge visa pack</a> then <a href="/guides/compress-pdf-home-affairs-australia">compress</a></li>
            <li>If <strong>per-slot</strong> uploads: compress each PDF separately — do not merge</li>
            <li>Verify MRZ, dates, and amounts at 100% zoom after compress</li>
            <li>Upload on stable Wi-Fi — do not refresh mid-transfer</li>
            </ol>
            ...
            <h2>Workflow deep dive — Visa Application PDF Workflow Australia — ImmiAccount PDF Steps (2026)</h2>
            <p>Regional portals punish wrong file size more often than wrong font — compress and merge discipline saves deadline panic.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Visa Application PDF Workflow Australia — ImmiAccount PDF Steps (2026)</figcaption></figure>
            <h2>Compliance note</h2>
            <p>Never alter amounts, dates, or MRZ data in compress — if illegible after compress, re-export from source bank or portal.</p>
        ...
        private const string VisaApplicationPdfWorkflowIndia = """
            <h2>Visa Application PDF Workflow India — Outbound &amp; Portal PDF Prep (2026)</h2>
            <p>RatPDF <a href="/pdf/compress">Compress PDF</a> — Tourist visa applicant compresses 3 MB salary slips for Schengen VFS slot.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Visa Application PDF Workflow India — Outbound &amp; Portal PDF Prep (2026)</figcaption></figure>
            
            <h2>India visa PDF pack</h2>
            <p>Typical portal: <strong>embassy / VFS / national portals</strong> — cap: 500 KB–5 MB per slot on many e-governance portals. Passport, IT returns, bank statements — DigiLocker exports may need compress.</p>
            <h2>Workflow</h2>
            <ol>
            <li>Gather PDFs — passport bio page, financials, invitation — numeric prefix filenames</li>
            <li>If portal allows <strong>one</strong> file: <a href="/guides/merge-pdf-visa-application">merge visa pack</a> then <a href="/guides/compress-pdf-for-visa-application">compress</a></li>
            ...
            <h2>Workflow deep dive — Visa Application PDF Workflow India — Outbound &amp; Portal PDF Prep (2026)</h2>
            <p>Regional portals punish wrong file size more often than wrong font — compress and merge discipline saves deadline panic.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Visa Application PDF Workflow India — Outbound &amp; Portal PDF Prep (2026)</figcaption></figure>
            <h2>Compliance note</h2>
            <p>Never alter amounts, dates, or MRZ data in compress — if illegible after compress, re-export from source bank or portal.</p>
        ...
        private const string BankStatementPdfWorkflowUsa = """
            <h2>Bank Statement PDF Workflow USA — Mortgage &amp; Visa Evidence (2026)</h2>
            <p>RatPDF <a href="/pdf/compress">Compress PDF</a> — Mortgage broker compresses 6-month Chase PDF export for lender portal.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Bank Statement PDF Workflow USA — Mortgage &amp; Visa Evidence (2026)</figcaption></figure>
            
            <h2>Bank statement PDF in United States</h2>
            ...
            <li><a href="/pdf/compress">Compress PDF</a> with Recommended if over portal cap (varies by form — often 6–12 MB per upload)</li>
            ...
            <p>Visa tie-in: <a href="/guides/visa-application-pdf-workflow-usa">visa workflow usa</a>.</p>
            ...
            <h2>Workflow deep dive — Bank Statement PDF Workflow USA — Mortgage &amp; Visa Evidence (2026)</h2>
            <p>Regional portals punish wrong file size more often than wrong font — compress and merge discipline saves deadline panic.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Bank Statement PDF Workflow USA — Mortgage &amp; Visa Evidence (2026)</figcaption></figure>
            <h2>Compliance note</h2>
            <p>Never alter amounts, dates, or MRZ data in compress — if illegible after compress, re-export from source bank or portal.</p>
        ...
        private const string BankStatementPdfWorkflowUk = """
            <h2>Bank Statement PDF Workflow UK — Visa &amp; Rental Applications (2026)</h2>
            <p>RatPDF <a href="/pdf/compress">Compress PDF</a> — Tenant compresses Barclays PDF statements for letting agent upload.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Bank Statement PDF Workflow UK — Visa &amp; Rental Applications (2026)</figcaption></figure>
            
            <h2>Bank statement PDF in United Kingdom</h2>
            <p>Lenders, landlords, and visa officers expect <strong>official PDF exports</strong> from netbanking — not phone photos unless specified.</p>
            <h2>Workflow</h2>
            <ol>
            <li>Download 3–6 month statement PDF from bank portal</li>
            <li>Check account holder name and closing balance visible at 100% zoom</li>
            <li><a href="/pdf/compress">Compress PDF</a> with Recommended if over portal cap (often 6 MB per document slot)</li>
            <li>Use Less if fine transaction lines soften — re-export from bank if possible</li>
            <li>Password-protect if emailing — share password separately</li>
            </ol>
            <p>Visa tie-in: <a href="/guides/visa-application-pdf-workflow-uk">visa workflow uk</a>.</p>
            ...
            <h2>Workflow deep dive — Bank Statement PDF Workflow UK — Visa &amp; Rental Applications (2026)</h2>
            <p>Regional portals punish wrong file size more often than wrong font — compress and merge discipline saves deadline panic.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Bank Statement PDF Workflow UK — Visa &amp; Rental Applications (2026)</figcaption></figure>
            <h2>Compliance note</h2>
            <p>Never alter amounts, dates, or MRZ data in compress — if illegible after compress, re-export from source bank or portal.</p>
        ...
        private const string BankStatementPdfWorkflowIndia = """
            <h2>Bank Statement PDF Workflow India — Loan &amp; Visa KYC (2026)</h2>
            <p>RatPDF <a href="/pdf/compress">Compress PDF</a> — Home loan applicant compresses netbanking PDF under 2 MB portal cap.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Bank Statement PDF Workflow India — Loan &amp; Visa KYC (2026)</figcaption></figure>
            
            <h2>Bank statement PDF in India</h2>
            <p>Lenders, landlords, and visa officers expect <strong>official PDF exports</strong> from netbanking — not phone photos unless specified.</p>
            <h2>Workflow</h2>
            <ol>
            <li>Download 3–6 month statement PDF from bank portal</li>
            <li>Check account holder name and closing balance visible at 100% zoom</li>
            <li><a href="/pdf/compress">Compress PDF</a> with Recommended if over portal cap (500 KB–5 MB per slot on many e-governance portals)</li>
            <li>Use Less if fine transaction lines soften — re-export from bank if possible</li>
            <li>Password-protect if emailing — share password separately</li>
            </ol>
            <p>Visa tie-in: <a href="/guides/visa-application-pdf-workflow-india">visa workflow india</a>.</p>
            ...
            <h2>Workflow deep dive — Bank Statement PDF Workflow India — Loan &amp; Visa KYC (2026)</h2>
            <p>Regional portals punish wrong file size more often than wrong font — compress and merge discipline saves deadline panic.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Bank Statement PDF Workflow India — Loan &amp; Visa KYC (2026)</figcaption></figure>
            <h2>Compliance note</h2>
            <p>Never alter amounts, dates, or MRZ data in compress — if illegible after compress, re-export from source bank or portal.</p>
        ...
        private const string ContractPdfWorkflowUsa = """
            <h2>Contract PDF Workflow USA — Sign, Merge &amp; Email Packs (2026)</h2>
            <p>RatPDF <a href="/pdf/merge">Merge PDF</a> — SMB merges MSA, SOW, and NDA PDFs for client DocuSign replacement email pack.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Contract PDF Workflow USA — Sign, Merge &amp; Email Packs (2026)</figcaption></figure>
            
            <h2>Contract PDF handling in United States</h2>
            ...
            <h2>Workflow deep dive — Contract PDF Workflow USA — Sign, Merge &amp; Email Packs (2026)</h2>
            <p>Regional portals punish wrong file size more often than wrong font — compress and merge discipline saves deadline panic.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Contract PDF Workflow USA — Sign, Merge &amp; Email Packs (2026)</figcaption></figure>
            <h2>Compliance note</h2>
            <p>Never alter amounts, dates, or MRZ data in compress — if illegible after compress, re-export from source bank or portal.</p>
        ...
        private const string ContractPdfWorkflowUk = """
            <h2>Contract PDF Workflow UK — SME Contract PDF Handling (2026)</h2>
            <p>RatPDF <a href="/pdf/merge">Merge PDF</a> — Agency merges engagement letter and schedule of rates before client send.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Contract PDF Workflow UK — SME Contract PDF Handling (2026)</figcaption></figure>
            
            <h2>Contract PDF handling in United Kingdom</h2>
            <p>MSA + SOW + exhibits — merge in signature order — watermark DRAFT until execution — flatten after sign.</p>
            <h2>Workflow</h2>
            <ol>
            <li>Export each contract part as PDF from Word or e-sign platform</li>
            ...
            <h2>Workflow deep dive — Contract PDF Workflow UK — SME Contract PDF Handling (2026)</h2>
            <p>Regional portals punish wrong file size more often than wrong font — compress and merge discipline saves deadline panic.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Contract PDF Workflow UK — SME Contract PDF Handling (2026)</figcaption></figure>
            <h2>Compliance note</h2>
            <p>Never alter amounts, dates, or MRZ data in compress — if illegible after compress, re-export from source bank or portal.</p>
        ...
        private const string InvoicePdfWorkflowIndia = """
            <h2>Invoice PDF Workflow India — GST, E-Invoice &amp; Client Email (2026)</h2>
            <p>RatPDF <a href="/pdf/compress">Compress PDF</a> — CA firm compresses monthly GST invoice PDF batch for client ZIP email.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Invoice PDF Workflow India — GST, E-Invoice &amp; Client Email (2026)</figcaption></figure>
            ...
            <h2>Workflow deep dive — Invoice PDF Workflow India — GST, E-Invoice &amp; Client Email (2026)</h2>
            <p>Regional portals punish wrong file size more often than wrong font — compress and merge discipline saves deadline panic.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Invoice PDF Workflow India — GST, E-Invoice &amp; Client Email (2026)</figcaption></figure>
            <h2>Compliance note</h2>
            <p>Never alter amounts, dates, or MRZ data in compress — if illegible after compress, re-export from source bank or portal.</p>
        ...
        private const string TaxDocumentPdfWorkflowIndia = """
            <h2>Tax Document PDF Workflow India — ITR, Form 16 &amp; Portal Upload (2026)</h2>
            <p>RatPDF <a href="/pdf/compress">Compress PDF</a> — Salaried employee compresses Form 16 scan for home loan KYC portal.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Tax Document PDF Workflow India — ITR, Form 16 &amp; Portal Upload (2026)</figcaption></figure>
            ...
            <h2>Workflow deep dive — Tax Document PDF Workflow India — ITR, Form 16 &amp; Portal Upload (2026)</h2>
            <p>Regional portals punish wrong file size more often than wrong font — compress and merge discipline saves deadline panic.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Tax Document PDF Workflow India — ITR, Form 16 &amp; Portal Upload (2026)</figcaption></figure>
            <h2>Compliance note</h2>
            <p>Never alter amounts, dates, or MRZ data in compress — if illegible after compress, re-export from source bank or portal.</p>
        ...
        private const string UniversityApplicationPdfWorkflowIndia = """
            <h2>University Application PDF Workflow India — UG &amp; PG Admissions (2026)</h2>
            <p>RatPDF <a href="/pdf/merge">Merge PDF</a> — Student merges marksheets and certificates for common admission portal upload.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> University Application PDF Workflow India — UG &amp; PG Admissions (2026)</figcaption></figure>
            ...
            <h2>Workflow deep dive — University Application PDF Workflow India — UG &amp; PG Admissions (2026)</h2>
            <p>Regional portals punish wrong file size more often than wrong font — compress and merge discipline saves deadline panic.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> University Application PDF Workflow India — UG &amp; PG Admissions (2026)</figcaption></figure>
            <h2>Compliance note</h2>
            <p>Never alter amounts, dates, or MRZ data in compress — if illegible after compress, re-export from source bank or portal.</p>
        ...
        private const string IndiaJobPortalPdfLimits = """
            <h2>India Job Portal PDF Limits — Naukri, Indeed &amp; Government Jobs (2026)</h2>
            <p>RatPDF <a href="/pdf/compress">Compress PDF</a> — Applicant compresses resume+certificates PDF for SSC portal 2 MB cap.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> India Job Portal PDF Limits — Naukri, Indeed &amp; Government Jobs (2026)</figcaption></figure>
            ...
            <h2>Workflow deep dive — India Job Portal PDF Limits — Naukri, Indeed &amp; Government Jobs (2026)</h2>
            <p>Regional portals punish wrong file size more often than wrong font — compress and merge discipline saves deadline panic.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> India Job Portal PDF Limits — Naukri, Indeed &amp; Government Jobs (2026)</figcaption></figure>
            <h2>Compliance note</h2>
            <p>Never alter amounts, dates, or MRZ data in compress — if illegible after compress, re-export from source bank or portal.</p>
        ...
        private const string PdfWorkflowGovernment = """
            <h2>PDF Workflow for Government — Applicants &amp; Filers (2026)</h2>
            <p>RatPDF <a href="/guides/pdf-tools">PDF tools hub</a> — Citizen services desk SOP for compress, merge, and flatten before portal upload.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF Workflow for Government — Applicants &amp; Filers (2026)</figcaption></figure>
            ...
            <h2>Workflow deep dive — PDF Workflow for Government — Applicants &amp; Filers (2026)</h2>
            <p>Regional portals punish wrong file size more often than wrong font — compress and merge discipline saves deadline panic.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF Workflow for Government — Applicants &amp; Filers (2026)</figcaption></figure>
            <h2>Compliance note</h2>
            <p>Never alter amounts, dates, or MRZ data in compress — if illegible after compress, re-export from source bank or portal.</p>
        ...
        private const string PdfToolsGovernmentApplicants = """
            <h2>PDF Tools for Government Applicants — Free Browser Checklist (2026)</h2>
            <p>RatPDF <a href="/guides/pdf-tools">PDF tools hub</a> — Library poster linking RatPDF compress and merge for passport and tax filers.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF Tools for Government Applicants — Free Browser Checklist (2026)</figcaption></figure>
            ...
            <h2>Workflow deep dive — PDF Tools for Government Applicants — Free Browser Checklist (2026)</h2>
            <p>Regional portals punish wrong file size more often than wrong font — compress and merge discipline saves deadline panic.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF Tools for Government Applicants — Free Browser Checklist (2026)</figcaption></figure>
            <h2>Compliance note</h2>
            <p>Never alter amounts, dates, or MRZ data in compress — if illegible after compress, re-export from source bank or portal.</p>
