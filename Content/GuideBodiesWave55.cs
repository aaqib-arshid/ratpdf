namespace ratpdf.Content
{
    ...
    internal static class GuideBodiesWave55
    {
        ...
        {
            "fix-pdf-bookmarks-missing" => FixPdfBookmarksMissing,
            "pdf-cloud-archive-vs-on-prem" => PdfCloudArchiveVsOnPrem,
            "cad-to-pdf" => CadToPdf,
            "ocr-pdf-for-lawyers" => OcrPdfForLawyers,
            "ocr-pdf-for-accountants" => OcrPdfForAccountants,
            "ocr-pdf-for-healthcare" => OcrPdfForHealthcare,
            "ocr-pdf-for-real-estate" => OcrPdfForRealEstate,
            "ocr-pdf-for-insurance" => OcrPdfForInsurance,
            "ocr-pdf-for-education" => OcrPdfForEducation,
            "ocr-pdf-for-nonprofits" => OcrPdfForNonprofits,
            "ocr-pdf-for-government" => OcrPdfForGovernment,
            "ocr-pdf-for-freelancers" => OcrPdfForFreelancers,
            "ocr-pdf-for-consultants" => OcrPdfForConsultants,
            "ocr-pdf-for-architects" => OcrPdfForArchitects,
            "ocr-pdf-for-engineers" => OcrPdfForEngineers,
            "ocr-pdf-for-researchers" => OcrPdfForResearchers,
            "ocr-pdf-for-journalists" => OcrPdfForJournalists,
            _ => null
        };

        private const string FixPdfBookmarksMissing = """
            <h2>Fix PDF Bookmarks Missing — Add Navigation Outline (2026)</h2>
            <p>Example: Analyst receives 200-page report PDF with no outline — adds chapter bookmarks before board distribution.</p>
            <p class="lead">Pillar: <a href="/guides/pdf-bookmarks-guide">PDF bookmarks guide</a> · Related: <a href="/guides/pdf-table-of-contents">/guides/pdf-table-of-contents</a> · Tool page: <a href="/pdf/editpdf">/pdf/editpdf</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Fix PDF Bookmarks Missing — Add Navigation Outline (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/editpdf" class="btn btn-primary">Edit PDF</a> · <a href="/guides/pdf-bookmarks-guide">Full guide</a></p>
            """;

        private const string PdfCloudArchiveVsOnPrem = """
            <h2>PDF Cloud Archive vs On-Prem — Retention &amp; Cost (2026)</h2>
            <p>Example: Records manager compares S3 Glacier vs on-prem WORM NAS for 10-year contract PDF archive.</p>
            <p class="lead">Pillar: <a href="/guides/pdf-records-management-policy">records management policy</a> · Related: <a href="/guides/pdf-worm-storage-compliance">/guides/pdf-worm-storage-compliance</a> · Tool page: <a href="/guides/pdf-records-management-policy">/guides/pdf-records-management-policy</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF Cloud Archive vs On-Prem — Retention &amp; Cost (2026)</figcaption></figure>
        ...
        private const string CadToPdf = """
            <h2>CAD to PDF — Export Drawings for Submittal (2026)</h2>
            <p>Example: Architect exports DWG sheet set to PDF via CAD plotter then merges submittal volumes in browser.</p>
            <p class="lead">Pillar: <a href="/guides/pdf-tools">PDF tools hub</a> · Related: <a href="/guides/merge-pdf-for-architects">/guides/merge-pdf-for-architects</a> · Tool page: <a href="/pdf/doctopdf">/pdf/doctopdf</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> CAD to PDF — Export Drawings for Submittal (2026)</figcaption></figure>
            ...
            <p>Tool: <a href="/pdf/doctopdf">/pdf/doctopdf</a></p>
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Start workflow</strong> <a href="/pdf/doctopdf" class="alert-link fw-semibold">Convert to PDF →</a></div>
            ...
            <p class="mt-4"><a href="/pdf/doctopdf" class="btn btn-primary">Convert to PDF</a> · <a href="/guides/pdf-tools">Full guide</a></p>
            """;

        private const string OcrPdfForLawyers = """
            <h2>OCR PDF for Lawyers — Searchable Scans (2026)</h2>
            <p>Example: Paralegal OCRs 400-page scanned deposition PDF so counsel can search witness names in e-discovery.</p>
            <p class="lead">Pillar: <a href="/guides/ocr-pdf">OCR PDF guide</a> · Related: <a href="/guides/compress-pdf-for-lawyers">/guides/compress-pdf-for-lawyers</a> · Tool page: <a href="/pdf/ocrpdf">/pdf/ocrpdf</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> OCR PDF for Lawyers — Searchable Scans (2026)</figcaption></figure>
            
            <h2>OCR PDF for Lawyers</h2>
            <p>Use case: Discovery — Paralegal OCRs 400-page scanned deposition PDF so counsel can search witness names in e-discovery.</p>
            <ol>
            ...
            <p>Pair with <a href="/guides/compress-pdf-for-lawyers">compress workflow</a> · <a href="/guides/merge-pdf-for-lawyers">merge workflow</a> · <a href="/guides/make-scanned-pdf-searchable">Searchable scan hub</a>.</p>
        ...
        private const string OcrPdfForAccountants = """
            <h2>OCR PDF for Accountants — Searchable Scans (2026)</h2>
            <p>Example: Staff OCRs scanned vendor invoice PDF so audit team can search line items without re-keying.</p>
            <p class="lead">Pillar: <a href="/guides/ocr-pdf">OCR PDF guide</a> · Related: <a href="/guides/compress-pdf-for-accountants">/guides/compress-pdf-for-accountants</a> · Tool page: <a href="/pdf/ocrpdf">/pdf/ocrpdf</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> OCR PDF for Accountants — Searchable Scans (2026)</figcaption></figure>
            
            <h2>OCR PDF for Accountants</h2>
            <p>Use case: Audit evidence — Staff OCRs scanned vendor invoice PDF so audit team can search line items without re-keying.</p>
            <ol>
            <li>Confirm scan is image-only — text does not select</li>
            <li><a href="/pdf/ocrpdf">OCR PDF</a> — choose language matching source</li>
            <li>Spot-check 3 random pages — numbers and names accurate</li>
            ...
            <p>Pair with <a href="/guides/compress-pdf-for-accountants">compress workflow</a> · <a href="/guides/merge-pdf-for-accountants">merge workflow</a> · <a href="/guides/make-scanned-pdf-searchable">Searchable scan hub</a>.</p>
            <p>Tool: <a href="/pdf/ocrpdf">/pdf/ocrpdf</a></p>
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Start workflow</strong> <a href="/pdf/ocrpdf" class="alert-link fw-semibold">OCR PDF →</a></div>
        ...
        private const string OcrPdfForHealthcare = """
            <h2>OCR PDF for Healthcare — Searchable Scans (2026)</h2>
            <p>Example: Admin OCRs legacy chart scan PDF before redacting PHI for patient disclosure request.</p>
            <p class="lead">Pillar: <a href="/guides/ocr-pdf">OCR PDF guide</a> · Related: <a href="/guides/compress-pdf-for-healthcare">/guides/compress-pdf-for-healthcare</a> · Tool page: <a href="/pdf/ocrpdf">/pdf/ocrpdf</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> OCR PDF for Healthcare — Searchable Scans (2026)</figcaption></figure>
            
            <h2>OCR PDF for Healthcare</h2>
            <p>Use case: Records release — Admin OCRs legacy chart scan PDF before redacting PHI for patient disclosure request.</p>
            <ol>
            <li>Confirm scan is image-only — text does not select</li>
            <li><a href="/pdf/ocrpdf">OCR PDF</a> — choose language matching source</li>
            <li>Spot-check 3 random pages — numbers and names accurate</li>
            ...
            <p>Pair with <a href="/guides/compress-pdf-for-healthcare">compress workflow</a> · <a href="/guides/merge-pdf-for-healthcare">merge workflow</a> · <a href="/guides/make-scanned-pdf-searchable">Searchable scan hub</a>.</p>
            <p>Tool: <a href="/pdf/ocrpdf">/pdf/ocrpdf</a></p>
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Start workflow</strong> <a href="/pdf/ocrpdf" class="alert-link fw-semibold">OCR PDF →</a></div>
        ...
        private const string OcrPdfForRealEstate = """
            <h2>OCR PDF for Real Estate — Searchable Scans (2026)</h2>
            <p>Example: Agent OCRs scanned HOA disclosure PDF so buyer can search special assessment keywords.</p>
            <p class="lead">Pillar: <a href="/guides/ocr-pdf">OCR PDF guide</a> · Related: <a href="/guides/compress-pdf-for-real-estate">/guides/compress-pdf-for-real-estate</a> · Tool page: <a href="/pdf/ocrpdf">/pdf/ocrpdf</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> OCR PDF for Real Estate — Searchable Scans (2026)</figcaption></figure>
            
            <h2>OCR PDF for Real Estate</h2>
            <p>Use case: Disclosure search — Agent OCRs scanned HOA disclosure PDF so buyer can search special assessment keywords.</p>
            <ol>
            <li>Confirm scan is image-only — text does not select</li>
            <li><a href="/pdf/ocrpdf">OCR PDF</a> — choose language matching source</li>
            <li>Spot-check 3 random pages — numbers and names accurate</li>
            ...
            <p>Pair with <a href="/guides/compress-pdf-for-real-estate">compress workflow</a> · <a href="/guides/merge-pdf-for-real-estate">merge workflow</a> · <a href="/guides/make-scanned-pdf-searchable">Searchable scan hub</a>.</p>
            <p>Tool: <a href="/pdf/ocrpdf">/pdf/ocrpdf</a></p>
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Start workflow</strong> <a href="/pdf/ocrpdf" class="alert-link fw-semibold">OCR PDF →</a></div>
        ...
        private const string OcrPdfForInsurance = """
            <h2>OCR PDF for Insurance — Searchable Scans (2026)</h2>
            <p>Example: Adjuster OCRs photo-heavy claims scan PDF so SIU can search policy number references.</p>
            <p class="lead">Pillar: <a href="/guides/ocr-pdf">OCR PDF guide</a> · Related: <a href="/guides/compress-pdf-for-insurance">/guides/compress-pdf-for-insurance</a> · Tool page: <a href="/pdf/ocrpdf">/pdf/ocrpdf</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> OCR PDF for Insurance — Searchable Scans (2026)</figcaption></figure>
            
            <h2>OCR PDF for Insurance</h2>
            <p>Use case: Claims file — Adjuster OCRs photo-heavy claims scan PDF so SIU can search policy number references.</p>
            <ol>
            <li>Confirm scan is image-only — text does not select</li>
            <li><a href="/pdf/ocrpdf">OCR PDF</a> — choose language matching source</li>
            <li>Spot-check 3 random pages — numbers and names accurate</li>
            ...
            <p>Pair with <a href="/guides/compress-pdf-for-insurance">compress workflow</a> · <a href="/guides/merge-pdf-for-insurance">merge workflow</a> · <a href="/guides/make-scanned-pdf-searchable">Searchable scan hub</a>.</p>
            <p>Tool: <a href="/pdf/ocrpdf">/pdf/ocrpdf</a></p>
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Start workflow</strong> <a href="/pdf/ocrpdf" class="alert-link fw-semibold">OCR PDF →</a></div>
        ...
        private const string OcrPdfForEducation = """
            <h2>OCR PDF for Education — Searchable Scans (2026)</h2>
            <p>Example: Instructor OCRs scanned textbook chapter PDF so students can search terms in LMS viewer.</p>
            <p class="lead">Pillar: <a href="/guides/ocr-pdf">OCR PDF guide</a> · Related: <a href="/guides/compress-pdf-for-education">/guides/compress-pdf-for-education</a> · Tool page: <a href="/pdf/ocrpdf">/pdf/ocrpdf</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> OCR PDF for Education — Searchable Scans (2026)</figcaption></figure>
            
            <h2>OCR PDF for Education</h2>
            <p>Use case: Course readings — Instructor OCRs scanned textbook chapter PDF so students can search terms in LMS viewer.</p>
            <ol>
            <li>Confirm scan is image-only — text does not select</li>
            <li><a href="/pdf/ocrpdf">OCR PDF</a> — choose language matching source</li>
            <li>Spot-check 3 random pages — numbers and names accurate</li>
            ...
            <p>Pair with <a href="/guides/compress-pdf-for-education">compress workflow</a> · <a href="/guides/merge-pdf-for-education">merge workflow</a> · <a href="/guides/make-scanned-pdf-searchable">Searchable scan hub</a>.</p>
            <p>Tool: <a href="/pdf/ocrpdf">/pdf/ocrpdf</a></p>
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Start workflow</strong> <a href="/pdf/ocrpdf" class="alert-link fw-semibold">OCR PDF →</a></div>
        ...
        private const string OcrPdfForNonprofits = """
            <h2>OCR PDF for Nonprofits — Searchable Scans (2026)</h2>
            <p>Example: Grant writer OCRs legacy award letter scan PDF for foundation reporting search.</p>
            <p class="lead">Pillar: <a href="/guides/ocr-pdf">OCR PDF guide</a> · Related: <a href="/guides/compress-pdf-for-nonprofits">/guides/compress-pdf-for-nonprofits</a> · Tool page: <a href="/pdf/ocrpdf">/pdf/ocrpdf</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> OCR PDF for Nonprofits — Searchable Scans (2026)</figcaption></figure>
            
            <h2>OCR PDF for Nonprofits</h2>
            <p>Use case: Grant archive — Grant writer OCRs legacy award letter scan PDF for foundation reporting search.</p>
            <ol>
            <li>Confirm scan is image-only — text does not select</li>
            <li><a href="/pdf/ocrpdf">OCR PDF</a> — choose language matching source</li>
            <li>Spot-check 3 random pages — numbers and names accurate</li>
            ...
            <p>Pair with <a href="/guides/compress-pdf-for-nonprofits">compress workflow</a> · <a href="/guides/merge-pdf-for-nonprofits">merge workflow</a> · <a href="/guides/make-scanned-pdf-searchable">Searchable scan hub</a>.</p>
            <p>Tool: <a href="/pdf/ocrpdf">/pdf/ocrpdf</a></p>
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Start workflow</strong> <a href="/pdf/ocrpdf" class="alert-link fw-semibold">OCR PDF →</a></div>
        ...
        private const string OcrPdfForGovernment = """
            <h2>OCR PDF for Government — Searchable Scans (2026)</h2>
            <p>Example: Clerk OCRs scanned FOIA release PDF so requester can search within 500-page bundle.</p>
            <p class="lead">Pillar: <a href="/guides/ocr-pdf">OCR PDF guide</a> · Related: <a href="/guides/compress-pdf-for-government">/guides/compress-pdf-for-government</a> · Tool page: <a href="/pdf/ocrpdf">/pdf/ocrpdf</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> OCR PDF for Government — Searchable Scans (2026)</figcaption></figure>
            
            <h2>OCR PDF for Government</h2>
            <p>Use case: FOIA response — Clerk OCRs scanned FOIA release PDF so requester can search within 500-page bundle.</p>
            <ol>
            <li>Confirm scan is image-only — text does not select</li>
            <li><a href="/pdf/ocrpdf">OCR PDF</a> — choose language matching source</li>
            <li>Spot-check 3 random pages — numbers and names accurate</li>
            ...
            <p>Pair with <a href="/guides/compress-pdf-for-government">compress workflow</a> · <a href="/guides/merge-pdf-for-government">merge workflow</a> · <a href="/guides/make-scanned-pdf-searchable">Searchable scan hub</a>.</p>
            <p>Tool: <a href="/pdf/ocrpdf">/pdf/ocrpdf</a></p>
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Start workflow</strong> <a href="/pdf/ocrpdf" class="alert-link fw-semibold">OCR PDF →</a></div>
        ...
        private const string OcrPdfForFreelancers = """
            <h2>OCR PDF for Freelancers — Searchable Scans (2026)</h2>
            <p>Example: Freelancer OCRs signed SOW scan PDF so future scope disputes are searchable.</p>
            <p class="lead">Pillar: <a href="/guides/ocr-pdf">OCR PDF guide</a> · Related: <a href="/guides/compress-pdf-for-freelancers">/guides/compress-pdf-for-freelancers</a> · Tool page: <a href="/pdf/ocrpdf">/pdf/ocrpdf</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> OCR PDF for Freelancers — Searchable Scans (2026)</figcaption></figure>
            
            <h2>OCR PDF for Freelancers</h2>
            <p>Use case: Client contract — Freelancer OCRs signed SOW scan PDF so future scope disputes are searchable.</p>
            <ol>
            <li>Confirm scan is image-only — text does not select</li>
            <li><a href="/pdf/ocrpdf">OCR PDF</a> — choose language matching source</li>
            <li>Spot-check 3 random pages — numbers and names accurate</li>
            ...
            <p>Pair with <a href="/guides/compress-pdf-for-freelancers">compress workflow</a> · <a href="/guides/merge-pdf-for-freelancers">merge workflow</a> · <a href="/guides/make-scanned-pdf-searchable">Searchable scan hub</a>.</p>
            <p>Tool: <a href="/pdf/ocrpdf">/pdf/ocrpdf</a></p>
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Start workflow</strong> <a href="/pdf/ocrpdf" class="alert-link fw-semibold">OCR PDF →</a></div>
        ...
        private const string OcrPdfForConsultants = """
            <h2>OCR PDF for Consultants — Searchable Scans (2026)</h2>
            <p>Example: Consultant OCRs client workshop notes scan PDF before merging into final report pack.</p>
            <p class="lead">Pillar: <a href="/guides/ocr-pdf">OCR PDF guide</a> · Related: <a href="/guides/compress-pdf-for-consultants">/guides/compress-pdf-for-consultants</a> · Tool page: <a href="/pdf/ocrpdf">/pdf/ocrpdf</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> OCR PDF for Consultants — Searchable Scans (2026)</figcaption></figure>
            
            <h2>OCR PDF for Consultants</h2>
            <p>Use case: Deliverable archive — Consultant OCRs client workshop notes scan PDF before merging into final report pack.</p>
            <ol>
            <li>Confirm scan is image-only — text does not select</li>
            <li><a href="/pdf/ocrpdf">OCR PDF</a> — choose language matching source</li>
            <li>Spot-check 3 random pages — numbers and names accurate</li>
            ...
            <p>Pair with <a href="/guides/compress-pdf-for-consultants">compress workflow</a> · <a href="/guides/merge-pdf-for-consultants">merge workflow</a> · <a href="/guides/make-scanned-pdf-searchable">Searchable scan hub</a>.</p>
            <p>Tool: <a href="/pdf/ocrpdf">/pdf/ocrpdf</a></p>
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Start workflow</strong> <a href="/pdf/ocrpdf" class="alert-link fw-semibold">OCR PDF →</a></div>
        ...
        private const string OcrPdfForArchitects = """
            <h2>OCR PDF for Architects — Searchable Scans (2026)</h2>
            <p>Example: Architect OCRs scanned spec PDF so GC can search material callouts on tablet.</p>
            <p class="lead">Pillar: <a href="/guides/ocr-pdf">OCR PDF guide</a> · Related: <a href="/guides/compress-pdf-for-architects">/guides/compress-pdf-for-architects</a> · Tool page: <a href="/pdf/ocrpdf">/pdf/ocrpdf</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> OCR PDF for Architects — Searchable Scans (2026)</figcaption></figure>
            
            <h2>OCR PDF for Architects</h2>
            <p>Use case: Submittal search — Architect OCRs scanned spec PDF so GC can search material callouts on tablet.</p>
            <ol>
            <li>Confirm scan is image-only — text does not select</li>
            <li><a href="/pdf/ocrpdf">OCR PDF</a> — choose language matching source</li>
            <li>Spot-check 3 random pages — numbers and names accurate</li>
            ...
            <p>Pair with <a href="/guides/compress-pdf-for-architects">compress workflow</a> · <a href="/guides/merge-pdf-for-architects">merge workflow</a> · <a href="/guides/make-scanned-pdf-searchable">Searchable scan hub</a>.</p>
            <p>Tool: <a href="/pdf/ocrpdf">/pdf/ocrpdf</a></p>
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Start workflow</strong> <a href="/pdf/ocrpdf" class="alert-link fw-semibold">OCR PDF →</a></div>
        ...
        private const string OcrPdfForEngineers = """
            <h2>OCR PDF for Engineers — Searchable Scans (2026)</h2>
            <p>Example: Engineer OCRs stamped calc scan PDF so reviewer can search load values.</p>
            <p class="lead">Pillar: <a href="/guides/ocr-pdf">OCR PDF guide</a> · Related: <a href="/guides/compress-pdf-for-engineers">/guides/compress-pdf-for-engineers</a> · Tool page: <a href="/pdf/ocrpdf">/pdf/ocrpdf</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> OCR PDF for Engineers — Searchable Scans (2026)</figcaption></figure>
            
            <h2>OCR PDF for Engineers</h2>
            <p>Use case: Calculation report — Engineer OCRs stamped calc scan PDF so reviewer can search load values.</p>
            <ol>
            <li>Confirm scan is image-only — text does not select</li>
            <li><a href="/pdf/ocrpdf">OCR PDF</a> — choose language matching source</li>
            <li>Spot-check 3 random pages — numbers and names accurate</li>
            ...
            <p>Pair with <a href="/guides/compress-pdf-for-engineers">compress workflow</a> · <a href="/guides/merge-pdf-for-engineers">merge workflow</a> · <a href="/guides/make-scanned-pdf-searchable">Searchable scan hub</a>.</p>
            <p>Tool: <a href="/pdf/ocrpdf">/pdf/ocrpdf</a></p>
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Start workflow</strong> <a href="/pdf/ocrpdf" class="alert-link fw-semibold">OCR PDF →</a></div>
        ...
        private const string OcrPdfForResearchers = """
            <h2>OCR PDF for Researchers — Searchable Scans (2026)</h2>
            <p>Example: PI OCRs 1990s journal scan PDF so supplementary data tables become searchable.</p>
            <p class="lead">Pillar: <a href="/guides/ocr-pdf">OCR PDF guide</a> · Related: <a href="/guides/compress-pdf-for-researchers">/guides/compress-pdf-for-researchers</a> · Tool page: <a href="/pdf/ocrpdf">/pdf/ocrpdf</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> OCR PDF for Researchers — Searchable Scans (2026)</figcaption></figure>
            
            <h2>OCR PDF for Researchers</h2>
            <p>Use case: Legacy supplement — PI OCRs 1990s journal scan PDF so supplementary data tables become searchable.</p>
            <ol>
            <li>Confirm scan is image-only — text does not select</li>
            <li><a href="/pdf/ocrpdf">OCR PDF</a> — choose language matching source</li>
            <li>Spot-check 3 random pages — numbers and names accurate</li>
            ...
            <p>Pair with <a href="/guides/compress-pdf-for-researchers">compress workflow</a> · <a href="/guides/merge-pdf-for-researchers">merge workflow</a> · <a href="/guides/make-scanned-pdf-searchable">Searchable scan hub</a>.</p>
            <p>Tool: <a href="/pdf/ocrpdf">/pdf/ocrpdf</a></p>
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Start workflow</strong> <a href="/pdf/ocrpdf" class="alert-link fw-semibold">OCR PDF →</a></div>
        ...
        private const string OcrPdfForJournalists = """
            <h2>OCR PDF for Journalists — Searchable Scans (2026)</h2>
            <p>Example: Reporter OCRs 800-page FOI dump PDF so editors can search names before publication.</p>
            <p class="lead">Pillar: <a href="/guides/ocr-pdf">OCR PDF guide</a> · Related: <a href="/guides/compress-pdf-for-journalists">/guides/compress-pdf-for-journalists</a> · Tool page: <a href="/pdf/ocrpdf">/pdf/ocrpdf</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> OCR PDF for Journalists — Searchable Scans (2026)</figcaption></figure>
            
            <h2>OCR PDF for Journalists</h2>
            <p>Use case: FOI bundle — Reporter OCRs 800-page FOI dump PDF so editors can search names before publication.</p>
            <ol>
            <li>Confirm scan is image-only — text does not select</li>
            <li><a href="/pdf/ocrpdf">OCR PDF</a> — choose language matching source</li>
            <li>Spot-check 3 random pages — numbers and names accurate</li>
            ...
            <p>Pair with <a href="/guides/compress-pdf-for-journalists">compress workflow</a> · <a href="/guides/merge-pdf-for-journalists">merge workflow</a> · <a href="/guides/make-scanned-pdf-searchable">Searchable scan hub</a>.</p>
            <p>Tool: <a href="/pdf/ocrpdf">/pdf/ocrpdf</a></p>
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Start workflow</strong> <a href="/pdf/ocrpdf" class="alert-link fw-semibold">OCR PDF →</a></div>
