namespace ratpdf.Content
{
    ...
    internal static class GuideBodiesWave24
    {
        ...
        {
            "beginner-what-is-a-pdf" => BeginnerWhatIsAPdf,
            "beginner-when-to-use-pdf" => BeginnerWhenToUsePdf,
            "beginner-pdf-hyperlinks" => BeginnerPdfHyperlinks,
            "beginner-pdf-fonts-embedding" => BeginnerPdfFontsEmbedding,
            "beginner-pdf-security-basics" => BeginnerPdfSecurityBasics,
            "beginner-pdf-vs-docx" => BeginnerPdfVsDocx,
            "beginner-pdf-vs-png" => BeginnerPdfVsPng,
            "how-to-extract-text-from-pdf" => HowToExtractTextFromPdf,
            "how-to-make-pdf-searchable" => HowToMakePdfSearchable,
            "how-to-ocr-a-scanned-pdf" => HowToOcrAScannedPdf,
            "how-to-compare-two-text-files" => HowToCompareTwoTextFiles,
            "email-attachment-limits-2024" => EmailAttachmentLimits2024,
            "email-attachment-limits-2025" => EmailAttachmentLimits2025,
            "email-attachment-limits-2026" => EmailAttachmentLimits2026,
            "glossary-calc-export" => GlossaryCalcExport,
            "glossary-certificate-based-signature" => GlossaryCertificateBasedSignature,
            "glossary-cid-font" => GlossaryCidFont,
            _ => null
        };

        private const string BeginnerWhatIsAPdf = """
            <h2>What Is a PDF? — Portable Document Format Explained (2026)</h2>
            <p>Example: Intern receives first client contract PDF — learns why layout stays fixed unlike Word.</p>
            <p class="lead">Learn more: <a href="/guides/beginner-pdf-basics">PDF basics</a> · Related: <a href="/guides/beginner-when-to-use-pdf">/guides/beginner-when-to-use-pdf</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> What Is a PDF? — Portable Document Format Explained (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/guides/pdf-tools" class="btn btn-primary">PDF tools hub</a> · <a href="/guides/beginner-pdf-basics">Full guide</a></p>
            """;

        private const string BeginnerWhenToUsePdf = """
            <h2>When to Use PDF — vs Word, Excel, PNG &amp; Email Body (2026)</h2>
            <p>Example: Freelancer sends invoice as PDF not DOCX so client cannot silently edit line items.</p>
            <p class="lead">Learn more: <a href="/guides/beginner-what-is-a-pdf">what is a PDF</a> · Related: <a href="/guides/beginner-pdf-vs-docx">/guides/beginner-pdf-vs-docx</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> When to Use PDF — vs Word, Excel, PNG &amp; Email Body (2026)</figcaption></figure>
        ...
        private const string BeginnerPdfHyperlinks = """
            <h2>PDF Hyperlinks Basics — Clickable Links &amp; Broken TOC (2026)</h2>
            <p>Example: Annual report TOC link to page 47 dead after print-to-PDF from browser.</p>
            <p class="lead">Learn more: <a href="/guides/glossary-hyperlink">hyperlink glossary</a> · Related: <a href="/guides/beginner-pdf-bookmarks">/guides/beginner-pdf-bookmarks</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF Hyperlinks Basics — Clickable Links &amp; Broken TOC (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/editpdf" class="btn btn-primary">Edit PDF</a> · <a href="/guides/glossary-hyperlink">Full guide</a></p>
            """;

        private const string BeginnerPdfFontsEmbedding = """
            <h2>PDF Fonts &amp; Embedding Basics — Missing Font Boxes (2026)</h2>
            <p>Example: Proposal PDF shows square boxes on client PC — custom brand font not embedded.</p>
            <p class="lead">Learn more: <a href="/guides/beginner-pdf-file-structure">PDF file structure basics</a> · Related: <a href="/guides/embed-fonts-before-printing">/guides/embed-fonts-before-printing</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF Fonts &amp; Embedding Basics — Missing Font Boxes (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/doctopdf" class="btn btn-primary">Word to PDF</a> · <a href="/guides/beginner-pdf-file-structure">Full guide</a></p>
            """;

        private const string BeginnerPdfSecurityBasics = """
            <h2>PDF Security Basics — Password, Redaction &amp; Watermark (2026)</h2>
            <p>Example: HR shares draft policy PDF — password protect before external pilot group.</p>
            <p class="lead">Learn more: <a href="/guides/secure-pdf-workflow">secure PDF workflow</a> · Related: <a href="/guides/beginner-digital-signature-basics">/guides/beginner-digital-signature-basics</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF Security Basics — Password, Redaction &amp; Watermark (2026)</figcaption></figure>
        ...
        private const string BeginnerPdfVsDocx = """
            <h2>PDF vs DOCX — When to Send Word vs PDF (2026)</h2>
            <p>Example: Legal sends final signed contract as PDF — redlines happen in Word only during negotiation.</p>
            <p class="lead">Learn more: <a href="/guides/pdf-to-word-vs-pdf-to-text">PDF to Word vs Text</a> · Related: <a href="/guides/beginner-when-to-use-pdf">/guides/beginner-when-to-use-pdf</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF vs DOCX — When to Send Word vs PDF (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/pdftodoc" class="btn btn-primary">PDF to Word</a> · <a href="/guides/pdf-to-word-vs-pdf-to-text">Full guide</a></p>
            """;

        private const string BeginnerPdfVsPng = """
            <h2>PDF vs PNG — Documents vs Single Images (2026)</h2>
            <p>Example: Designer exports logo as PNG for web but delivers multi-page brand guide as PDF.</p>
            <p class="lead">Learn more: <a href="/guides/beginner-vector-vs-raster-pdf">vector vs raster PDF</a> · Related: <a href="/guides/pdf-to-images">/guides/pdf-to-images</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF vs PNG — Documents vs Single Images (2026)</figcaption></figure>
            ...
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Try the tool</strong> <a href="/pdf/pdftoimages" class="alert-link fw-semibold">PDF to Images →</a></div>
            ...
            <p class="mt-4"><a href="/pdf/pdftoimages" class="btn btn-primary">PDF to Images</a> · <a href="/guides/beginner-vector-vs-raster-pdf">Full guide</a></p>
            """;

        private const string HowToExtractTextFromPdf = """
            <h2>How Do I Extract Text from PDF? — Copy, Export &amp; .txt (2026)</h2>
            <p>Example: Analyst pulls contract clauses to .txt for Python keyword search script.</p>
            <p class="lead">Learn more: <a href="/guides/extract-text-scanned-pdf">extract text from scanned PDF</a> · Related: <a href="/guides/pdf-to-text-online">/guides/pdf-to-text-online</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> How Do I Extract Text from PDF? — Copy, Export &amp; .txt (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/pdftotext" class="btn btn-primary">PDF to Text</a> · <a href="/guides/extract-text-scanned-pdf">Full guide</a></p>
            """;

        private const string HowToMakePdfSearchable = """
            <h2>How Do I Make a PDF Searchable? — OCR Workflow (2026)</h2>
            <p>Example: Paralegal OCRs 400-page scanned deposition so Ctrl+F finds witness name.</p>
            <p class="lead">Learn more: <a href="/guides/beginner-ocr-basics">OCR basics</a> · Related: <a href="/guides/ocr-pdf">/guides/ocr-pdf</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> How Do I Make a PDF Searchable? — OCR Workflow (2026)</figcaption></figure>
        ...
        private const string HowToOcrAScannedPdf = """
            <h2>How Do I OCR a Scanned PDF? — Step-by-Step (2026)</h2>
            <p>Example: Clerk OCRs incoming fax PDF before archiving in searchable DMS.</p>
            <p class="lead">Learn more: <a href="/guides/ocr-pdf">OCR PDF guide</a> · Related: <a href="/guides/how-to-make-pdf-searchable">/guides/how-to-make-pdf-searchable</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> How Do I OCR a Scanned PDF? — Step-by-Step (2026)</figcaption></figure>
        ...
        private const string HowToCompareTwoTextFiles = """
            <h2>How Do I Compare Two Text Files? — Diff After PDF Extract (2026)</h2>
            <p>Example: Developer diffs policy PDF text extract v1 vs v2 before publishing.</p>
            <p class="lead">Learn more: <a href="/guides/text-comparer-guide">text comparer guide</a> · Related: <a href="/guides/how-to-extract-text-from-pdf">/guides/how-to-extract-text-from-pdf</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> How Do I Compare Two Text Files? — Diff After PDF Extract (2026)</figcaption></figure>
            ...
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Try the tool</strong> <a href="/text-comparer" class="alert-link fw-semibold">Text comparer →</a></div>
            ...
            <p class="mt-4"><a href="/text-comparer" class="btn btn-primary">Text comparer</a> · <a href="/guides/text-comparer-guide">Full guide</a></p>
            """;

        private const string EmailAttachmentLimits2024 = """
            <h2>Email Attachment Limits 2024 — PDF Size Reference (Archive)</h2>
            <p>Example: IT audits 2024 helpdesk tickets — most rejects were 22–28 MB PDF board packs.</p>
            <p class="lead">Learn more: <a href="/guides/email-attachment-size-limits-2026">email attachment limits 2026 (current)</a> · Related: <a href="/research/attachment-size-limits">/research/attachment-size-limits</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Email Attachment Limits 2024 — PDF Size Reference (Archive)</figcaption></figure>
        ...
        private const string EmailAttachmentLimits2025 = """
            <h2>Email Attachment Limits 2025 — PDF Size Reference (Archive)</h2>
            <p>Example: Ops documents 2025 provider caps before updating internal wiki to 2026 edition.</p>
            <p class="lead">Learn more: <a href="/guides/email-attachment-size-limits-2026">email attachment limits 2026 (current)</a> · Related: <a href="/guides/gmail-vs-outlook-pdf-limits">/guides/gmail-vs-outlook-pdf-limits</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Email Attachment Limits 2025 — PDF Size Reference (Archive)</figcaption></figure>
        ...
        private const string EmailAttachmentLimits2026 = """
            <h2>Email Attachment Limits 2026 — PDF Size Quick Reference</h2>
            <p>Example: Sales checks quick-reference table before sending 24 MB proposal PDF.</p>
            <p class="lead">Learn more: <a href="/guides/email-attachment-size-limits-2026">full email limits guide (size-limits slug)</a> · Related: <a href="/guides/pdf-email-attachment-checklist">/guides/pdf-email-attachment-checklist</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Email Attachment Limits 2026 — PDF Size Quick Reference</figcaption></figure>
        ...
        private const string GlossaryCalcExport = """
            <h2>What Is Calc Export to PDF? — LibreOffice Spreadsheets (2026)</h2>
            <p>Example: Analyst exports LibreOffice Calc budget to PDF for board email — fonts must embed.</p>
            <p class="lead">Learn more: <a href="/guides/excel-to-pdf">Excel to PDF guide</a> · Related: <a href="/guides/excel-to-pdf">/guides/excel-to-pdf</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> What Is Calc Export to PDF? — LibreOffice Spreadsheets (2026)</figcaption></figure>
        ...
        private const string GlossaryCertificateBasedSignature = """
            <h2>What Is a Certificate-Based PDF Signature? — PKI Details (2026)</h2>
            <p>Example: EU procurement requires certificate-based signature — RatPDF typed block not accepted.</p>
            <p class="lead">Learn more: <a href="/guides/glossary-certificate-signature">certificate signature glossary</a> · Related: <a href="/guides/beginner-digital-signature-basics">/guides/beginner-digital-signature-basics</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> What Is a Certificate-Based PDF Signature? — PKI Details (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/guides/sign-pdf-legally" class="btn btn-primary">sign PDF legally</a> · <a href="/guides/glossary-certificate-signature">Full guide</a></p>
            """;

        private const string GlossaryCidFont = """
            <h2>What Is a CID Font in PDF? — CJK &amp; Composite Fonts (2026)</h2>
            <p>Example: Japanese annual report PDF uses CID font — copy-paste shows garbage without proper encoding.</p>
            <p class="lead">Learn more: <a href="/guides/ocr-hindi-pdf">OCR Hindi PDF guide</a> · Related: <a href="/guides/glossary-composite-font">/guides/glossary-composite-font</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> What Is a CID Font in PDF? — CJK &amp; Composite Fonts (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/ocrpdf" class="btn btn-primary">OCR PDF</a> · <a href="/guides/ocr-hindi-pdf">Full guide</a></p>
            """;
