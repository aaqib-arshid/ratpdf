namespace ratpdf.Content
{
    ...
    internal static class GuideBodiesWave23
    {
        ...
        {
            "beginner-pdf-basics" => BeginnerPdfBasics,
            "beginner-ocr-basics" => BeginnerOcrBasics,
            "beginner-pdf-compression-basics" => BeginnerPdfCompressionBasics,
            "beginner-pdf-file-structure" => BeginnerPdfFileStructure,
            "beginner-pdf-forms-basics" => BeginnerPdfFormsBasics,
            "beginner-digital-signature-basics" => BeginnerDigitalSignatureBasics,
            "beginner-pdf-bookmarks" => BeginnerPdfBookmarks,
            "beginner-pdf-accessibility-basics" => BeginnerPdfAccessibilityBasics,
            "beginner-vector-vs-raster-pdf" => BeginnerVectorVsRasterPdf,
            "beginner-pdf-color-space-rgb-cmyk" => BeginnerPdfColorSpaceRgbCmyk,
            "how-to-combine-images-into-pdf" => HowToCombineImagesIntoPdf,
            "how-to-split-a-pdf" => HowToSplitAPdf,
            "how-to-split-pdf-for-email" => HowToSplitPdfForEmail,
            "pdf-email-attachment-checklist" => PdfEmailAttachmentChecklist,
            "glossary-blob-storage" => GlossaryBlobStorage,
            "glossary-browser-based-processing" => GlossaryBrowserBasedProcessing,
            "glossary-certificate-signature" => GlossaryCertificateSignature,
            _ => null
        };

        private const string BeginnerPdfBasics = """
            <h2>PDF Basics — What PDFs Are &amp; First Tasks (2026)</h2>
            <p>Example: New hire receives contract PDF — learns view, search, merge, and compress before first client send.</p>
            <p class="lead">Learn more: <a href="/guides/beginner-what-is-a-pdf">what is a PDF</a> · Related: <a href="/guides/beginner-when-to-use-pdf">/guides/beginner-when-to-use-pdf</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF Basics — What PDFs Are &amp; First Tasks (2026)</figcaption></figure>
            ...
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Try the tool</strong> <a href="/guides/pdf-tools" class="alert-link fw-semibold">PDF tools hub →</a></div>
        ...
        private const string BeginnerOcrBasics = """
            <h2>OCR Basics — Scanned PDFs vs Digital Text (2026)</h2>
            <p>Example: Student scans library chapter — OCR makes PDF searchable before highlighting quotes.</p>
            <p class="lead">Learn more: <a href="/guides/ocr-pdf">OCR PDF guide</a> · Related: <a href="/guides/ocr-vs-pdf-to-text">/guides/ocr-vs-pdf-to-text</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> OCR Basics — Scanned PDFs vs Digital Text (2026)</figcaption></figure>
        ...
        private const string BeginnerPdfCompressionBasics = """
            <h2>PDF Compression Basics — Size, Quality &amp; When to Compress (2026)</h2>
            <p>Example: Freelancer shrinks 18 MB portfolio PDF to fit Gmail without blurry text.</p>
            <p class="lead">Learn more: <a href="/guides/compress-pdf-guide">compress PDF guide</a> · Related: <a href="/guides/pdf-compression-benchmark">/guides/pdf-compression-benchmark</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF Compression Basics — Size, Quality &amp; When to Compress (2026)</figcaption></figure>
        ...
        private const string BeginnerPdfFileStructure = """
            <h2>PDF File Structure Basics — Objects, Pages &amp; Metadata (2026)</h2>
            <p>Example: Developer inspects PDF metadata JSON before publishing API documentation export.</p>
            <p class="lead">Learn more: <a href="/guides/beginner-pdf-metadata-explained">PDF metadata explained</a> · Related: <a href="/guides/glossary-embedded-files">/guides/glossary-embedded-files</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF File Structure Basics — Objects, Pages &amp; Metadata (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/pdfmetadata" class="btn btn-primary">PDF Metadata</a> · <a href="/guides/beginner-pdf-metadata-explained">Full guide</a></p>
            """;

        private const string BeginnerPdfFormsBasics = """
            <h2>PDF Forms Basics — Fillable Fields vs Flat PDFs (2026)</h2>
            <p>Example: Employee fills HR onboarding PDF in browser — discovers some government forms are flat scans.</p>
            <p class="lead">Learn more: <a href="/guides/edit-pdf-forms">edit PDF forms guide</a> · Related: <a href="/guides/beginner-pdf-basics">/guides/beginner-pdf-basics</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF Forms Basics — Fillable Fields vs Flat PDFs (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/editpdf" class="btn btn-primary">Edit PDF</a> · <a href="/guides/edit-pdf-forms">Full guide</a></p>
            """;

        private const string BeginnerDigitalSignatureBasics = """
            <h2>Digital Signature Basics — Typed, Image &amp; Qualified E-Sign (2026)</h2>
            <p>Example: Consultant adds typed signature block to SOW — learns when DocuSign is required instead.</p>
            <p class="lead">Learn more: <a href="/guides/sign-pdf-legally">sign PDF legally guide</a> · Related: <a href="/guides/add-signature-to-pdf">/guides/add-signature-to-pdf</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Digital Signature Basics — Typed, Image &amp; Qualified E-Sign (2026)</figcaption></figure>
            ...
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Try the tool</strong> <a href="/pdf/signtext" class="alert-link fw-semibold">Sign PDF →</a></div>
        ...
        private const string BeginnerPdfBookmarks = """
            <h2>PDF Bookmarks Basics — Navigation Outline in Long Documents (2026)</h2>
            <p>Example: Policy reader jumps to Chapter 4 via bookmark panel instead of scrolling 200 pages.</p>
            <p class="lead">Learn more: <a href="/guides/glossary-bookmark">bookmark glossary</a> · Related: <a href="/guides/organize-pdf-pages">/guides/organize-pdf-pages</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF Bookmarks Basics — Navigation Outline in Long Documents (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/pdfmetadata" class="btn btn-primary">PDF Metadata</a> · <a href="/guides/glossary-bookmark">Full guide</a></p>
            """;

        private const string BeginnerPdfAccessibilityBasics = """
            <h2>PDF Accessibility Basics — Tags, Alt Text &amp; Screen Readers (2026)</h2>
            <p>Example: Designer learns why exported InDesign PDF fails university accessibility checker.</p>
            <p class="lead">Learn more: <a href="/guides/glossary-accessibility">accessibility glossary</a> · Related: <a href="/guides/pdf-ua-accessibility">/guides/pdf-ua-accessibility</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF Accessibility Basics — Tags, Alt Text &amp; Screen Readers (2026)</figcaption></figure>
            ...
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Try the tool</strong> <a href="/guides/pdf-accessibility-wcag" class="alert-link fw-semibold">PDF accessibility WCAG →</a></div>
            ...
            <p class="mt-4"><a href="/guides/pdf-accessibility-wcag" class="btn btn-primary">PDF accessibility WCAG</a> · <a href="/guides/glossary-accessibility">Full guide</a></p>
            """;

        private const string BeginnerVectorVsRasterPdf = """
            <h2>Vector vs Raster PDF — Logos, Text &amp; Photo Quality (2026)</h2>
            <p>Example: Marketing PDF logo stays sharp at zoom but hero photo pixelates after aggressive compress.</p>
            <p class="lead">Learn more: <a href="/guides/beginner-pdf-basics">PDF basics</a> · Related: <a href="/guides/glossary-downsampling">/guides/glossary-downsampling</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Vector vs Raster PDF — Logos, Text &amp; Photo Quality (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/compress" class="btn btn-primary">Compress PDF</a> · <a href="/guides/beginner-pdf-basics">Full guide</a></p>
            """;

        private const string BeginnerPdfColorSpaceRgbCmyk = """
            <h2>PDF Color Space Basics — RGB vs CMYK for Screen &amp; Print (2026)</h2>
            <p>Example: Brand red looks dull on office printer — PDF still RGB not CMYK for press.</p>
            <p class="lead">Learn more: <a href="/guides/glossary-cmyk">CMYK glossary</a> · Related: <a href="/guides/glossary-grayscale">/guides/glossary-grayscale</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF Color Space Basics — RGB vs CMYK for Screen &amp; Print (2026)</figcaption></figure>
            ...
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Try the tool</strong> <a href="/guides/pdf-x-print-standard" class="alert-link fw-semibold">PDF/X print standard →</a></div>
            ...
            <p class="mt-4"><a href="/guides/pdf-x-print-standard" class="btn btn-primary">PDF/X print standard</a> · <a href="/guides/glossary-cmyk">Full guide</a></p>
            """;

        private const string HowToCombineImagesIntoPdf = """
            <h2>How Do I Combine Images into PDF? — JPG &amp; PNG to One File (2026)</h2>
            <p>Example: Tenant photographs 12 receipt photos on phone — combines into one expense PDF.</p>
            <p class="lead">Learn more: <a href="/guides/images-to-pdf">images to PDF guide</a> · Related: <a href="/guides/images-to-pdf-without-adobe">/guides/images-to-pdf-without-adobe</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> How Do I Combine Images into PDF? — JPG &amp; PNG to One File (2026)</figcaption></figure>
            ...
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Try the tool</strong> <a href="/pdf/convertimages" class="alert-link fw-semibold">Images to PDF →</a></div>
        ...
        private const string HowToSplitAPdf = """
            <h2>How Do I Split a PDF? — Extract Pages Online (2026)</h2>
            <p>Example: Homeowner extracts insurance declaration page 3 from 40-page homeowner policy PDF.</p>
            <p class="lead">Learn more: <a href="/guides/split-pdf">split PDF guide</a> · Related: <a href="/guides/split-pdf-page-range">/guides/split-pdf-page-range</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> How Do I Split a PDF? — Extract Pages Online (2026)</figcaption></figure>
        ...
        private const string HowToSplitPdfForEmail = """
            <h2>How Do I Split PDF for Email? — Parts Under Attachment Limits (2026)</h2>
            <p>Example: Legal cannot compress scanned fine print further — splits exhibit into Part1 and Part2 for Gmail.</p>
            <p class="lead">Learn more: <a href="/guides/compress-vs-split">compress vs split guide</a> · Related: <a href="/guides/email-attachment-size-limits-2026">/guides/email-attachment-size-limits-2026</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> How Do I Split PDF for Email? — Parts Under Attachment Limits (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/pdf/split" class="btn btn-primary">Split PDF</a> · <a href="/guides/compress-vs-split">Full guide</a></p>
            """;

        private const string PdfEmailAttachmentChecklist = """
            <h2>PDF Email Attachment Checklist — Before You Hit Send (2026)</h2>
            <p>Example: Accountant runs five-point checklist — catches 26 MB board pack before Friday client blast.</p>
            <p class="lead">Learn more: <a href="/guides/email-attachment-size-limits-2026">email attachment limits 2026</a> · Related: <a href="/guides/gmail-vs-outlook-pdf-limits">/guides/gmail-vs-outlook-pdf-limits</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> PDF Email Attachment Checklist — Before You Hit Send (2026)</figcaption></figure>
        ...
        private const string GlossaryBlobStorage = """
            <h2>What Is Blob Storage for PDFs? — Cloud Archives &amp; URLs (2026)</h2>
            <p>Example: IT stores compressed PDF archive in S3 — signed URL for partner download.</p>
            <p class="lead">Learn more: <a href="/guides/beginner-pdf-file-structure">PDF file structure basics</a> · Related: <a href="/guides/compress-pdf-cloud-storage">/guides/compress-pdf-cloud-storage</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> What Is Blob Storage for PDFs? — Cloud Archives &amp; URLs (2026)</figcaption></figure>
            ...
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Try the tool</strong> <a href="/guides/compress-pdf-cloud-storage" class="alert-link fw-semibold">compress for cloud storage →</a></div>
            ...
            <p class="mt-4"><a href="/guides/compress-pdf-cloud-storage" class="btn btn-primary">compress for cloud storage</a> · <a href="/guides/beginner-pdf-file-structure">Full guide</a></p>
            """;

        private const string GlossaryBrowserBasedProcessing = """
            <h2>What Is Browser-Based PDF Processing? — Upload, Server, Download (2026)</h2>
            <p>Example: Remote worker merges PDFs in Chrome without IT-approved desktop install.</p>
            <p class="lead">Learn more: <a href="/guides/browser-vs-desktop-pdf-tools">browser vs desktop PDF tools</a> · Related: <a href="/guides/pdf-tool-security-comparison">/guides/pdf-tool-security-comparison</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> What Is Browser-Based PDF Processing? — Upload, Server, Download (2026)</figcaption></figure>
            ...
            <p class="mt-4"><a href="/guides/pdf-tools" class="btn btn-primary">PDF tools hub</a> · <a href="/guides/browser-vs-desktop-pdf-tools">Full guide</a></p>
            """;

        private const string GlossaryCertificateSignature = """
            <h2>What Is a Certificate PDF Signature? — PKI &amp; Qualified E-Sign (2026)</h2>
            <p>Example: Regulated deal requires qualified certificate signature — typed RatPDF block not sufficient.</p>
            <p class="lead">Learn more: <a href="/guides/beginner-digital-signature-basics">digital signature basics</a> · Related: <a href="/guides/glossary-owner-password">/guides/glossary-owner-password</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> What Is a Certificate PDF Signature? — PKI &amp; Qualified E-Sign (2026)</figcaption></figure>
            ...
            <div class="rp-mid-cta alert alert-primary my-4"><strong>Try the tool</strong> <a href="/guides/sign-pdf-legally" class="alert-link fw-semibold">sign PDF legally →</a></div>
            ...
            <p class="mt-4"><a href="/guides/sign-pdf-legally" class="btn btn-primary">sign PDF legally</a> · <a href="/guides/beginner-digital-signature-basics">Full guide</a></p>
            """;
