namespace ratpdf.Content
{
    ...
    internal static class GuideBodiesWave28
    {
        ...
        {
            "contract-pdf-workflow-france" => ContractPdfWorkflowFrance,
            "contract-pdf-workflow-india" => ContractPdfWorkflowIndia,
            "contract-pdf-workflow-ireland" => ContractPdfWorkflowIreland,
            "contract-pdf-workflow-japan" => ContractPdfWorkflowJapan,
            "contract-pdf-workflow-netherlands" => ContractPdfWorkflowNetherlands,
            "contract-pdf-workflow-singapore" => ContractPdfWorkflowSingapore,
            "contract-pdf-workflow-spain" => ContractPdfWorkflowSpain,
            "contract-pdf-workflow-uae" => ContractPdfWorkflowUae,
            "tax-document-pdf-workflow-australia" => TaxDocumentPdfWorkflowAustralia,
            "tax-document-pdf-workflow-brazil" => TaxDocumentPdfWorkflowBrazil,
            "tax-document-pdf-workflow-canada" => TaxDocumentPdfWorkflowCanada,
            "tax-document-pdf-workflow-france" => TaxDocumentPdfWorkflowFrance,
            "tax-document-pdf-workflow-germany" => TaxDocumentPdfWorkflowGermany,
            "tax-document-pdf-workflow-ireland" => TaxDocumentPdfWorkflowIreland,
            "tax-document-pdf-workflow-italy" => TaxDocumentPdfWorkflowItaly,
            "tax-document-pdf-workflow-japan" => TaxDocumentPdfWorkflowJapan,
            "tax-document-pdf-workflow-mexico" => TaxDocumentPdfWorkflowMexico,
            _ => null
        };

        private const string ContractPdfWorkflowFrance = """
            <h2>Contract PDF Workflow France — B2B Contrat &amp; RGPD Pack (2026)</h2>
            <p>Example: Paris SaaS vendor merges contrat cadre and RGPD annexe PDFs — watermarks DRAFT before client legal review.</p>
            <p class="lead">Pillar: <a href="/guides/contract-pdf-workflow-germany">contract PDF workflow (Germany reference)</a> · Related: <a href="/guides/visa-application-pdf-workflow-france">/guides/visa-application-pdf-workflow-france</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Contract PDF Workflow France — B2B Contrat &amp; RGPD Pack (2026)</figcaption></figure>
            
            <h2>Contract PDF — France</h2>
            <p>Contrat cadre + annexes RGPD — merge order: master then numbered allegati — eIDAS context for qualified sign. Watermark negotiation drafts — flatten only after mutual sign.</p>
            <h2>Workflow</h2>
            <ol>
            ...
            <p>Regional: <a href="/guides/visa-application-pdf-workflow-france">visa application pdf workflow france</a>.</p>
        ...
        private const string ContractPdfWorkflowIndia = """
            <h2>Contract PDF Workflow India — MSA, SOW &amp; GST Annex (2026)</h2>
            <p>Example: Bangalore IT firm merges MSA, SOW, and GST registration annex PDF before enterprise client sign-off.</p>
            <p class="lead">Pillar: <a href="/guides/contract-pdf-workflow-usa">contract PDF workflow (USA reference)</a> · Related: <a href="/guides/invoice-pdf-workflow-india">/guides/invoice-pdf-workflow-india</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Contract PDF Workflow India — MSA, SOW &amp; GST Annex (2026)</figcaption></figure>
            
            <h2>Contract PDF — India</h2>
            <p>MSA + SOW + DPA if needed — GSTIN on commercial invoices separate — watermark negotiation drafts. Watermark negotiation drafts — flatten only after mutual sign.</p>
            <h2>Workflow</h2>
            <ol>
            <li>Export each part from Word or e-sign tool — consistent page size</li>
            <li><a href="/pdf/merge">Merge PDF</a> — master agreement first, exhibits numbered</li>
            ...
            <h2>Compliance</h2>
            <p>Do not merge unrelated client contracts — data minimisation applies. See <a href="/guides/edit-pdf-mistakes-compliance">edit compliance mistakes</a>.</p>
            <p>Regional: <a href="/guides/invoice-pdf-workflow-india">invoice pdf workflow india</a>.</p>
            ...
            <p class="mt-4"><a href="/pdf/merge" class="btn btn-primary">Merge PDF</a> · <a href="/guides/contract-pdf-workflow-usa">Full guide</a></p>
            """;

        private const string ContractPdfWorkflowIreland = """
            <h2>Contract PDF Workflow Ireland — SME Agreement &amp; GDPR Pack (2026)</h2>
            <p>Example: Dublin agency merges services agreement and GDPR processing schedule PDF for client review.</p>
            <p class="lead">Pillar: <a href="/guides/contract-pdf-workflow-uk">contract PDF workflow UK</a> · Related: <a href="/guides/visa-application-pdf-workflow-ireland">/guides/visa-application-pdf-workflow-ireland</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Contract PDF Workflow Ireland — SME Agreement &amp; GDPR Pack (2026)</figcaption></figure>
            
            <h2>Contract PDF — Ireland</h2>
            <p>Heads of terms then full agreement — GDPR Article 28 processor terms as numbered exhibit. Watermark negotiation drafts — flatten only after mutual sign.</p>
            <h2>Workflow</h2>
            <ol>
            <li>Export each part from Word or e-sign tool — consistent page size</li>
            <li><a href="/pdf/merge">Merge PDF</a> — master agreement first, exhibits numbered</li>
            ...
            <h2>Compliance</h2>
            <p>Do not merge unrelated client contracts — data minimisation applies. See <a href="/guides/edit-pdf-mistakes-compliance">edit compliance mistakes</a>.</p>
            <p>Regional: <a href="/guides/visa-application-pdf-workflow-ireland">visa application pdf workflow ireland</a>.</p>
            ...
            <p class="mt-4"><a href="/pdf/merge" class="btn btn-primary">Merge PDF</a> · <a href="/guides/contract-pdf-workflow-uk">Full guide</a></p>
            """;

        private const string ContractPdfWorkflowJapan = """
            <h2>Contract PDF Workflow Japan — B2B Keiyaku &amp; Bilingual Pack (2026)</h2>
            <p>Example: Exporter merges Japanese master keiyaku and English translation PDF for overseas buyer countersign.</p>
            <p class="lead">Pillar: <a href="/guides/contract-pdf-workflow-usa">contract PDF workflow hub</a> · Related: <a href="/guides/visa-application-pdf-workflow-japan">/guides/visa-application-pdf-workflow-japan</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Contract PDF Workflow Japan — B2B Keiyaku &amp; Bilingual Pack (2026)</figcaption></figure>
            
            <h2>Contract PDF — Japan</h2>
            <p>Hanko/stamp culture — digital PDF sign via e-sign platform — bilingual deals need both language exhibits. Watermark negotiation drafts — flatten only after mutual sign.</p>
            <h2>Workflow</h2>
            <ol>
            <li>Export each part from Word or e-sign tool — consistent page size</li>
            <li><a href="/pdf/merge">Merge PDF</a> — master agreement first, exhibits numbered</li>
            ...
            <h2>Compliance</h2>
            <p>Do not merge unrelated client contracts — data minimisation applies. See <a href="/guides/edit-pdf-mistakes-compliance">edit compliance mistakes</a>.</p>
            <p>Regional: <a href="/guides/visa-application-pdf-workflow-japan">visa application pdf workflow japan</a>.</p>
        ...
        private const string ContractPdfWorkflowNetherlands = """
            <h2>Contract PDF Workflow Netherlands — B2B Overeenkomst Pack (2026)</h2>
            <p>Example: Amsterdam startup merges overeenkomst and AVV GDPR bijlage PDF before investor pilot.</p>
            <p class="lead">Pillar: <a href="/guides/contract-pdf-workflow-germany">contract PDF workflow Germany</a> · Related: <a href="/guides/visa-application-pdf-workflow-netherlands">/guides/visa-application-pdf-workflow-netherlands</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Contract PDF Workflow Netherlands — B2B Overeenkomst Pack (2026)</figcaption></figure>
            
            <h2>Contract PDF — Netherlands</h2>
            <p>AVG/GDPR processor agreement — merge master first — Dutch or English per counterparty. Watermark negotiation drafts — flatten only after mutual sign.</p>
            <h2>Workflow</h2>
            <ol>
            <li>Export each part from Word or e-sign tool — consistent page size</li>
            <li><a href="/pdf/merge">Merge PDF</a> — master agreement first, exhibits numbered</li>
            ...
            <h2>Compliance</h2>
            <p>Do not merge unrelated client contracts — data minimisation applies. See <a href="/guides/edit-pdf-mistakes-compliance">edit compliance mistakes</a>.</p>
            <p>Regional: <a href="/guides/visa-application-pdf-workflow-netherlands">visa application pdf workflow netherlands</a>.</p>
        ...
        private const string ContractPdfWorkflowSingapore = """
            <h2>Contract PDF Workflow Singapore — MSA &amp; PDPA Pack (2026)</h2>
            <p>Example: Fintech merges MSA and PDPA data processing addendum PDF for MAS-regulated client onboarding.</p>
            <p class="lead">Pillar: <a href="/guides/contract-pdf-workflow-australia">contract PDF workflow Australia</a> · Related: <a href="/guides/visa-application-pdf-workflow-singapore">/guides/visa-application-pdf-workflow-singapore</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Contract PDF Workflow Singapore — MSA &amp; PDPA Pack (2026)</figcaption></figure>
            
            <h2>Contract PDF — Singapore</h2>
            <p>PDPA schedule separate exhibit — merge for internal review — compress email copy under 20 MB. Watermark negotiation drafts — flatten only after mutual sign.</p>
            <h2>Workflow</h2>
            <ol>
            <li>Export each part from Word or e-sign tool — consistent page size</li>
            <li><a href="/pdf/merge">Merge PDF</a> — master agreement first, exhibits numbered</li>
            ...
            <h2>Compliance</h2>
            <p>Do not merge unrelated client contracts — data minimisation applies. See <a href="/guides/edit-pdf-mistakes-compliance">edit compliance mistakes</a>.</p>
            <p>Regional: <a href="/guides/visa-application-pdf-workflow-singapore">visa application pdf workflow singapore</a>.</p>
            ...
            <p class="mt-4"><a href="/pdf/merge" class="btn btn-primary">Merge PDF</a> · <a href="/guides/contract-pdf-workflow-australia">Full guide</a></p>
            """;

        private const string ContractPdfWorkflowSpain = """
            <h2>Contract PDF Workflow Spain — Contrato B2B &amp; RGPD Anexo (2026)</h2>
            <p>Example: Barcelona consultancy merges contrato marco and anexo RGPD PDF before cliente firma.</p>
            <p class="lead">Pillar: <a href="/guides/contract-pdf-workflow-italy">contract PDF workflow Italy</a> · Related: <a href="/guides/visa-application-pdf-workflow-spain">/guides/visa-application-pdf-workflow-spain</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Contract PDF Workflow Spain — Contrato B2B &amp; RGPD Anexo (2026)</figcaption></figure>
            
            <h2>Contract PDF — Spain</h2>
            <p>LOPDGDD data processing annex — watermark borrador on negotiation copies. Watermark negotiation drafts — flatten only after mutual sign.</p>
            <h2>Workflow</h2>
            <ol>
            <li>Export each part from Word or e-sign tool — consistent page size</li>
            <li><a href="/pdf/merge">Merge PDF</a> — master agreement first, exhibits numbered</li>
            ...
            <h2>Compliance</h2>
            <p>Do not merge unrelated client contracts — data minimisation applies. See <a href="/guides/edit-pdf-mistakes-compliance">edit compliance mistakes</a>.</p>
            <p>Regional: <a href="/guides/visa-application-pdf-workflow-spain">visa application pdf workflow spain</a>.</p>
            ...
            <p class="mt-4"><a href="/pdf/merge" class="btn btn-primary">Merge PDF</a> · <a href="/guides/contract-pdf-workflow-italy">Full guide</a></p>
            """;

        private const string ContractPdfWorkflowUae = """
            <h2>Contract PDF Workflow UAE — Commercial Contract &amp; PRO Pack (2026)</h2>
            <p>Example: Dubai free-zone company merges commercial agreement and attested trade licence PDF for PRO filing.</p>
            <p class="lead">Pillar: <a href="/guides/contract-pdf-workflow-usa">contract PDF workflow hub</a> · Related: <a href="/guides/visa-application-pdf-workflow-uae">/guides/visa-application-pdf-workflow-uae</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Contract PDF Workflow UAE — Commercial Contract &amp; PRO Pack (2026)</figcaption></figure>
            
            <h2>Contract PDF — UAE</h2>
            <p>Arabic translation may be required for certain filings — merge English master + translation exhibit. Watermark negotiation drafts — flatten only after mutual sign.</p>
            <h2>Workflow</h2>
            <ol>
            <li>Export each part from Word or e-sign tool — consistent page size</li>
            <li><a href="/pdf/merge">Merge PDF</a> — master agreement first, exhibits numbered</li>
            ...
            <h2>Compliance</h2>
            <p>Do not merge unrelated client contracts — data minimisation applies. See <a href="/guides/edit-pdf-mistakes-compliance">edit compliance mistakes</a>.</p>
            <p>Regional: <a href="/guides/visa-application-pdf-workflow-uae">visa application pdf workflow uae</a>.</p>
        ...
        private const string TaxDocumentPdfWorkflowAustralia = """
            <h2>Tax Document PDF Workflow Australia — ATO &amp; myGov Upload (2026)</h2>
            <p>Example: Mortgage applicant compresses ATO notice of assessment PDF for lender KYC portal.</p>
            <p class="lead">Pillar: <a href="/guides/tax-document-pdf-workflow-india">tax document workflow India (reference)</a> · Related: <a href="/guides/visa-application-pdf-workflow-australia">/guides/visa-application-pdf-workflow-australia</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Tax Document PDF Workflow Australia — ATO &amp; myGov Upload (2026)</figcaption></figure>
            
            <h2>Tax documents — Australia</h2>
            <p><strong>Common PDFs:</strong> Notice of assessment, payment summary, BAS PDF exports from myGov/ATO.</p>
            <p><strong>Typical use:</strong> Lender KYC, rental agent, visa financial evidence — often 2–5 MB per slot.</p>
            <h2>Workflow</h2>
            <ol>
            ...
            <p>Pair with <a href="/guides/visa-application-pdf-workflow-australia">visa workflow</a> when immigration evidence. India reference: <a href="/guides/tax-document-pdf-workflow-india">tax workflow India</a>.</p>
        ...
        private const string TaxDocumentPdfWorkflowBrazil = """
            <h2>Tax Document PDF Workflow Brazil — IRPF &amp; Receita Federal (2026)</h2>
            <p>Example: Applicant compresses IRPF recibo PDF for consulate financial evidence upload.</p>
            <p class="lead">Pillar: <a href="/guides/tax-document-pdf-workflow-india">tax document workflow India (reference)</a> · Related: <a href="/guides/visa-application-pdf-workflow-brazil">/guides/visa-application-pdf-workflow-brazil</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Tax Document PDF Workflow Brazil — IRPF &amp; Receita Federal (2026)</figcaption></figure>
            
            <h2>Tax documents — Brazil</h2>
            <p><strong>Common PDFs:</strong> IRPF declaração, recibo de entrega, Informe de Rendimentos from Receita.</p>
            <p><strong>Typical use:</strong> Consulate, bank loan, rental — compress under 3 MB safe default.</p>
            <h2>Workflow</h2>
            <ol>
            <li>Download official PDF from tax authority portal — not edited screenshots</li>
            <li>Verify name, tax ID, and assessment year at 100% zoom</li>
            ...
            <h2>Loan and visa KYC</h2>
            <p>Pair with <a href="/guides/visa-application-pdf-workflow-brazil">visa workflow</a> when immigration evidence. India reference: <a href="/guides/tax-document-pdf-workflow-india">tax workflow India</a>.</p>
            <h2>Troubleshooting</h2>
            <p><strong>Password-protected portal PDF:</strong> unlock only if you set password — re-export unprotected if portal allows. <strong>Scan instead of export:</strong> re-download from authority site.</p>
        ...
        private const string TaxDocumentPdfWorkflowCanada = """
            <h2>Tax Document PDF Workflow Canada — CRA My Account &amp; NOA (2026)</h2>
            <p>Example: Express Entry applicant compresses CRA notice of assessment PDF for IRCC proof of funds workflow.</p>
            <p class="lead">Pillar: <a href="/guides/tax-document-pdf-workflow-india">tax document workflow India (reference)</a> · Related: <a href="/guides/visa-application-pdf-workflow-canada">/guides/visa-application-pdf-workflow-canada</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Tax Document PDF Workflow Canada — CRA My Account &amp; NOA (2026)</figcaption></figure>
            
            <h2>Tax documents — Canada</h2>
            <p><strong>Common PDFs:</strong> Notice of assessment (NOA), T4, tax return PDF from CRA My Account.</p>
            <p><strong>Typical use:</strong> IRCC, mortgage broker, provincial rental — 2–4 MB typical.</p>
            <h2>Workflow</h2>
            <ol>
            <li>Download official PDF from tax authority portal — not edited screenshots</li>
            <li>Verify name, tax ID, and assessment year at 100% zoom</li>
            ...
            <h2>Loan and visa KYC</h2>
            <p>Pair with <a href="/guides/visa-application-pdf-workflow-canada">visa workflow</a> when immigration evidence. India reference: <a href="/guides/tax-document-pdf-workflow-india">tax workflow India</a>.</p>
            <h2>Troubleshooting</h2>
            <p><strong>Password-protected portal PDF:</strong> unlock only if you set password — re-export unprotected if portal allows. <strong>Scan instead of export:</strong> re-download from authority site.</p>
        ...
        private const string TaxDocumentPdfWorkflowFrance = """
            <h2>Tax Document PDF Workflow France — Avis d'Imposition &amp; impots.gouv (2026)</h2>
            <p>Example: Tenant compresses avis d'imposition PDF for dossier locatif under 2 MB cap.</p>
            <p class="lead">Pillar: <a href="/guides/tax-document-pdf-workflow-india">tax document workflow India (reference)</a> · Related: <a href="/guides/visa-application-pdf-workflow-france">/guides/visa-application-pdf-workflow-france</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Tax Document PDF Workflow France — Avis d'Imposition &amp; impots.gouv (2026)</figcaption></figure>
            
            <h2>Tax documents — France</h2>
            <p><strong>Common PDFs:</strong> Avis d'imposition, déclaration PDF from impots.gouv — not altered scans.</p>
            <p><strong>Typical use:</strong> Rental dossier, visa financial proof, loan KYC.</p>
            <h2>Workflow</h2>
            <ol>
            <li>Download official PDF from tax authority portal — not edited screenshots</li>
            <li>Verify name, tax ID, and assessment year at 100% zoom</li>
            ...
            <h2>Loan and visa KYC</h2>
            <p>Pair with <a href="/guides/visa-application-pdf-workflow-france">visa workflow</a> when immigration evidence. India reference: <a href="/guides/tax-document-pdf-workflow-india">tax workflow India</a>.</p>
            <h2>Troubleshooting</h2>
            <p><strong>Password-protected portal PDF:</strong> unlock only if you set password — re-export unprotected if portal allows. <strong>Scan instead of export:</strong> re-download from authority site.</p>
        ...
        private const string TaxDocumentPdfWorkflowGermany = """
            <h2>Tax Document PDF Workflow Germany — Steuerbescheid &amp; Elster (2026)</h2>
            <p>Example: Applicant compresses Finanzamt Steuerbescheid PDF for visa blocked-account evidence bundle.</p>
            <p class="lead">Pillar: <a href="/guides/tax-document-pdf-workflow-india">tax document workflow India (reference)</a> · Related: <a href="/guides/visa-application-pdf-workflow-germany">/guides/visa-application-pdf-workflow-germany</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Tax Document PDF Workflow Germany — Steuerbescheid &amp; Elster (2026)</figcaption></figure>
            
            <h2>Tax documents — Germany</h2>
            <p><strong>Common PDFs:</strong> Steuerbescheid, Lohnsteuerbescheinigung PDF from Elster or employer.</p>
            <p><strong>Typical use:</strong> Visa, rental, mortgage — verify Finanzamt stamp readable after compress.</p>
            <h2>Workflow</h2>
            <ol>
            <li>Download official PDF from tax authority portal — not edited screenshots</li>
            <li>Verify name, tax ID, and assessment year at 100% zoom</li>
            ...
            <h2>Loan and visa KYC</h2>
            <p>Pair with <a href="/guides/visa-application-pdf-workflow-germany">visa workflow</a> when immigration evidence. India reference: <a href="/guides/tax-document-pdf-workflow-india">tax workflow India</a>.</p>
            <h2>Troubleshooting</h2>
            <p><strong>Password-protected portal PDF:</strong> unlock only if you set password — re-export unprotected if portal allows. <strong>Scan instead of export:</strong> re-download from authority site.</p>
        ...
        private const string TaxDocumentPdfWorkflowIreland = """
            <h2>Tax Document PDF Workflow Ireland — Revenue ROS &amp; P60 (2026)</h2>
            <p>Example: Renter compresses Revenue tax summary PDF for landlord agent portal.</p>
            <p class="lead">Pillar: <a href="/guides/tax-document-pdf-workflow-india">tax document workflow India (reference)</a> · Related: <a href="/guides/visa-application-pdf-workflow-ireland">/guides/visa-application-pdf-workflow-ireland</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Tax Document PDF Workflow Ireland — Revenue ROS &amp; P60 (2026)</figcaption></figure>
            
            <h2>Tax documents — Ireland</h2>
            <p><strong>Common PDFs:</strong> P60, tax clearance certificate, ROS statement PDF.</p>
            <p><strong>Typical use:</strong> Rental, mortgage, AVATS supporting docs.</p>
            <h2>Workflow</h2>
            <ol>
            <li>Download official PDF from tax authority portal — not edited screenshots</li>
            <li>Verify name, tax ID, and assessment year at 100% zoom</li>
            ...
            <h2>Loan and visa KYC</h2>
            <p>Pair with <a href="/guides/visa-application-pdf-workflow-ireland">visa workflow</a> when immigration evidence. India reference: <a href="/guides/tax-document-pdf-workflow-india">tax workflow India</a>.</p>
            <h2>Troubleshooting</h2>
            <p><strong>Password-protected portal PDF:</strong> unlock only if you set password — re-export unprotected if portal allows. <strong>Scan instead of export:</strong> re-download from authority site.</p>
        ...
        private const string TaxDocumentPdfWorkflowItaly = """
            <h2>Tax Document PDF Workflow Italy — CU &amp; Agenzia Entrate (2026)</h2>
            <p>Example: Worker compresses Certificazione Unica PDF for rental contract dossier.</p>
            <p class="lead">Pillar: <a href="/guides/tax-document-pdf-workflow-india">tax document workflow India (reference)</a> · Related: <a href="/guides/visa-application-pdf-workflow-italy">/guides/visa-application-pdf-workflow-italy</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Tax Document PDF Workflow Italy — CU &amp; Agenzia Entrate (2026)</figcaption></figure>
            
            <h2>Tax documents — Italy</h2>
            <p><strong>Common PDFs:</strong> CU, dichiarazione dei redditi PDF from Agenzia Entrate.</p>
            <p><strong>Typical use:</strong> Affitto, visa Schengen financial evidence, bank loan.</p>
            <h2>Workflow</h2>
            <ol>
            <li>Download official PDF from tax authority portal — not edited screenshots</li>
            <li>Verify name, tax ID, and assessment year at 100% zoom</li>
            ...
            <h2>Loan and visa KYC</h2>
            <p>Pair with <a href="/guides/visa-application-pdf-workflow-italy">visa workflow</a> when immigration evidence. India reference: <a href="/guides/tax-document-pdf-workflow-india">tax workflow India</a>.</p>
            <h2>Troubleshooting</h2>
            <p><strong>Password-protected portal PDF:</strong> unlock only if you set password — re-export unprotected if portal allows. <strong>Scan instead of export:</strong> re-download from authority site.</p>
        ...
        private const string TaxDocumentPdfWorkflowJapan = """
            <h2>Tax Document PDF Workflow Japan — e-Tax &amp; Gensen Choshu (2026)</h2>
            <p>Example: Visa applicant compresses kazei shomeisho tax certificate PDF for embassy slot.</p>
            <p class="lead">Pillar: <a href="/guides/tax-document-pdf-workflow-india">tax document workflow India (reference)</a> · Related: <a href="/guides/visa-application-pdf-workflow-japan">/guides/visa-application-pdf-workflow-japan</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Tax Document PDF Workflow Japan — e-Tax &amp; Gensen Choshu (2026)</figcaption></figure>
            
            <h2>Tax documents — Japan</h2>
            <p><strong>Common PDFs:</strong> Gensen choshu hyo, e-Tax PDF, municipal tax certificate.</p>
            <p><strong>Typical use:</strong> Embassy, COE, rental guarantor — Japanese or English export.</p>
            <h2>Workflow</h2>
            <ol>
            <li>Download official PDF from tax authority portal — not edited screenshots</li>
            <li>Verify name, tax ID, and assessment year at 100% zoom</li>
            ...
            <h2>Loan and visa KYC</h2>
            <p>Pair with <a href="/guides/visa-application-pdf-workflow-japan">visa workflow</a> when immigration evidence. India reference: <a href="/guides/tax-document-pdf-workflow-india">tax workflow India</a>.</p>
            <h2>Troubleshooting</h2>
            <p><strong>Password-protected portal PDF:</strong> unlock only if you set password — re-export unprotected if portal allows. <strong>Scan instead of export:</strong> re-download from authority site.</p>
        ...
        private const string TaxDocumentPdfWorkflowMexico = """
            <h2>Tax Document PDF Workflow Mexico — SAT &amp; Declaración PDF (2026)</h2>
            <p>Example: Loan applicant compresses SAT constancia de situación fiscal PDF for bank portal.</p>
            <p class="lead">Pillar: <a href="/guides/tax-document-pdf-workflow-india">tax document workflow India (reference)</a> · Related: <a href="/guides/visa-application-pdf-workflow-mexico">/guides/visa-application-pdf-workflow-mexico</a>.</p>
            <figure class="rp-screenshot-placeholder border rounded p-3 mb-4 text-muted small"><figcaption><strong>Screenshot placeholder:</strong> Tax Document PDF Workflow Mexico — SAT &amp; Declaración PDF (2026)</figcaption></figure>
            
            <h2>Tax documents — Mexico</h2>
            <p><strong>Common PDFs:</strong> Constancia de situación fiscal, declaración anual PDF from SAT.</p>
            <p><strong>Typical use:</strong> Bank KYC, consulate, rental — RFC visible at 100% zoom.</p>
            <h2>Workflow</h2>
            <ol>
            <li>Download official PDF from tax authority portal — not edited screenshots</li>
            <li>Verify name, tax ID, and assessment year at 100% zoom</li>
            ...
            <h2>Loan and visa KYC</h2>
            <p>Pair with <a href="/guides/visa-application-pdf-workflow-mexico">visa workflow</a> when immigration evidence. India reference: <a href="/guides/tax-document-pdf-workflow-india">tax workflow India</a>.</p>
            <h2>Troubleshooting</h2>
            <p><strong>Password-protected portal PDF:</strong> unlock only if you set password — re-export unprotected if portal allows. <strong>Scan instead of export:</strong> re-download from authority site.</p>
