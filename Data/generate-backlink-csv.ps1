...
$freeListings = @(
    ...
    @{Domain="startupfa.me"; Name="Startup Fame"; Type="Startup directory"; SubmitUrl="https://startupfa.me/s/ratpdf"; DR="82"; Cost="Free (badge verify)"; PrimaryPage="PdfToolsHub"; Anchor="RatPDF"; Notes="Badge on homepage required. Listing: https://startupfa.me/s/ratpdf — click Verify in dashboard after deploy."},
